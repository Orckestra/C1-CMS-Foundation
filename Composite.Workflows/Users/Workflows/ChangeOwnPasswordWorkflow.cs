...
namespace Composite.Users.Workflows
{
    ...
    public sealed partial class ChangeOwnPasswordWorkflow : Composite.Workflow.Activities.FormsWorkflow
    {
        ...
        {
            this.ShowMessage(DialogType.Error, "${Composite.Users, ChangeOwnPasswordWorkflow.NotSupportedErrorLabel}", "${Composite.Users, ChangeOwnPasswordWorkflow.NotSupportedErrorText}");
        }
    }
}
