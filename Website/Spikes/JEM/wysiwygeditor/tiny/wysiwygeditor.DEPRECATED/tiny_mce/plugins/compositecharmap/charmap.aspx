...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:ui="http://www.w3.org/1999/xhtml" xmlns:control="http://www.composite.net/ns/uicontrol">
	...
	<body>
		<ui:dialogpage 
			...
			label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelSelectSpecialChar}" 
			image="${icon:specialchar}" 
			height="auto" 
			resizable="false">
			<ui:tabbox type="boxed" equalsize="true">
				<ui:tabs>
					<ui:tab label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelGeneral}"/>
					<ui:tab label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelAlphabetical}"/>
					<ui:tab label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelMathSymbols}"/>
				</ui:tabs>
				<ui:tabpanels>
					<ui:tabpanel>
						<ui:fields>
							<ui:fieldgroup label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelCommon}">
								<ui:field>
							...
							<ui:fieldgroup label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelQuotation}">
								<ui:field>
							...
							<ui:fieldgroup label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelCurrency}">
								<ui:field>
					...
					<ui:tabpanel>
						<ui:fields>
							<ui:fieldgroup label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelLatin}">
								<ui:field>
							...
							<ui:fieldgroup label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelGreek}">
								<ui:field>
					...
					<ui:tabpanel>
						<ui:fields>
							<ui:fieldgroup label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelMathAndLogic}">
								<ui:field>
							...
							<ui:fieldgroup label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelSymbols}">
								<ui:field>
							...
							<ui:fieldgroup label="${string:Website.Dialogs.WysiwygEditor.CharMap.CharMap.LabelArrows}">
								<ui:field>
