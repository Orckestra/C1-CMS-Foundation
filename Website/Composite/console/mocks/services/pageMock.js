			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						options: [
							{ name: 'other-page.toolbar2.levels.critical', label: 'Critical' },
							{ name: 'other-page.toolbar2.levels.error', label: 'Error' },
							{ name: 'other-page.toolbar2.levels.warning', label: 'Warning' },
							{ name: 'other-page.toolbar2.levels.info', label: 'Information' },
							{ name: 'other-page.toolbar2.levels.verbose', label: 'Verbose' }
						],
						default: [
							'other-page/toolbar2/levels/critical',
							'other-page/toolbar2/levels/error',
							'other-page/toolbar2/levels/warning',
							'other-page/toolbar2/levels/info'
						]
					}
				]
			}
