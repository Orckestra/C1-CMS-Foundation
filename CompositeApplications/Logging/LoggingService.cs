    ...
    public static class LoggingService
    {
        ...
        private sealed class Resources
        {
            ...
            public static void Initialize(Resources resources)
            {
                ...
                {
                    string path = System.IO.Path.Combine(IO.PathUtil.BaseDirectory, string.Format("logging{0}.config", Guid.NewGuid()));
...
#warning ASSEMBLY RENAME: This string should be renamed as well
  ...
  <loggingConfiguration name=""Logging Application Block"" tracingEnabled=""true""
    ...
    <listeners>
        <add listenerDataType=""Microsoft.Practices.EnterpriseLibrary.Logging.Configuration.CustomTraceListenerData, Microsoft.Practices.EnterpriseLibrary.Logging, Version=3.0.0.0""
            traceOutputOptions=""None"" type=""Composite.StandardPlugins.Logging.LogTraceListeners.TcpLogTraceListener.TcpLogTraceListener, Composite, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null""
  ...
  <loggingConfiguration name=""Logging Application Block"" tracingEnabled=""true""
    ...
    <listeners>
      <add listenerDataType=""Microsoft.Practices.EnterpriseLibrary.Logging.Configuration.CustomTraceListenerData, Microsoft.Practices.EnterpriseLibrary.Logging, Version=3.0.0.0""
        traceOutputOptions=""None"" type=""Composite.Logging.NullLogTraceListener, Composite, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null""
