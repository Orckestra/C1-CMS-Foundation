...
{
    public sealed partial class ChangeOwnForeignLocaleWorkflow : Composite.Workflow.Activities.FormsWorkflow
    {
        ...
        private void step1CodeActivity_Initialize_ExecuteCode(object sender, EventArgs e)
        {
            ...
            foriegnCulturesDictionary.Insert(0, new KeyValuePair<string, string>("NONE", StringResourceSystemFacade.GetString("Composite.Users", "ChangeForeignLocaleWorkflow.NoForeignLocaleLabel")));
