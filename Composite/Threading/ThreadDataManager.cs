...
@"ThreadDataManager hasn't been initialized in the current thread. You probably have forgotten to use Composite.Threading.ThreadDataManager.EnsureInitialize() call on a custom created thread.
Example of usage:
using(Composite.Threading.ThreadDataManager.EnsureInitialize())
{
  ...
  .....
        ...
        public static void InitializeThroughHttpContext(bool forceUserValidation)
        {
            ...
            if (httpContext.Items[c_HttpContextItemsId] == null)
            {
                ...
                {
                    Logging.LoggingService.LogCritical(LogTitle, "ThreadData has already been initialized in the current thread. It's been reset to NULL value, resource leaks are possible.");
        ...
        public static void FinalizeThroughHttpContext()
        {
            ...
            {
                _threadDataManagerData = null;
                Logging.LoggingService.LogError(LogTitle, "Thread data hasn't been disposed after request execution. Resource leaks are possible.");
            }
            ...
            if (currentData != null)
            {
                ...
                {
                    Logging.LoggingService.LogError(LogTitle, e);
                }
            }
        }
