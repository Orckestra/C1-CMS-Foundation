...
namespace Composite.PackageSystem.PackageFragmentInstallers
{
    public sealed class DataPackageFragmentUninstaller : BasePackageFragmentUninstaller
    {
        ...
        public override IEnumerable<PackageFragmentValidationResult> Validate()
        {
            ...
            {
                validationResult.Add(new PackageFragmentValidationResult(PackageFragmentValidationResultType.Fatal, StringResourceSystemFacade.GetString("Composite.PackageSystem.PackageFragmentInstallers", "DataAddOnFragmentUninstaller.OnlyOneElement")));
            ...
            if (typesElement == null) return validationResult;
            ...
            foreach (XElement typeElement in typesElement.Elements("Type").Reverse())
            {
                ...
                if (typeAttribute == null) { validationResult.Add(new PackageFragmentValidationResult(PackageFragmentValidationResultType.Fatal, string.Format(StringResourceSystemFacade.GetString("Composite.PackageSystem.PackageFragmentInstallers", "DataAddOnFragmentUninstaller.MissingAttribute"), "type"), typeElement)); continue; }
                if (dataScopeIdentifierAttribute == null) { validationResult.Add(new PackageFragmentValidationResult(PackageFragmentValidationResultType.Fatal, string.Format(StringResourceSystemFacade.GetString("Composite.PackageSystem.PackageFragmentInstallers", "DataAddOnFragmentUninstaller.MissingAttribute"), "dataScopeIdentifier"), typeElement)); continue; }
                ...
                foreach (XElement datasElement in typeElement.Elements("Datas").Reverse())
                {
                    ...
                    foreach (XElement keysElement in datasElement.Elements("Keys"))
                    {
                        ...
                        foreach (XElement keyElement in keysElement.Elements("Key"))
                        {
                            ...
                            {
                                if (keyNameAttribute == null) validationResult.Add(new PackageFragmentValidationResult(PackageFragmentValidationResultType.Fatal, string.Format(StringResourceSystemFacade.GetString("Composite.PackageSystem.PackageFragmentInstallers", "DataAddOnFragmentUninstaller.MissingAttribute"), "name"), keyElement));
                                if (keyValueAttribute == null) validationResult.Add(new PackageFragmentValidationResult(PackageFragmentValidationResultType.Fatal, string.Format(StringResourceSystemFacade.GetString("Composite.PackageSystem.PackageFragmentInstallers", "DataAddOnFragmentUninstaller.MissingAttribute"), "value"), keyElement));
                            ...
                            else
                            {
                                ...
                                {
                                    validationResult.Add(new PackageFragmentValidationResult(PackageFragmentValidationResultType.Fatal, string.Format(StringResourceSystemFacade.GetString("Composite.PackageSystem.PackageFragmentInstallers", "DataAddOnFragmentUninstaller.MissingKeyProperty"), type, keyName)));
                                    allKeyPropertiesValidated = false;
                                }
                                else
                                {
        ...
        {
            if (_datasToDelete == null) throw new InvalidOperationException("Has not been validated");
