...
namespace Composite.Plugins.Elements.ElementProviders.UserControlFunctionProviderElementProvider
{
    ...
    public sealed partial class AddNewUserControlFunctionWorkflow : Composite.C1Console.Workflow.Activities.FormsWorkflow
    {
...
public partial class C1Function : Composite.AspNet.UserControlFunction
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        private void initializeCodeActivity_ExecuteCode(object sender, EventArgs e)
        {
            ...
            string @namespace = token.Id;
            string prefix = "ROOT:UserControlFunctionProviderElementProvider";

            if (@namespace == prefix)
            {
                @namespace = UserSettings.LastSpecifiedNamespace;
            }
        ...
        private void IsValidData(object sender, ConditionalEventArgs e)
        {
            ...
            var provider = GetUserControlFunctionProvider();
        ...
        private void finalizecodeActivity_ExecuteCode(object sender, EventArgs e)
        {
            ...
            executionService.Execute(newFunctionEntityToken, new WorkflowActionToken(typeof(EditXsltFunctionWorkflow)), null);*/
        }
        ...
        private static UserControlFunctionProvider GetUserControlFunctionProvider()
        {
            ...
            foreach (string providerName in providerNames)
            {
                ...
                if (provider is UserControlFunctionProvider)
                {
                    return provider as UserControlFunctionProvider;
                }
            }

            throw new InvalidOperationException("Failed to get instance of " + typeof(UserControlFunctionProvider));
        }
    }
}
