    ...
    public static class ConsoleFacade
    {
        ...
        public static void Initialize()
        {
            lock (_lock)
            {
                ...
                {
                    WorkflowInstance workflowInstance = WorkflowFacade.CreateNewWorkflow(WorkflowFacade.GetWorkflowType("Composite.ConsoleEventSystem.Workflows.UserConsoleInformationScavengerWorkflow"));
