...
{
    public sealed class AddOnElementProviderAddOnSourcesFolderEntityTokenAncestorProvider : ISecurityAncestorProvider
    {
    ...
    public sealed class PackageElementProviderPackageSourcesFolderEntityToken : EntityToken
    {
