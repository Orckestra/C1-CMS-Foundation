var TinyMCE_CompositeTextPlugin = new function () {
	
	var URL_TEXT = "${tinymce}/plugins/compositetext/text.aspx";
	var logger = SystemLogger.getLogger ( "TinyMCE_CompositeTextPlugin" );
...
tinyMCE.addPlugin ( "compositetext", TinyMCE_CompositeTextPlugin );