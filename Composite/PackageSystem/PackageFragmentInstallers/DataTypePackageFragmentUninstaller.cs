...
namespace Composite.PackageSystem.PackageFragmentInstallers
{
    public sealed class DataTypePackageFragmentUninstaller : BasePackageFragmentUninstaller
    {
        ...
        {            
            ...
            {
                _validationResult.Add(new PackageFragmentValidationResult(PackageFragmentValidationResultType.Fatal, StringResourceSystemFacade.GetString("Composite.PackageSystem.PackageFragmentInstallers", "DataTypeAddOnFragmentUninstaller.OnlyOneElement")));
            ...
            foreach (XElement typeElement in typesElement.Elements("Type").Reverse())
            {
                ...
                {
                    _validationResult.Add(new PackageFragmentValidationResult(PackageFragmentValidationResultType.Fatal, string.Format(StringResourceSystemFacade.GetString("Composite.PackageSystem.PackageFragmentInstallers", "DataTypeAddOnFragmentUninstaller.MissingAttribute"), "typeId")));
                    continue;
                }
                ...
                {
                    _validationResult.Add(new PackageFragmentValidationResult(PackageFragmentValidationResultType.Fatal, StringResourceSystemFacade.GetString("Composite.PackageSystem.PackageFragmentInstallers", "DataTypeAddOnFragmentUninstaller.WrongAttributeFormat"), typeIdAttribute));
                    continue;
                }
