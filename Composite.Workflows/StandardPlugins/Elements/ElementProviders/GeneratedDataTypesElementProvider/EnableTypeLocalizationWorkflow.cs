...
namespace Composite.StandardPlugins.Elements.ElementProviders.GeneratedDataTypesElementProvider
{
    ...
    public sealed partial class EnableTypeLocalizationWorkflow : Composite.Workflow.Activities.FormsWorkflow
    {
        ...
        private DataTypeDescriptor GetDataTypeDescriptor()
        {
            ...
            {
                var castedEntityToken = this.EntityToken as Composite.Elements.ElementProviderHelpers.AssociatedDataElementProviderHelper.AssociatedDataElementProviderHelperEntityToken;
