...
TableDialogPageBinding.prototype._invokeInsertVersusUpdateLayout = function () {
	...
	if ( this._tinyAction == "update" ) {
		this.label = StringBundle.getString ( "ui", "Website.Dialogs.WysiwygEditor.Tables.Table.TitleUpdate" );
		this._populateDataBindingsFromDOM ();
	} else {
		this.label = StringBundle.getString ( "ui", "Website.Dialogs.WysiwygEditor.Tables.Table.TitleInsert" );
	}
}
