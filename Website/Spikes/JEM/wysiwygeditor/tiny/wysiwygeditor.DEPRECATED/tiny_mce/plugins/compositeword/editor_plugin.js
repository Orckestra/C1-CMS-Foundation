var TinyMCE_CompositeWordPlugin = new function () {
	
	var URL_WORD = "${tinymce}/plugins/compositeword/word.aspx";
	var logger = SystemLogger.getLogger ( "TinyMCE_CompositeWordPlugin" );
...
tinyMCE.addPlugin ( "compositeword", TinyMCE_CompositeWordPlugin );