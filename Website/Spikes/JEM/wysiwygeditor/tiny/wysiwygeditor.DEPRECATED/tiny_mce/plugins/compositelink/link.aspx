		...
		<ui:dialogpage binding="LinkDialogPageBinding"
			...
			<ui:tabbox type="boxed" equalsize="true">
				...
				<ui:tabpanels>
					<ui:tabpanel>
						<ui:fields>
							<ui:fieldgroup label="${string:Website.Dialogs.WysiwygEditor.Link.Link.LabelLink}">
								<ui:field>
									<ui:fielddesc label="${string:Website.Dialogs.WysiwygEditor.Link.Link.LinkDestination}"/>
									<ui:fielddata>
										<ui:datainputdialog type="url" handle="Composite.Management.LinkableSelectorDialog" name="href" required="true"/>
									</ui:fielddata>
								</ui:field>
								<ui:field>
									<ui:fielddesc label="${string:Website.Dialogs.WysiwygEditor.Link.Link.LinkRole}"/>
									<ui:fielddata>
								...
								<ui:field>
									<ui:fielddesc label="${string:Website.Dialogs.WysiwygEditor.Link.Link.TitleText}"/>
									<ui:fieldhelp label="${string:Website.Dialogs.WysiwygEditor.Link.Link.TitleTextToolTip}"/>
									<ui:fielddata>
										<ui:datainput name="title"/>
									</ui:fielddata>
								</ui:field>
								<ui:field>
									<ui:fielddesc label="${string:Website.Dialogs.WysiwygEditor.Link.Link.LinkTarget}"/>
									<ui:fielddata>
										<ui:checkboxgroup>
											<ui:checkbox label="${string:Website.Dialogs.WysiwygEditor.Link.Link.LinkTarget.LabelCheckBox}" name="blank" value="true"/>
										</ui:checkboxgroup>
									</ui:fielddata>
								</ui:field>
							</ui:fieldgroup>
