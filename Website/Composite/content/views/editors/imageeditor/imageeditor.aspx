...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:ui="http://www.w3.org/1999/xhtml" xmlns:control="http://www.composite.net/ns/uicontrol">
	...
	<body id="root">
		...
		<ui:broadcasterset>
			...
			<ui:broadcaster id="broadcasterCanSave" isdisabled="true"/> <!-- not used?!?! -->
		...
		<ui:editorpage id="editorpage" 
			...
			<ui:menubar>
				...
				<ui:menu label="${string:Website.Content.Views.Editors.ImageEditor.ImageEditor.LabelImage}">
					<ui:menupopup>
						<ui:menubody>
							<ui:menugroup>
					...
					<ui:toolbar imagesize="large">
						<ui:toolbarbody>
							<ui:toolbargroup>
								...
								<ui:toolbarbutton type="radio" image="${skin}/imageeditor/select24.png" oncommand="ImageEditor.setMode ( ImageEditor.MODE_SELECT )" tooltip="${string:Website.Content.Views.Editors.ImageEditor.ImageEditor.ToolBox.ToolTipSelect}"/>
			...
			<ui:toolbar class="statusbar" blockactionevents="true">
				<ui:toolbarbody>
					<ui:toolbargroup>
						<ui:selector id="zoomselector" width="80" image="${icon:zoom}">
