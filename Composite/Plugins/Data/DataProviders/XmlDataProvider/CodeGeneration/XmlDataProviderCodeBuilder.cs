...
#warning MRJ: BM: Does not make sense to create a general class here, it might be generated by other providres supporting the same interface
            // Data wrapper for caching
           // DataWrapperCodeGenerator.AddDataWrapperClassCode(_codeGenerationBuilder, dataTypeDescriptor);
        }
