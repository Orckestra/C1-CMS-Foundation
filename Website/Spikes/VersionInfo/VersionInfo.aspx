...
<%@ Page Language="C#" AutoEventWireup="true" Inherits="Spikes_VersionInfo_Default" Codebehind="VersionInfo.aspx.cs" %>
...
<body>
    <ui:dialogpage label="Version information" image="${skin}/dialogpages/message16.png">
        <ui:scrollbox>
            <asp:PlaceHolder ID="VersionInfoHolder" runat="server" />
        </ui:scrollbox>
    </ui:dialogpage>
</body>
</html>