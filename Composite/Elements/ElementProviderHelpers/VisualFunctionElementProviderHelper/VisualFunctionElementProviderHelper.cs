...
using Composite.Elements.ElementProviderHelpers.VisualFunctionElementProviderHelper.Foundation;
    ...
    public sealed class VisualFunctionElementProviderHelper
    {
        ...
        public void AttachElementActions(IEnumerable<Element> elements)
        {
            foreach (Element element in elements)
            {
                ...
                {
                    element.AddAction(
                        new ElementAction(new ActionHandle(new WorkflowActionToken(WorkflowFacade.GetWorkflowType("Composite.Elements.ElementProviderHelpers.VisualFunctionElementProviderHelper.AddVisualFunctionWorkflow"))))
                            {
                                VisualData = new ActionVisualizedData
                                {
                                    Label = StringResourceSystemFacade.GetString("Composite.StandardPlugins.VisualFunction", "VisualFunctionElementProviderHelper.AddNewLabel"),
                                    ToolTip = StringResourceSystemFacade.GetString("Composite.StandardPlugins.VisualFunction", "VisualFunctionElementProviderHelper.AddNewToolTip"),
                    ...
                    {
                        element.AddAction(
                            new ElementAction(new ActionHandle(new WorkflowActionToken(WorkflowFacade.GetWorkflowType("Composite.Elements.ElementProviderHelpers.VisualFunctionElementProviderHelper.SelectVisualFunctionWorkflow")) { Payload = "Edit" }))
                            {
                                VisualData = new ActionVisualizedData
                                {
                                    Label = StringResourceSystemFacade.GetString("Composite.StandardPlugins.VisualFunction", "VisualFunctionElementProviderHelper.EditLabel"),
                                    ToolTip = StringResourceSystemFacade.GetString("Composite.StandardPlugins.VisualFunction", "VisualFunctionElementProviderHelper.EditToolTip"),
                        ...
                        element.AddAction(
                            new ElementAction(new ActionHandle(new WorkflowActionToken(WorkflowFacade.GetWorkflowType("Composite.Elements.ElementProviderHelpers.VisualFunctionElementProviderHelper.SelectVisualFunctionWorkflow")) { Payload = "Delete" }))
                            {
                                VisualData = new ActionVisualizedData
                                {
                                    Label = StringResourceSystemFacade.GetString("Composite.StandardPlugins.VisualFunction", "VisualFunctionElementProviderHelper.DeleteLabel"),
                                    ToolTip = StringResourceSystemFacade.GetString("Composite.StandardPlugins.VisualFunction", "VisualFunctionElementProviderHelper.DeleteToolTip"),
