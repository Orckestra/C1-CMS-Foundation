...
var _83c=DOMUtil.createElementNS(Constants.NS_XHTML,"textarea",this.bindingDocument);
_83c.tabIndex=-1;
return _83c;
};
TextBoxBinding.prototype.handleElement=function(_83d){
return true;
};
TextBoxBinding.prototype.updateElement=function(_83e){
var _83f,area=_83e.getElementsByTagName("textarea").item(0);
if(area!=null&&area.hasChildNodes()){
_83f=DOMUtil.getTextContent(area);
}
if(_83f==null){
_83f="";
}
...
var _842=_83e.getAttribute("type");
if(this.type!=_842){
...
IEEditorTextBoxBinding.prototype._handleTabKey=function(_846){
var _847=this.bindingDocument.selection.createRange();
var _848=_847.text=="";
if(_848&&!_846){
_847.text="\t";
}else{
var text="";
var _84a=_847.text.length;
while((_847.moveStart("word",-1)&&_847.text.charAt(1)!="\n")){
}
_847.moveStart("character",1);
var _84b=0;
var i=0,line,_84e=_847.text.split("\n");
while((line=_84e[i++])!=null){
if(_846){
...
_847.text=text;
_847.moveStart("character",-_84a);
if(_846){
_847.moveStart("character",2*_84e.length-2);
}
_847.select();
}
};
...
var _850=_84f.duplicate();
while((_850.moveStart("word",-1)&&_850.text.indexOf("\n")==-1)){
}
...
MozEditorTextBoxBinding.prototype._handleTabKey=function(_851){
var _852;
var _853;
var oss;
var osy;
var i;
var fnd;
var _858=this._getSelectedText();
...
el.selectionEnd=osy;
_858=this._getSelectedText();
if(_851){
ntext=_858.replace(/^(\s)/mg,"");
}else{
ntext=_858.replace(/^(.)/mg,"\t$1");
}
el.value=el.value.substr(0,el.selectionStart)+ntext+el.value.substr(el.selectionEnd);
el.selectionStart=oss;
el.selectionEnd=osy+(ntext.length-_858.length);
}
el.scrollLeft=_852;
el.scrollTop=_853;
};
...
var _862=this.shadowTree.input.value;
var _863=this.shadowTree.input.selectionStart;
var end=this.shadowTree.input.selectionEnd;
return _862.substr(_863,end-_863);
};
...
var _865=this.getProperty("isdisabled");
if(this.isDisabled||_865){
this.disable();
}
};
...
var type=this.getProperty("type");
var _867=this.getProperty("label");
var _868=this.getProperty("value");
var _869=this.getProperty("width");
var _86a=this.getProperty("onchange");
var _86b=this.getProperty("required")==true;
if(!this.type&&type){
this.type=type;
}
if(!this.label&&_867!=null){
this.label=_867;
}
if(!this.value&&_868!=null){
this.value=_868;
}
if(!this.width&&_869){
this.width=_869;
...
var _86c=DOMUtil.createElementNS(Constants.NS_XHTML,"input",this.bindingDocument);
_86c.name=this.getName();
_86c.value=this.getValue();
_86c.type="hidden";
if(this.hasCallBackID()){
_86c.id=this.getCallBackID();
}
this.shadowTree.input=_86c;
this.bindingElement.appendChild(_86c);
};
SelectorBinding.prototype.buildButton=function(){
var _86d=this.BUTTON_IMPLEMENTATION;
var _86e=this.add(_86d.newInstance(this.bindingDocument));
if(this.imageProfile!=null){
_86e.imageProfile=this.imageProfile;
}
if(this.width!=null){
_86e.setWidth(this.width);
}
this._buttonBinding=_86e;
this.shadowTree.button=_86e;
_86e.attach();
};
...
var _870=top.app.bindingMap.selectorpopupset;
var doc=_870.bindingDocument;
var _872=_870.add(PopupBinding.newInstance(doc));
var _873=_872.add(MenuBodyBinding.newInstance(doc));
this._popupBinding=_872;
this._menuBodyBinding=_873;
...
_872.attachClassName("selectorpopup");
_872.addActionListener(PopupBinding.ACTION_SHOW,this);
_872.addActionListener(MenuItemBinding.ACTION_COMMAND,this);
_872.addActionListener(PopupBinding.ACTION_HIDE,this);
this._buttonBinding.setPopup(_872);
};
...
var list=new List();
var _876=DOMUtil.getElementsByTagName(this.bindingElement,"selection");
new List(_876).each(function(_877){
var _878=_877.getAttribute("label");
var _879=_877.getAttribute("value");
var _87a=_877.getAttribute("selected");
var _87b=_877.getAttribute("image");
var _87c=_877.getAttribute("image-hover");
var _87d=_877.getAttribute("image-active");
var _87e=_877.getAttribute("image-disabled");
var _87f=null;
if(_87b||_87c||_87d||_87e){
_87f=new ImageProfile({image:_87b,imageHover:_87c,imageActive:_87d,imageDisabled:_87e});
}
list.add(new SelectorBindingSelection(_878?_878:null,_879?_879:null,_87a&&_87a=="true",_87f));
});
return list;
};
...
var _881=null;
while(list.hasNext()){
var _882=list.getNext();
var item=this.addSelection(_882);
if(!_881){
_881=item;
}
}
if(!this._selectedItemBinding){
this.select(_881,true);
}
...
SelectorBinding.prototype.addSelection=function(_884,_885){
var _886=this.MENUITEM_IMPLEMENTATION;
var _887=this._menuBodyBinding;
var _888=_887.bindingDocument;
var _889=_886.newInstance(_888);
_889.imageProfile=_884.imageProfile;
_889.setLabel(_884.label);
if(_884.tooltip!=null){
_889.setToolTip(_884.tooltip);
}
_889.selectionValue=_884.value;
if(_884.isSelected){
this.select(_889,true);
}
_884.menuItemBinding=_889;
if(_885){
_887.addFirst(_889);
this.selections.addFirst(_884);
}else{
_887.add(_889);
this.selections.add(_884);
}
this._isUpToDate=false;
return _889;
};
SelectorBinding.prototype.addSelectionFirst=function(_88a){
return this.addSelection(_88a,true);
};
SelectorBinding.prototype.clear=function(_88b){
this._selectedItemBinding=null;
if(this._popupBinding){
this._popupBinding.clear();
this.selections.clear();
if(!_88b&&this.defaultSelection!=null){
var _88c=this.addSelection(this.defaultSelection);
...
SelectorBinding.prototype.setDisabled=function(_88d){
if(this.isAttached==true){
var _88e=this._buttonBinding;
this.shadowTree.selectorindicatorimage.style.display=_88d?"none":"block";
_88e.setDisabled(_88d);
}
if(_88d){
this.setProperty("isdisabled",true);
}else{
...
SelectorBinding.prototype.reset=function(_88f){
if(this.defaultSelection!=null){
this.selectByValue(this.defaultSelection.value,_88f);
}
};
SelectorBinding.prototype.handleAction=function(_890){
SelectorBinding.superclass.handleAction.call(this,_890);
switch(_890.type){
case ButtonBinding.ACTION_COMMAND:
...
this._onMenuItemCommand(_890.target);
_890.consume();
break;
...
SelectorBinding.prototype._onMenuItemCommand=function(_892){
this.select(_892);
FocusBinding.focusElement(this.bindingElement);
this._grabKeyboard();
};
...
var _893=this._buttonBinding.bindingElement.offsetWidth+"px";
var _894=this._popupBinding.bindingElement;
if(Client.isMozilla==true){
_894.style.minWidth=_893;
}else{
_894.style.width=_893;
}
};
...
SelectorBinding.prototype.handleBroadcast=function(_896,arg){
SelectorBinding.superclass.handleBroadcast.call(this,_896,arg);
switch(_896){
case BroadcastMessages.KEY_ARROW:
...
SelectorBinding.prototype.select=function(_899,_89a){
var _89b=false;
if(_899!=this._selectedItemBinding){
this._selectedItemBinding=_899;
_89b=true;
var _89c=this._buttonBinding;
this._selectionValue=_899.selectionValue;
_89c.setLabel(_899.getLabel());
if(_899.imageProfile!=null){
_89c.imageProfile=_899.imageProfile;
}
if(_89c.imageProfile!=null){
_89c.setImage(this.isDisabled==true?_89c.imageProfile.getDisabledImage():_89c.imageProfile.getDefaultImage());
}
...
if(!this._isValid||(this.isRequired&&!_89a)){
this.validate();
}
}
return _89b;
...
var _89d=this.getProperty("relate");
if(_89d){
var _89e=this.bindingDocument.getElementById(_89d);
if(_89e){
var _89f=UserInterface.getBinding(_89e);
if(_89f){
if(this.isChecked){
_89f.show();
}else{
...
SelectorBinding.prototype.selectByValue=function(_8a0,_8a1){
var _8a2=false;
var _8a3=this._menuBodyBinding;
var _8a4=_8a3.getDescendantElementsByLocalName("menuitem");
while(_8a4.hasNext()){
var _8a5=UserInterface.getBinding(_8a4.getNext());
if(_8a5.selectionValue==_8a0){
_8a2=this.select(_8a5,_8a1);
break;
}
}
return _8a2;
...
var _8a6=this._selectionValue;
if(_8a6!=null){
_8a6=String(_8a6);
}
return _8a6;
};
SelectorBinding.prototype.setValue=function(_8a7){
this.selectByValue(String(_8a7),true);
};
...
SelectorBinding.prototype.setResult=function(_8a9){
this.selectByValue(_8a9,true);
};
SelectorBinding.prototype.validate=function(){
var _8aa=true;
if(this.isRequired==true&&this.defaultSelection!=null){
var _8ab=this.getValue();
if(_8ab==this.defaultSelection.value){
_8aa=false;
}
if(_8aa!=this._isValid){
if(_8aa){
this.dispatchAction(Binding.ACTION_VALID);
this.detachClassName(DataBinding.CLASSNAME_INVALID);
}else{
...
var _8ac=this._popupBinding;
if(!this._isUpToDate){
_8ac.attachRecursive();
...
SelectorBinding.prototype.updateElement=function(_8ad,_8ae){
this.bindingWindow.UpdateManager.addUpdate(new this.bindingWindow.ReplaceUpdate(this.getID(),_8ad));
return true;
};
SelectorBinding.newInstance=function(_8af){
var _8b0=DOMUtil.createElementNS(Constants.NS_UI,"ui:selector",_8af);
return UserInterface.registerBinding(_8b0,SelectorBinding);
};
...
var _8b3=this.getProperty("onchange");
...
SimpleSelectorBinding.prototype.focus=function(_8b6){
...
SimpleSelectorBinding.prototype._hack=function(_8b7){
if(Client.isExplorer){
this._select.style.width=_8b7?"auto":this._cachewidth+"px";
if(_8b7){
...
var text=DOMUtil.getTextContent(_8ba);
_8b9.blur();
_8b9.style.color="#A40000";
_8b9.style.fontWeight="bold";
if(!Client.isExplorer6){
DOMUtil.setTextContent(_8ba,DataBinding.warnings["required"]);
}
_8b9.onfocus=function(){
this.style.color="black";
this.style.fontWeight="normal";
this.onfocus=null;
if(!Client.isExplorer6){
DOMUtil.setTextContent(_8ba,text);
}
};
}
this._isValid=_8b8;
...
var _8bf=true;
if(Client.isExplorer){
var html=_8be.outerHTML.toLowerCase();
if(html.indexOf("value=")==-1){
_8bf=false;
}
}
if(_8bf){
_8bc=_8be.getAttribute("value");
}
return _8bc;
};
SimpleSelectorBinding.prototype.setValue=function(_8c1){
};
SimpleSelectorBinding.prototype.getResult=function(){
return this.getValue();
};
SimpleSelectorBinding.prototype.setResult=function(_8c2){
this.setValue(_8c2);
};
SimpleSelectorBinding.newInstance=function(_8c3){
var _8c4=DOMUtil.createElementNS(Constants.NS_XHTML,"select",_8c3);
return UserInterface.registerBinding(_8c4,SimpleSelectorBinding);
};
function SelectorBindingSelection(_8c5,_8c6,_8c7,_8c8,_8c9){
this._init(_8c5,_8c6,_8c7,_8c8,_8c9);
}
SelectorBindingSelection.prototype={label:null,value:null,tooltip:null,isSelected:null,imageProfile:null,menuItemBinding:null,_init:function(_8ca,_8cb,_8cc,_8cd,_8ce){
if(_8ca!=null){
this.label=String(_8ca);
}
if(_8cb!=null){
this.value=String(_8cb);
}
if(_8cd!=null){
this.imageProfile=_8cd;
}
if(_8ce!=null){
this.tooltip=_8ce;
}
this.isSelected=_8cc?true:false;
}};
...
var _8cf=this.addFirst(ToolBarButtonBinding.newInstance(this.bindingDocument));
_8cf.popupBindingTargetElement=this.shadowTree.input;
_8cf.setImage(DataInputSelectorBinding.INDICATOR_IMAGE);
_8cf.attach();
var self=this;
_8cf.oncommand=function(){
self._attachSelections();
};
this._buttonBinding=_8cf;
};
...
var list=new List();
var _8d2=DOMUtil.getElementsByTagName(this.bindingElement,"selection");
new List(_8d2).each(function(_8d3){
if(_8d3.getAttribute("label")){
throw "label not supported - use value property!";
}else{
var _8d4=_8d3.getAttribute("value");
var _8d5=_8d3.getAttribute("selected");
var _8d6=_8d3.getAttribute("tooltip");
list.add({value:_8d4?_8d4:null,toolTip:_8d6?_8d6:null,isSelected:(_8d5&&_8d5=="true")?true:false});
}
});
if(list.hasEntries()){
this.populateFromList(list);
...
var _8d8=this._menuBodyBinding;
var _8d9=_8d8.bindingDocument;
while(_8d8.bindingElement.hasChildNodes()){
var node=_8d8.bindingElement.lastChild;
if(node.nodeType==Node.ELEMENT_NODE&&UserInterface.hasBinding(node)){
UserInterface.getBinding(node).dispose();
}else{
_8d8.removeChild(node);
}
}
if(list.hasEntries()){
this._isUpToDate=false;
...
while(list.hasNext()){
var _8db=list.getNext();
var _8dc=MenuItemBinding.newInstance(_8d9);
_8dc.setLabel(_8db.value);
_8dc.selectionValue=_8db.value;
if(_8db.toolTip){
_8dc.setToolTip(_8db.toolTip);
}
if(_8db.isSelected){
this.select(_8dc,true);
}
_8d8.add(_8dc);
}
}else{
...
DataInputSelectorBinding.prototype._onMenuItemCommand=function(_8dd){
this.select(_8dd);
FocusBinding.focusElement(this.bindingElement);
this._grabKeyboard();
};
DataInputSelectorBinding.prototype.handleBroadcast=function(_8de,arg){
SelectorBinding.prototype.handleBroadcast.call(this,_8de,arg);
switch(_8de){
case BroadcastMessages.MOUSEEVENT_MOUSEDOWN:
if(arg!=this._buttonBinding){
DataInputSelectorBinding.superclass.handleBroadcast.call(this,_8de,arg);
}
break;
}
};
...
DataInputSelectorBinding.prototype.focus=function(_8e0){
if(!this.isFocused){
DataInputSelectorBinding.superclass.focus.call(this,_8e0);
if(this.isFocused==true){
this._grabKeyboard();
}
}
};
DataInputSelectorBinding.prototype.blur=function(_8e1){
if(this.isFocused==true){
DataInputSelectorBinding.superclass.blur.call(this,_8e1);
this._releaseKeyboard();
if(this._popupBinding.isVisible){
this._popupBinding.hide();
}
...
var _8e2=this.bindingElement.offsetWidth+"px";
var _8e3=this._popupBinding.bindingElement;
if(Client.isMozilla){
_8e3.style.minWidth=_8e2;
}else{
_8e3.style.width=_8e2;
}
};
...
var _8e4=this._menuBodyBinding.getDescendantBindingsByLocalName("menuitem");
var _8e5=this.getValue();
var _8e6=null;
_8e4.each(function(item){
if(item.getLabel()==_8e5){
_8e6=item;
}
});
if(_8e6){
...
DataInputSelectorBinding.prototype.select=function(item,_8e9){
...
var _8ea=ToolBarButtonBinding.newInstance(this.bindingDocument);
_8ea.setImage("${icon:popup}");
this.addFirst(_8ea);
_8ea.attach();
var self=this;
_8ea.oncommand=function(){
self._isButtonClicked=true;
setTimeout(function(){
self._isButtonClicked=false;
},1000);
var _8ec=self.getProperty("handle");
var _8ed=ViewDefinitions[_8ec];
if(_8ed instanceof DialogViewDefinition){
_8ed.handler={handleDialogResponse:function(_8ee,_8ef){
self._isButtonClicked=false;
if(_8ee==Dialog.RESPONSE_ACCEPT){
self.logger.debug("Usecase scenario was hardcoded into DataInputDialogBinding#buildButton");
var _8f0=_8ef.getFirst();
self.setValue(_8f0);
self.validate(true);
}
self.focus();
}};
_8ed.argument.selectedResult=self.getValue();
StageBinding.presentViewDefinition(_8ed);
}else{
throw "Definition was either undefine or of a non-dialog type.";
}
};
DOMEvents.addEventListener(_8ea.getBindingElement(),DOMEvents.MOUSEDOWN,{handleEvent:function(e){
self._isButtonClicked=true;
}});
this._dialogButtonBinding=_8ea;
};
DataInputDialogBinding.prototype.oncommand=function(){
var _8f2=this._dialogButtonBinding;
if(_8f2!=null){
_8f2.oncommand();
}
};
...
_8f4=DataInputDialogBinding.superclass.validate.call(this,arg);
}
return _8f4;
};
...
var _8f7=ToolBarButtonBinding.newInstance(this.bindingDocument);
_8f7.setImage("${icon:popup}");
this.addFirst(_8f7);
_8f7.attach();
var self=this;
...
var _8f9=ViewDefinitions[self.handle];
if(_8f9 instanceof DialogViewDefinition){
_8f9.handler={handleDialogResponse:function(_8fa,_8fb){
self._isButtonClicked=false;
if(_8fa==Dialog.RESPONSE_ACCEPT){
self.logger.debug("Usecase scenario was hardcoded into ImageInputDialogBinding#buildButton");
var _8fc=_8fb.getFirst();
self.setValue(_8fc);
self.validate(true);
...
_8f9.argument.selectedResult=self.getValue();
StageBinding.presentViewDefinition(_8f9);
}else{
throw "Definition was either undefine or of a non-dialog type.";
}
};
DOMEvents.addEventListener(_8f7.getBindingElement(),DOMEvents.MOUSEDOWN,{handleEvent:function(e){
self._isButtonClicked=true;
}});
this._dialogButtonBinding=_8f7;
};
ImageInputDialogBinding.prototype.oncommand=function(){
var _8fe=this._dialogButtonBinding;
if(_8fe!=null){
_8fe.oncommand();
}
};
...
_900=ImageInputDialogBinding.superclass.validate.call(this,arg);
}
return _900;
};
ImageInputDialogBinding.prototype.setValue=function(_901){
if(this.isReadOnly){
this.value=_901;
this.shadowTree.input.value=TreeService.GetMediaLabel(_901);
}else{
ImageInputDialogBinding.superclass.setValue.call(this,_901);
}
};
...
ImageInputDialogBinding.prototype.setReadOnly=function(_902){
var _903=this.isReadOnly;
ImageInputDialogBinding.superclass.setReadOnly.call(this,_902);
if(_903==true&&_902==false){
ImageInputDialogBinding.superclass.setValue.call(this,this.value);
}
if(_903==false&&_902==true){
...
var _904=ToolBarButtonBinding.newInstance(this.bindingDocument);
var _905=this.getProperty("image");
if(_905!=null){
_904.setImage(_905);
}else{
_904.setImage("${icon:popup}");
}
this.addFirst(_904);
_904.attach();
var self=this;
...
this._dialogButtonBinding=_904;
};
DataInputButtonBinding.prototype.oncommand=function(){
var _907=this._dialogButtonBinding;
if(_907!=null){
_907.oncommand();
}
};
...
var _908=this.getProperty("label");
var _909=this.getProperty("tooltip");
...
this._buttonBinding.setLabel(_908+LabelBinding.DIALOG_INDECATOR_SUFFIX);
}else{
this._buttonBinding.setLabel(_908);
}
}
if(this.imageProfile){
...
if(_909!=null){
this._buttonBinding.setToolTip(_909);
}
...
DataDialogBinding.prototype.handleAction=function(_90b){
DataDialogBinding.superclass.handleAction.call(this,_90b);
var _90c=_90b.target;
var self=this;
switch(_90b.type){
case ButtonBinding.ACTION_COMMAND:
if(this._handler==null){
this._handler={handleDialogResponse:function(_90e,_90f){
if(_90e==Dialog.RESPONSE_ACCEPT){
if(_90f instanceof DataBindingMap){
self._map=_90f;
}else{
...
DataDialogBinding.prototype.handleBroadcast=function(_910,arg){
DataDialogBinding.superclass.handleBroadcast.call(this,_910,arg);
switch(_910){
...
var _913=this.getProperty("handle");
var url=this.getURL();
var _915=null;
if(_913!=null||def!=null){
if(def!=null){
_915=def;
}else{
_915=ViewDefinitions[_913];
}
if(_915 instanceof DialogViewDefinition){
_915.handler=this._handler;
if(this._map!=null){
_915.argument=this._map;
}
StageBinding.presentViewDefinition(_915);
}
}else{
if(url!=null){
_915=Dialog.invokeModal(url,this._handler,this._map);
}
}
if(_915!=null){
this._dialogViewHandle=_915.handle;
this._releaseKeyboard();
}
};
DataDialogBinding.prototype.setLabel=function(_916){
this.setProperty("label",_916);
if(this.isAttached){
this._buttonBinding.setLabel(_916+LabelBinding.DIALOG_INDECATOR_SUFFIX);
}
};
DataDialogBinding.prototype.setImage=function(_917){
this.setProperty("image",_917);
if(this.imageProfile!=null){
this.imageProfile.setDefaultImage(_917);
...
DataDialogBinding.prototype.setToolTip=function(_918){
this.setProperty("tooltip",_918);
if(this.isAttached){
this._buttonBinding.setToolTip(_918);
}
};
DataDialogBinding.prototype.setHandle=function(_919){
this.setProperty("handle",_919);
};
...
DataDialogBinding.prototype.setHandler=function(_91b){
this._handler=_91b;
};
...
DataDialogBinding.newInstance=function(_91d){
var _91e=DOMUtil.createElementNS(Constants.NS_UI,"ui:datadialog",_91d);
return UserInterface.registerBinding(_91e,DataDialogBinding);
};
...
self._onDialogAccept(_921);
}else{
self._onDialogCancel();
}
}};
};
PostBackDataDialogBinding.prototype._onDialogAccept=function(_922){
_922=new String(_922);
this.dirty();
this.setValue(encodeURIComponent(_922));
var self=this;
setTimeout(function(){
...
this.shadowTree.dotnetinput.value=_926;
};
PostBackDataDialogBinding.prototype.setValue=function(_927){
this.setProperty("value",_927);
};
...
PostBackDataDialogBinding.prototype.setResult=function(_928){
};
PostBackDataDialogBinding.newInstance=function(_929){
var _92a=DOMUtil.createElementNS(Constants.NS_UI,"ui:postbackdialog",_929);
return UserInterface.registerBinding(_92a,PostBackDataDialogBinding);
};
...
var _92b=this.getProperty("dialoglabel");
var _92c=this.getProperty("providersearch");
var key=this.getProperty("providerkey");
var _92e=this.getProperty("handle");
if(_92e!=null){
var def=ViewDefinition.clone(_92e,"Generated.ViewDefinition.Handle."+KeyMaster.getUniqueKey());
if(_92b!=null){
if(def.argument==null){
def.argument={};
}
def.argument.label=_92b;
}
if(_92c!=null){
if(def.argument==null){
def.argument={};
...
def.argument.nodes[0].search=_92c;
}
if(key!=null){
if(def.argument==null){
def.argument={};
...
ViewDefinitionPostBackDataDialogBinding.newInstance=function(_930){
var _931=DOMUtil.createElementNS(Constants.NS_UI,"ui:postbackdialog",_930);
return UserInterface.registerBinding(_931,ViewDefinitionPostBackDataDialogBinding);
};
...
this.propertyMethodMap["label"]=this.setLabel;
var self=this;
this.propertyMethodMap["value"]=function(_933){
self._datathing.setValue(_933);
};
...
var _937=this.getProperty("value");
var _938=this.getProperty("selectorlabel");
if(_938==null){
_938=NullPostBackDataDialogBinding.LABEL_DEFAULT;
}
var list=new List();
list.add(new SelectorBindingSelection(NullPostBackDataDialogBinding.LABEL_NULL,NullPostBackDataDialogBinding.VALUE_NULL,_937==null));
list.add(new SelectorBindingSelection(_938+LabelBinding.DIALOG_INDECATOR_SUFFIX,NullPostBackDataDialogBinding.VALUE_SELECTED,_937!=null,new ImageProfile({image:"${icon:popup}"})));
...
NullPostBackDataDialogBinding.prototype.handleAction=function(_93a){
NullPostBackDataDialogBinding.superclass.handleAction.call(this,_93a);
switch(_93a.type){
case PageBinding.ACTION_DOPOSTBACK:
if(_93a.target==this._datathing){
var _93b=this.getProperty("label");
this._selector.setLabel("");
this.dispatchAction(PageBinding.ACTION_DOPOSTBACK);
var self=this;
setTimeout(function(){
if(self.getProperty("label")==_93b){
self._selector.setLabel(_93b);
}
},500);
_93a.consume();
}
...
NullPostBackDataDialogBinding.prototype.setLabel=function(_93d){
this.setProperty("label",_93d);
if(this._selector!=null){
this._selector.setLabel(_93d);
}
};
NullPostBackDataDialogBinding.prototype.getValue=function(){
return this._datathing.getValue();
};
NullPostBackDataDialogBinding.prototype.setValue=function(_93e){
this._datathing.setValue(_93e);
this.dispatchAction(PageBinding.ACTION_DOPOSTBACK);
};
...
NullPostBackDataDialogSelectorBinding.prototype.select=function(_93f,_940){
if(NullPostBackDataDialogSelectorBinding.superclass.select.call(this,_93f,_940)){
...
NullPostBackDataDialogSelectorBinding.prototype.setLabel=function(_941){
this._buttonBinding.setLabel(_941);
};
NullPostBackDataDialogSelectorBinding.prototype.setToolTip=function(_942){
this._buttonBinding.setToolTip(_942);
};
NullPostBackDataDialogSelectorBinding.prototype.handleAction=function(_943){
NullPostBackDataDialogSelectorBinding.superclass.handleAction.call(this,_943);
switch(_943.type){
case MenuItemBinding.ACTION_COMMAND:
var _944=_943.target;
var _945=this.master;
if(_944.selectionValue==NullPostBackDataDialogBinding.VALUE_SELECTED){
this.setLabel(_944.getLabel());
setTimeout(function(){
_945.action();
},0);
}else{
...
NullPostBackDataDialogSelectorBinding.newInstance=function(_946){
var _947=DOMUtil.createElementNS(Constants.NS_UI,"ui:selector",_946);
return UserInterface.registerBinding(_947,NullPostBackDataDialogSelectorBinding);
};
...
var _948=this._dataDialogBinding;
if(_948!=null){
...
var _949=this.getProperty("editable");
var _94a=this.getProperty("selectable");
var _94b=this.getProperty("display");
if(_949!=false){
...
if(this.isEditable){
var _94c=MultiSelectorDataDialogBinding.newInstance(this.bindingDocument);
_94c.selections=this.selections;
this.add(_94c);
_94c.attach();
this._dataDialogBinding=_94c;
this.shadowTree.datadialog=_94c;
}
};
...
while(list.hasNext()){
var _94f=list.getNext();
switch(this._display){
case MultiSelectorBinding.DISPLAY_SELECTED:
_94e=_94f.isSelected;
break;
case MultiSelectorBinding.DISPLAY_UNSELECTED:
_94e=_94f.isSelected!=true;
break;
}
if(_94e){
this.shadowTree.box.appendChild(this._getElementForSelection(_94f));
}
}
...
MultiSelectorBinding.prototype.cumulateFromList=function(list,_951){
var box=this.shadowTree.box;
var _953=false;
if(list.hasEntries()){
list.reverse().reset();
while(list.hasNext()){
var _954=list.getNext();
if(_951){
_954.isSelected=this._display==MultiSelectorBinding.DISPLAY_SELECTED;
_953=true;
}else{
switch(this._display){
case MultiSelectorBinding.DISPLAY_SELECTED:
_953=_954.isSelected;
break;
case MultiSelectorBinding.DISPLAY_UNSELECTED:
_953=_954.isSelected!=true;
break;
}
}
if(_953){
var _955=this._getElementForSelection(_954);
box.insertBefore(_955,box.firstChild);
CSSUtil.attachClassName(_955,"selected");
this._selectionMap.set(_954.value,_955);
}
}
this.dispatchAction(MultiSelectorBinding.ACTION_SELECTIONCHANGED);
}
};
MultiSelectorBinding.prototype._getElementForSelection=function(_956){
var _957=DOMUtil.createElementNS(Constants.NS_XHTML,"div",this.bindingDocument);
_957.appendChild(this.bindingDocument.createTextNode(_956.label));
_957.setAttribute("label",_956.label);
_957.setAttribute("value",_956.value);
return _957;
};
...
var _959=DOMEvents.getTarget(e);
var _95a=DOMUtil.getLocalName(_959);
if(_95a=="div"){
this._handleMouseDown(_959);
this.dispatchAction(MultiSelectorBinding.ACTION_SELECTIONCHANGED);
}
}
break;
...
MultiSelectorBinding.prototype._handleMouseDown=function(_95b){
if(Keyboard.isShiftPressed&&this._lastSelectedElement){
var _95c=this._getElements();
var _95d=_95b.getAttribute("value");
var _95e=this._lastSelectedElement.getAttribute("value");
var _95f=false;
while(_95c.hasNext()){
var el=_95c.getNext();
...
if(Keyboard.isControlPressed&&this._isHilited(_95b)){
this._unhilite(_95b);
}else{
this._hilite(_95b);
}
...
this._lastSelectedElement=_95b;
};
MultiSelectorBinding.prototype._hilite=function(_963){
var _964=_963.getAttribute("value");
if(!this._selectionMap.has(_964)){
CSSUtil.attachClassName(_963,"selected");
this._selectionMap.set(_964,_963);
}
};
MultiSelectorBinding.prototype._unhilite=function(_965){
var _966=_965.getAttribute("value");
if(this._selectionMap.has(_966)){
CSSUtil.detachClassName(_965,"selected");
this._selectionMap.del(_966);
}
};
MultiSelectorBinding.prototype._isHilited=function(_967){
return CSSUtil.hasClassName(_967,"selected");
};
MultiSelectorBinding.prototype.handleAction=function(_968){
MultiSelectorBinding.superclass.handleAction.call(this,_968);
var _969=_968.target;
switch(_968.type){
case DataDialogBinding.ACTION_COMMAND:
if(_969==this._dataDialogBinding){
if(!this.isFocused){
this.focus();
}
...
this.populateFromList(_969.result);
this.dirty();
_969.result=null;
_968.consume();
break;
...
var self=this;
this._getElements().each(function(_96c){
if(self._isHilited(_96c)){
_96c.parentNode.removeChild(_96c);
_96a.add(new SelectorBindingSelection(_96c.getAttribute("label"),_96c.getAttribute("value"),true));
}
});
this._selectionMap=new Map();
this.dispatchAction(MultiSelectorBinding.ACTION_SELECTIONCHANGED);
...
var _96e=this._getElements();
if(!isUp){
_96e.reverse();
}
var _96f=true;
while(_96f&&_96e.hasNext()){
var _970=_96e.getNext();
if(this._isHilited(_970)){
switch(isUp){
case true:
if(_970.previousSibling){
_970.parentNode.insertBefore(_970,_970.previousSibling);
}else{
_96f=false;
}
break;
case false:
if(_970.nextSibling){
_970.parentNode.insertBefore(_970,_970.nextSibling.nextSibling);
}else{
_96f=false;
}
break;
...
var _971=new List();
var _972=this._display==MultiSelectorBinding.DISPLAY_SELECTED;
var self=this;
this._getElements().each(function(_974){
var _975=new SelectorBindingSelection(_974.getAttribute("label"),_974.getAttribute("value"),_972);
_975.isHighlighted=self._isHilited(_974);
_971.add(_975);
});
return _971;
};
...
var _976=new List(DOMUtil.getElementsByTagName(this.bindingElement,"input"));
if(_976.hasEntries()){
_976.each(function(_977){
_977.parentNode.removeChild(_977);
});
}
this.selections.reset();
while(this.selections.hasNext()){
var _978=this.selections.getNext();
if(_978.isSelected){
var _979=DOMUtil.createElementNS(Constants.NS_XHTML,"input",this.bindingDocument);
_979.name=this._name;
_979.value=_978.value;
this.bindingElement.appendChild(_979);
}
}
};
...
MultiSelectorBinding.prototype.setValue=function(_97a){
alert(_97a);
};
...
MultiSelectorBinding.prototype.setResult=function(_97b){
...
var _97c={label:DataBinding.getAssociatedLabel(this),value:decodeURIComponent(this.getValue()),configuration:{"formattingconfiguration":this.getProperty("formattingconfiguration"),"elementclassconfiguration":this.getProperty("elementclassconfiguration"),"configurationstylesheet":this.getProperty("configurationstylesheet"),"presentationstylesheet":this.getProperty("presentationstylesheet"),"embedablefieldstypenames":this.getProperty("embedablefieldstypenames")}};
var _97d=ViewDefinitions["Composite.Management.VisualEditorDialog"];
_97d.handler=this._handler;
_97d.argument=_97c;
StageBinding.presentViewDefinition(_97d);
this._releaseKeyboard();
};
...
this.dispatchAction(DataDialogBinding.ACTION_COMMAND);
var _97e={label:DataBinding.getAssociatedLabel(this),selections:this.selections};
var self=this;
var _980={handleDialogResponse:function(_981,_982){
if(_981==Dialog.RESPONSE_ACCEPT){
self.result=_982;
self.dispatchAction(MultiSelectorDataDialogBinding.ACTION_RESULT);
}
}};
var _983=ViewDefinitions[this._dialogViewHandle];
_983.handler=_980;
_983.argument=_97e;
StageBinding.presentViewDefinition(_983);
};
MultiSelectorDataDialogBinding.newInstance=function(_984){
var _985=DOMUtil.createElementNS(Constants.NS_UI,"ui:datadialog",_984);
return UserInterface.registerBinding(_985,MultiSelectorDataDialogBinding);
};
...
LazyBindingBinding.wakeUp=function(_986){
var id=_986.bindingElement.id+LazyBindingBinding.ID_APPENDIX;
var _988=_986.bindingDocument.getElementById(id);
if(_988!=null){
...
if(id!=null){
var _98b=this.bindingDocument.getElementById(id);
if(_98b!=null){
var _98c=UserInterface.getBinding(_98b);
if(_98c&&!_98c.isAttached){
_98c.isLazy=true;
}else{
_98b.setAttribute("lazy",true);
}
}
}
};
...
LazyBindingBinding.prototype.setResult=function(_98d){
this._isLazy=_98d;
};
...
var url=this._url;
var _98f=this.getProperty("stateprovider");
var _990=this.getProperty("handle");
if(_98f!=null&&_990!=null){
url=url.replace("${stateprovider}",_98f).replace("${handle}",_990);
}else{
url=url.split("?")[0];
}
...
EditorDataBinding.prototype._onPageInitialize=function(_991){
EditorDataBinding.superclass._onPageInitialize.call(this,_991);
if(this._pageBinding!=null){
Application.unlock(this);
this._coverBinding.hide();
}
...
EditorDataBinding.prototype.handleAction=function(_992){
EditorDataBinding.superclass.handleAction.call(this,_992);
switch(_992.type){
...
EditorDataBinding.prototype.setValue=function(_993){
};
EditorDataBinding.prototype.getResult=function(){
return null;
};
EditorDataBinding.prototype.setResult=function(_994){
};
...
Binding.dotnetify(this);
var _99d=this.bindingDocument.getElementById(RequestBinding.INPUT_ID);
if(_99d!=null){
_99d.value=Application.CONSOLE_ID;
}
};
RequestBinding.prototype.postback=function(_99e){
_99e=_99e!=null?_99e:EditorPageBinding.message;
this.shadowTree.dotnetinput.value=_99e;
this.dispatchAction(PageBinding.ACTION_DOPOSTBACK);
};
...
var _99f=Templates.getTemplateElementText("fieldgroupmatrix.xml");
var _9a0=_99f.replace("MARKUP",this.bindingElement.innerHTML);
try{
this.bindingElement.innerHTML=_9a0;
}
catch(exception1){
...
var self=this;
var _9a2=DOMUtil.getElementsByTagName(this.bindingElement,"table").item(0);
new List(_9a2.rows).each(function(row){
...
var _9a5=this.getProperty("label");
if(_9a5){
this.setLabel(_9a5);
}else{
...
FieldGroupBinding.prototype.setLabel=function(_9a6){
this.setProperty("label",_9a6);
if(this.shadowTree.labelBinding==null){
var _9a7=LabelBinding.newInstance(this.bindingDocument);
var cell=this.shadowTree[FieldGroupBinding.NORTH];
_9a7.attachClassName("fieldgrouplabel");
cell.insertBefore(_9a7.bindingElement,cell.getElementsByTagName("div").item(1));
_9a7.attach();
this.shadowTree.labelBinding=_9a7;
}
this.shadowTree.labelBinding.setLabel(Resolver.resolve(_9a6));
};
FieldGroupBinding.prototype.getLabel=function(){
return this.getProperty("label");
};
FieldGroupBinding.prototype.add=function(_9a9){
this.shadowTree[FieldGroupBinding.CENTER].appendChild(_9a9.bindingElement);
return _9a9;
};
FieldGroupBinding.prototype.addFirst=function(_9aa){
var _9ab=this.shadowTree[FieldGroupBinding.CENTER];
_9ab.insertBefore(_9aa.bindingElement,_9ab.firstChild);
return _9aa;
};
...
this.attachClassName(Binding.CLASSNAME_CLEARFLOAT);
var _9ac=this.getProperty("relation");
if(_9ac!=null){
this.bindingRelation=_9ac;
this.subscribe(BroadcastMessages.BINDING_RELATE);
this.hide();
}
};
FieldBinding.prototype.handleBroadcast=function(_9ad,arg){
FieldBinding.superclass.handleBroadcast.call(this,_9ad,arg);
switch(_9ad){
...
FieldBinding.newInstance=function(_9af){
var _9b0=DOMUtil.createElementNS(Constants.NS_UI,"ui:field",_9af);
return UserInterface.registerBinding(_9b0,FieldBinding);
};
...
this.bindingElement.style.display="block";
var _9b1=this.getDescendantBindingByLocalName("fieldgroup");
if(_9b1!=null){
_9b1.attachClassName(FieldGroupBinding.CLASSNAME_FIRST);
}
};
...
var _9b2=true;
var _9b3=this.getDescendantBindingsByLocalName("*");
while(_9b3.hasNext()){
var _9b4=_9b3.getNext();
if(Interfaces.isImplemented(IData,_9b4)){
var _9b5=_9b4.validate();
if(_9b2&&!_9b5){
_9b2=false;
}
}
...
FieldsBinding.prototype.handleAction=function(_9b6){
FieldsBinding.superclass.handleAction.call(this,_9b6);
var _9b7=_9b6.target;
if(_9b7!=this){
switch(_9b6.type){
case Binding.ACTION_INVALID:
var _9b8=DataBinding.getAssociatedLabel(_9b7);
if(_9b8){
this._invalidFieldLabels.set(_9b7.key,_9b8);
}
if(_9b7.error){
if(!_9b7.isInvalidBecauseRequired){
ErrorBinding.presentError({text:_9b7.error},_9b7);
}
}
if(this._invalidCount==0){
this.dispatchAction(Binding.ACTION_INVALID);
...
if(this._invalidFieldLabels.has(_9b7.key)){
this._invalidFieldLabels.del(_9b7.key);
}
this._invalidCount--;
if(this._invalidCount==0){
this.dispatchAction(Binding.ACTION_VALID);
...
_9b9=this._invalidFieldLabels.toList();
}
return _9b9;
};
FieldsBinding.newInstance=function(_9ba){
var _9bb=DOMUtil.createElementNS(Constants.NS_UI,"ui:fields",_9ba);
return UserInterface.registerBinding(_9bb,FieldsBinding);
};
...
var _9bc=this.getProperty("image");
if(_9bc){
this.setImage(_9bc);
}
var _9bd=this.getProperty("tooltip");
if(_9bd){
this.setToolTip(_9bd);
}
...
switch(e.type){
case DOMEvents.CLICK:
var _9c0=this.getAncestorBindingByLocalName("field");
if(_9c0){
var _9c1=true;
_9c0.getDescendantBindingsByLocalName("*").each(function(_9c2){
if(Interfaces.isImplemented(IData,_9c2)){
_9c2.focus();
_9c1=false;
}
return _9c1;
...
FieldDescBinding.prototype.setLabel=function(_9c3){
this.setProperty("label",_9c3);
if(this.isAttached){
this.bindingElement.innerHTML=Resolver.resolve(_9c3);
}
};
...
FieldDescBinding.prototype.setImage=function(_9c6){
this.setProperty("image",_9c6);
if(this.isAttached){
throw "FieldDescBinding: Images not suppoerted!";
}
};
FieldDescBinding.prototype.setToolTip=function(_9c7){
this.setProperty("tooltip",_9c7);
if(this.isAttached){
this.bindingElement.title=_9c7;
}
};
FieldDescBinding.newInstance=function(_9c8){
var _9c9=DOMUtil.createElementNS(Constants.NS_UI,"ui:fielddesc",_9c8);
return UserInterface.registerBinding(_9c9,FieldDescBinding);
};
...
FieldDataBinding.newInstance=function(_9ca){
var _9cb=DOMUtil.createElementNS(Constants.NS_UI,"ui:fielddata",_9ca);
return UserInterface.registerBinding(_9cb,FieldDataBinding);
};
...
var _9cc=this._fieldHelpPopupBinding;
if(_9cc){
_9cc.dispose();
}
};
FieldHelpBinding.prototype.buildPopupBinding=function(){
var _9cd=app.bindingMap.fieldhelpopupset;
var doc=_9cd.bindingDocument;
var _9cf=_9cd.add(PopupBinding.newInstance(doc));
var _9d0=_9cf.add(PopupBodyBinding.newInstance(doc));
_9cf.position=PopupBinding.POSITION_RIGHT;
_9cf.attachClassName("fieldhelppopup");
if(this.bindingElement.hasChildNodes()){
_9d0.bindingElement.innerHTML=this.bindingElement.innerHTML;
}else{
var _9d1=this.getProperty("label");
if(_9d1){
_9d0.bindingElement.innerHTML=Resolver.resolve(_9d1);
}
}
this.bindingElement.innerHTML="";
this._fieldHelpPopupBinding=_9cf;
};
FieldHelpBinding.prototype.buildPopupButton=function(){
var _9d2=this.getAncestorBindingByLocalName("field");
if(_9d2){
_9d2.attachClassName("fieldhelp");
var _9d3=ClickButtonBinding.newInstance(this.bindingDocument);
_9d3.attachClassName("fieldhelp");
_9d3.setImage(FieldHelpBinding.INDICATOR_IMAGE);
this.add(_9d3);
_9d3.attach();
var self=this;
_9d3.oncommand=function(){
self.attachPopupBinding();
};
_9d3.setPopup(this._fieldHelpPopupBinding);
this._fieldHelpButton=_9d3;
}
};
FieldHelpBinding.prototype.attachPopupBinding=function(){
var _9d5=this._fieldHelpPopupBinding;
if(_9d5&&!_9d5.isAttached){
_9d5.attachRecursive();
}
};
...
RadioDataGroupBinding.prototype.handleAction=function(_9d7){
RadioDataGroupBinding.superclass.handleAction.call(this,_9d7);
switch(_9d7.type){
...
RadioDataGroupBinding.prototype.handleBroadcast=function(_9d9,arg){
RadioDataGroupBinding.superclass.handleBroadcast.call(this,_9d9,arg);
switch(_9d9){
case BroadcastMessages.KEY_ARROW:
var _9db=null;
var next=null;
...
case KeyEventCodes.VK_DOWN:
case KeyEventCodes.VK_UP:
_9dd=this.getChildBindingsByLocalName("radio");
while(!_9db&&_9dd.hasNext()){
var _9de=_9dd.getNext();
if(_9de.getProperty("ischecked")){
_9db=_9de;
}
}
break;
...
switch(arg){
case KeyEventCodes.VK_DOWN:
next=_9dd.getFollowing(_9db);
while(next!=null&&next.isDisabled){
next=_9dd.getFollowing(next);
}
break;
case KeyEventCodes.VK_UP:
next=_9dd.getPreceding(_9db);
while(next!=null&&next.isDisabled){
next=_9dd.getPreceding(next);
}
break;
}
}
...
RadioDataGroupBinding.prototype.focus=function(_9df){
if(!this.isFocused){
DataBinding.prototype.focus.call(this);
if(this.isFocused){
if(!_9df){
...
if(this.isAttached){
if(!this.shadowTree.input){
var _9e0=DOMUtil.createElementNS(Constants.NS_XHTML,"input",this.bindingDocument);
_9e0.type="hidden";
_9e0.name=this._name;
this.bindingElement.appendChild(_9e0);
this.shadowTree.input=_9e0;
}
this.shadowTree.input.value=this.getValue();
}
};
...
var _9e1=null;
var _9e2=this.getChildBindingsByLocalName("radio");
while(!_9e1&&_9e2.hasNext()){
var _9e3=_9e2.getNext();
if(_9e3.isChecked){
_9e1=_9e3.getProperty("value");
}
}
return _9e1;
};
RadioDataGroupBinding.prototype.getResult=RadioDataGroupBinding.prototype.getValue;
RadioDataGroupBinding.prototype.setValue=function(_9e4){
};
RadioDataGroupBinding.prototype.setResult=function(_9e5){
};
...
this.propertyMethodMap["checked"]=function(_9e6){
if(_9e6!=this.isChecked){
this.setChecked(_9e6,true);
}
};
this.propertyMethodMap["checksum"]=function(){
var _9e7=this.getProperty("ischecked");
...
var _9e8=this.getProperty("relate");
var _9e9=this.getProperty("oncommand");
if(_9e8){
this.bindingRelate=_9e8;
this.relate();
}
if(_9e9){
this.oncommand=function(){
Binding.evaluate(_9e9,this);
};
}
if(this.hasCallBackID()){
Binding.dotnetify(this);
...
var self=this;
var _9eb=this.getCallBackID();
this._buttonBinding.check=function(_9ec){
RadioButtonBinding.prototype.check.call(this,_9ec);
self.setProperty("ischecked",true);
self.isChecked=true;
self.relate();
};
this._buttonBinding.uncheck=function(_9ed){
RadioButtonBinding.prototype.uncheck.call(this,_9ed);
...
RadioDataBinding.prototype.setChecked=function(_9ee,_9ef){
this._buttonBinding.setChecked(_9ee,_9ef);
if(this.bindingRelate!=null){
this.relate();
}
this.setProperty("ischecked",_9ee);
};
RadioDataBinding.prototype.check=function(_9f0){
this.setChecked(true,_9f0);
};
RadioDataBinding.prototype.uncheck=function(_9f1){
this.setChecked(false,_9f1);
};
RadioDataBinding.prototype.setDisabled=function(_9f2){
if(_9f2!=this.isDisabled){
this.isDisabled=_9f2;
this._buttonBinding.setDisabled(_9f2);
if(_9f2){
...
var _9f4=DOMEvents.getTarget(e);
switch(_9f4){
...
this.shadowTree.labelText.appendChild(this.bindingDocument.createTextNode(Resolver.resolve(_9f5)));
...
RadioDataBinding.prototype.setLabel=function(_9f6){
if(this.shadowTree.labelText!=null){
this.shadowTree.labelText.firstChild.data=_9f6;
}
...
if(e.type==DOMEvents.CLICK){
var _9fa=DOMEvents.getTarget(e);
switch(_9fa){
case this.shadowTree.labelText:
this.setChecked(!this.isChecked);
break;
...
CheckBoxBinding.prototype.handleBroadcast=function(_9fb,arg){
CheckBoxBinding.superclass.handleBroadcast.call(this,_9fb,arg);
switch(_9fb){
case BroadcastMessages.KEY_SPACE:
this.setChecked(!this.isChecked);
break;
...
var self=this;
this._buttonBinding.addActionListener(ButtonBinding.ACTION_COMMAND,{handleAction:function(_9fe){
_9fe.consume();
...
ButtonBinding.prototype.check.call(this,_a01);
self.setProperty("ischecked",true);
self.isChecked=true;
self.relate();
if(!_a01){
...
ButtonBinding.prototype.uncheck.call(this,_a02);
...
var _a03=true;
var _a04=this.bindingElement.parentNode;
if(_a04){
var _a05=UserInterface.getBinding(_a04);
if(_a05&&_a05 instanceof CheckBoxGroupBinding){
if(_a05.isRequired){
if(_a05.isValid){
_a03=_a05.validate();
}else{
...
var _a07=null;
var _a08=this.getProperty("value");
if(this.isChecked){
_a07=_a08?_a08:"on";
}
return _a07;
};
CheckBoxBinding.prototype.setValue=function(_a09){
if(_a09==this.getValue()||_a09=="on"){
this.check(true);
}else{
if(_a09!="on"){
this.setPropety("value",_a09);
}
}
};
...
var _a0a=false;
if(this.isChecked){
_a0a=this._result!=null?this._result:true;
}
return _a0a;
};
CheckBoxBinding.prototype.setResult=function(_a0b){
if(typeof _a0b=="boolean"){
this.setChecked(_a0b,true);
}else{
this._result=_a0b;
}
};
CheckBoxBinding.newInstance=function(_a0c){
var _a0d=DOMUtil.createElementNS(Constants.NS_UI,"ui:checkbox",_a0c);
return UserInterface.registerBinding(_a0d,CheckBoxBinding);
};
...
var _a0e=true;
if(this.isRequired){
var _a0f=this.getDescendantBindingsByLocalName("checkbox");
if(_a0f.hasEntries()){
_a0e=false;
while(_a0f.hasNext()&&!_a0e){
if(_a0f.getNext().isChecked){
_a0e=true;
}
}
}
...
CheckBoxGroupBinding.prototype._showWarning=function(_a10){
if(_a10){
if(!this._labelBinding){
var _a11=LabelBinding.newInstance(this.bindingDocument);
_a11.attachClassName("invalid");
_a11.setImage("${icon:error}");
_a11.setLabel("Selection required");
this._labelBinding=this.addFirst(_a11);
...
CheckBoxGroupBinding.prototype.handleAction=function(_a12){
CheckBoxGroupBinding.superclass.handleAction.call(this,_a12);
switch(_a12.type){
...
CheckBoxGroupBinding.newInstance=function(_a13){
var _a14=DOMUtil.createElementNS(Constants.NS_UI,"ui:checkboxgroup",_a13);
return UserInterface.registerBinding(_a14,CheckBoxGroupBinding);
};
...
var _a15=DialogControlBinding.newInstance(this.bindingDocument);
_a15.setControlType(ControlBinding.TYPE_CLOSE);
this._controlGroupBinding.add(_a15);
this._controlGroupBinding.attachRecursive();
var _a16=DOMUtil.createElementNS(Constants.NS_UI,"ui:balloonspeak",this.bindingDocument);
this.bindingElement.appendChild(_a16);
var _a17=this.getLabel();
if(_a17!=null){
this.setLabel(_a17);
}
};
...
if(Binding.exists(_a18)==true){
_a18.removeActionListener(Binding.ACTION_BLURRED,this);
_a18.removeActionListener(Binding.ACTION_VALID,this);
}
};
BalloonBinding.prototype.snapTo=function(_a19){
if(Interfaces.isImplemented(IData,_a19)){
this._snapTargetBinding=_a19;
var _a1a=_a19.dispatchAction(BalloonBinding.ACTION_INITIALIZE);
if(_a1a&&_a1a.isConsumed){
this._environmentBinding=_a1a.listener;
}
if(this._environmentBinding){
_a19.addActionListener(Binding.ACTION_BLURRED,this);
_a19.addActionListener(Binding.ACTION_VALID,this);
...
_a19.dispatchAction(BalloonBinding.ACTION_SNAP);
}else{
...
var _a1d=this._environmentBinding;
var root=UserInterface.getBinding(_a1c.bindingDocument.body);
if(Binding.exists(_a1c)&&Binding.exists(_a1d)){
if(!root.isActivated){
if(this.isVisible==true){
this.hide();
}
}else{
if(_a1c.isAttached&&_a1d.isAttached){
var _a1f=_a1c.boxObject.getUniversalPosition();
var _a20=_a1d.boxObject.getUniversalPosition();
_a20.y+=_a1d.bindingElement.scrollTop;
_a20.x+=_a1d.bindingElement.scrollLeft;
var tDim=_a1c.boxObject.getDimension();
var eDim=_a1d.boxObject.getDimension();
var _a23=false;
if(_a1f.y+tDim.h<_a20.y){
_a23=true;
}else{
if(_a1f.x+tDim.w<_a20.x){
_a23=true;
}else{
if(_a1f.y>_a20.y+eDim.h){
_a23=true;
}else{
if(_a1f.x>_a20.x+eDim.w){
_a23=true;
}
}
}
...
if(!_a23){
this._setComputedPosition(_a1f,_a20,tDim,eDim);
if(!this.isVisible){
this.show();
}
}else{
...
BalloonBinding.prototype._setComputedPosition=function(_a24,_a25,tDim,eDim){
var wDim=WindowManager.getWindowDimensions();
var bDim=this._getDimension();
var _a2a=_a24;
var _a2b=false;
if(_a24.x+tDim.w+bDim.w+BalloonBinding.OFFSET_X>=wDim.w){
_a2b=true;
}else{
if(_a24.x+tDim.w>=_a25.x+eDim.w){
_a2b=true;
}
}
if(_a2b){
_a2a.x-=(bDim.w+BalloonBinding.OFFSET_X);
this.attachClassName(BalloonBinding.CLASSNAME_LEFT);
}else{
_a2a.x+=tDim.w+BalloonBinding.OFFSET_X;
this.detachClassName(BalloonBinding.CLASSNAME_LEFT);
}
_a2a.y-=(bDim.h);
_a2a.y+=BalloonBinding.OFFSET_Y;
this._setPosition(_a2a);
};
BalloonBinding.prototype.handleBroadcast=function(_a2c,arg){
BalloonBinding.superclass.handleBroadcast.call(this,_a2c,arg);
switch(_a2c){
...
BalloonBinding.prototype._isAssociatedView=function(_a2e){
var _a2f=false;
if(this._snapTargetBinding){
var view=this._snapTargetBinding.getAncestorBindingByType(ViewBinding,true);
if(view&&view.getHandle()==_a2e){
_a2f=true;
}
}
return _a2f;
};
BalloonBinding.prototype._setPosition=function(_a31){
var _a32=false;
...
if(!_a32){
this.bindingElement.style.left=_a31.x+"px";
this.bindingElement.style.top=_a31.y+"px";
this._point=_a31;
}
};
...
BalloonBinding.prototype.handleAction=function(_a34){
BalloonBinding.superclass.handleAction.call(this,_a34);
var _a35=_a34.target;
switch(_a34.type){
case Binding.ACTION_ACTIVATED:
if(this._snapTargetBinding){
...
case Binding.ACTION_BLURRED:
case Binding.ACTION_VALID:
if(_a35==this._snapTargetBinding){
var self=this;
setTimeout(function(){
if(!Binding.exists(_a35)){
self.dispose();
}else{
if(_a35.validate()){
var _a37=true;
if(_a34.type==Binding.ACTION_BLURRED){
var root=_a35.bindingDocument.body;
...
BalloonBinding.prototype.setLabel=function(_a3a){
if(this.isAttached==true){
if(!this._isTableIndexed){
this._indexTable();
}
var _a3b=DOMUtil.createElementNS(Constants.NS_UI,"ui:balloontext",this.bindingDocument);
var text=this.bindingDocument.createTextNode(_a3a);
_a3b.appendChild(text);
this.shadowTree[MatrixBinding.CENTER].appendChild(_a3b);
}
this.setProperty("label",_a3a);
};
BalloonBinding.prototype.getLabel=function(){
return this.getProperty("label");
};
BalloonBinding.newInstance=function(_a3d){
var _a3e=DOMUtil.createElementNS(Constants.NS_UI,"ui:balloon",_a3d);
var _a3f=UserInterface.registerBinding(_a3e,BalloonBinding);
_a3f.hide();
return _a3f;
};
...
ErrorBinding.presentError=function(_a40,_a41){
if(Interfaces.isImplemented(IData,_a41)==true){
var _a42,_a43=_a41.dispatchAction(ErrorBinding.ACTION_INITIALIZE);
if(_a43&&_a43.isConsumed){
switch(_a43.listener.constructor){
case StageBinding:
_a42=false;
break;
...
var _a44=_a42?top.app.bindingMap.dialogballoonset:top.app.bindingMap.balloonset;
var _a45=_a44.add(BalloonBinding.newInstance(top.app.document));
_a45.setLabel(_a40.text);
_a45.snapTo(_a41);
_a45.attach();
}
};
...
var _a46=this.bindingWindow.DataManager;
var text=this.getProperty("text");
var name=this.getProperty("targetname");
var _a49=_a46.getDataBinding(name);
if(_a49){
ErrorBinding.presentError({text:text},_a49);
}else{
...
FocusBinding.focusElement=function(_a4a){
var _a4b=true;
try{
_a4a.focus();
Application.focused(true);
...
var _a4c=UserInterface.getBinding(_a4a);
var _a4d=SystemLogger.getLogger("FocusBinding.focusElement");
_a4d.warn("Could not focus "+(_a4c?_a4c.toString():String(_a4a)));
_a4b=false;
}
return _a4b;
};
...
FocusBinding.getCachedFocus=function(_a4e){
var win=_a4e.bindingWindow;
var id=_a4e.bindingElement.id;
return {getBinding:function(){
var _a51=null;
try{
if(Binding.exists(_a4e)){
_a51=win.bindingMap[id];
}
}
catch(exception){
}
...
FocusBinding.navigateNext=function(_a52){
if(Binding.exists(FocusBinding.activeInstance)){
FocusBinding.activeInstance.focusNext(_a52);
}
};
...
var _a53=this.dispatchAction(FocusBinding.ACTION_ATTACHED);
if(_a53&&_a53.isConsumed){
if(_a53.listener.isStrongFocusManager){
this._isFocusManager=false;
}
}
if(this._isFocusManager){
...
FocusBinding.prototype.handleAction=function(_a54){
FocusBinding.superclass.handleAction.call(this,_a54);
...
if(Application.isOperational){
_a56=new FocusCrawler();
_a56.mode=FocusCrawler.MODE_BLUR;
_a56.crawl(_a55.bindingElement);
...
if(Application.isOperational&&_a55!=this){
_a56=new FocusCrawler();
_a56.mode=FocusCrawler.MODE_FOCUS;
_a56.crawl(_a55.bindingElement);
}
_a54.consume();
break;
case Binding.ACTION_FOCUSED:
if(Interfaces.isImplemented(IFocusable,_a55)){
this.claimFocus();
this._onFocusableFocused(_a55);
}
_a54.consume();
break;
case Binding.ACTION_BLURRED:
if(Interfaces.isImplemented(IFocusable,_a55)){
this._onFocusableBlurred(_a55);
}
_a54.consume();
break;
}
...
FocusBinding.prototype.focusNext=function(_a57){
var _a58=null;
var list=this._getFocusableList();
if(list.reset().hasEntries()){
while(_a58==null&&list.hasNext()){
var _a5a=list.getNext();
if(this._cachedFocus&&_a5a==this._cachedFocus.getBinding()){
_a58=_a5a;
}
}
if(_a58!=null){
if(_a5a.isFocused){
var next=_a57?list.getPreceding(_a58):list.getFollowing(_a58);
if(!next){
next=_a57?list.getLast():list.getFirst();
}
next.focus();
}else{
_a58.focus();
...
if(!this._isUpToDate){
var _a5c=new FocusCrawler();
var list=new List();
_a5c.mode=FocusCrawler.MODE_INDEX;
_a5c.crawl(this.bindingElement,list);
...
var _a60=this._cachedFocus.getBinding();
if(_a60&&!_a60.isFocused){
_a60.focus();
}
}
};
FocusBinding.prototype._onFocusableFocused=function(_a61){
if(_a61!=FocusBinding.focusedBinding){
if(FocusBinding.focusedBinding!=null){
if(Binding.exists(FocusBinding.focusedBinding)){
FocusBinding.focusedBinding.blur();
}
}
FocusBinding.focusedBinding=_a61;
_a61.setProperty(FocusBinding.MARKER,true);
this._cachedFocus=FocusBinding.getCachedFocus(_a61);
}
};
FocusBinding.prototype._onFocusableBlurred=function(_a62){
_a62.deleteProperty(FocusBinding.MARKER);
...
TabsButtonBinding.prototype.show=function(_a64){
this.bindingElement.style.left=_a64+"px";
...
TabsButtonBinding.prototype.registerHiddenTabBinding=function(_a65){
this.hiddenTabBindings.add(_a65);
};
...
var _a66=this.hiddenTabBindings.getNext();
var item=MenuItemBinding.newInstance(this.popupBinding.bindingDocument);
item.setLabel(_a66.getLabel());
item.setImage(_a66.getImage());
item.associatedTabBinding=_a66;
var self=this;
...
TabsButtonBinding.prototype.handleAction=function(_a69){
TabsButtonBinding.superclass.handleAction.call(this,_a69);
switch(_a69.type){
case PopupBinding.ACTION_HIDE:
this.popupBinding.removeActionListener(PopupBinding.ACTION_HIDE,this);
var _a6a=this.selectedTabBinding;
if(_a6a){
this.containingTabBoxBinding.moveToOrdinalPosition(_a6a,0);
this.containingTabBoxBinding.select(_a6a);
}
_a69.consume();
break;
}
};
TabsButtonBinding.newInstance=function(_a6b){
var _a6c=DOMUtil.createElementNS(Constants.NS_UI,"ui:toolbarbutton",_a6b);
_a6c.setAttribute("type","checkbox");
_a6c.setAttribute("popup","app.bindingMap.tabsbuttonpopup");
_a6c.className="tabbutton";
return UserInterface.registerBinding(_a6c,TabsButtonBinding);
};
...
if(Keyboard.isControlPressed){
var _a6d=TabBoxBinding.currentActiveInstance;
if(_a6d!=null&&Binding.exists(_a6d)){
}
}
}});
...
var _a6e=this.getTabElements().getLength();
var _a6f=this.getTabPanelElements().getLength();
...
var _a70=this.getTabPanelElements();
while(_a70.hasNext()){
this._setupWarningSystem(UserInterface.getBinding(_a70.getNext()));
}
if(this.isEqualSize){
...
var _a71=DOMUtil.getOrdinalPosition(this._tabsElement);
var _a72=DOMUtil.getOrdinalPosition(this._tabPanelsElement);
var _a73=_a71>_a72?"tabsbelow":"tabsontop";
this.attachClassName(_a73);
};
TabBoxBinding.prototype._TEMPNAME=function(){
var tabs=this.getTabElements();
var _a75=this.getTabPanelElements();
var _a76=null;
var _a77=this.getProperty("selectedindex");
if(_a77!=null){
if(_a77>tabs.getLength()-1){
...
var _a7a=_a75.getNext();
this.registerTabBoxPair(tab,_a7a);
if(_a77&&_a78==_a77){
...
if(!_a76){
_a76=tabs.getFirst();
_a76.setAttribute("selected","true");
}
}
};
TabBoxBinding.prototype.enforceEqualSize=function(_a7b){
var _a7c=null;
var _a7d=null;
if(this.isEqualSize){
var _a7e=CSSComputer.getPadding(this._tabPanelsElement);
var max=0,_a80=this.getTabPanelElements();
_a80.each(function(_a81){
max=_a81.offsetHeight>max?_a81.offsetHeight:max;
});
_a7d=max+_a7e.top+_a7e.bottom;
if(_a7b&&this._tabPanelsElement.style.height!=null){
_a7c=this._tabPanelsElement.offsetHeight;
}
if(_a7c!=null||_a7d>_a7c){
this._tabPanelsElement.style.height=_a7d+"px";
}
}
};
TabBoxBinding.prototype._setupWarningSystem=function(_a82){
_a82._invalidCount=0;
_a82.addActionListener(Binding.ACTION_INVALID,this);
_a82.addActionListener(Binding.ACTION_VALID,this);
_a82.addActionListener(BalloonBinding.ACTION_SNAP,this);
};
TabBoxBinding.prototype.handleAction=function(_a83){
TabBoxBinding.superclass.handleAction.call(this,_a83);
var _a84=_a83.target;
var _a85=_a83.listener;
switch(_a83.type){
case Binding.ACTION_ATTACHED:
break;
case Binding.ACTION_DETACHED:
if(_a84.constructor==this._impl_tab){
...
break;
case PageBinding.ACTION_INITIALIZED:
if(_a84.isDialogSubPage&&this.isEqualSize){
this.enforceEqualSize();
}
break;
case Binding.ACTION_INVALID:
_a85._invalidCount++;
if(_a85._invalidCount==1){
var self=this;
setTimeout(function(){
if(!_a85.isSelected){
self._showWarning(_a85,true);
}
},0);
}
break;
case Binding.ACTION_VALID:
if(_a85._invalidCount>0){
_a85._invalidCount--;
if(_a85._invalidCount==0){
if(_a85.isSelected){
this._showWarning(_a85,false);
}
}
}
break;
case BalloonBinding.ACTION_SNAP:
this._showBalloon(_a85,true);
break;
case Binding.ACTION_ACTIVATED:
case Binding.ACTION_FOCUSED:
if(_a83._tabboxstamp==null){
TabBoxBinding.currentActiveInstance=this;
_a83._tabboxstamp="stamped";
}
break;
}
};
...
switch(e.type){
case DOMEvents.AFTERUPDATE:
var _a88=DOMEvents.getTarget(e);
if(_a88==this.bindingDocument.documentElement){
if(this._hasBastardUpdates){
this._hasBastardUpdates=false;
var tabs=this.getTabElements();
var _a8a=this.getTabPanelElements();
tabs.each(function(tab,_a8c){
if(tab.getAttribute(TabBoxBinding.ASSOCIATION_KEY)==null){
var _a8d=_a8a.get(_a8c);
this.registerTabBoxPair(tab,_a8d);
}
},this);
var _a8e=this._tabBoxPairs;
for(var key in _a8e){
var tab=_a8e[key].tab;
...
if(!this._hasBastardUpdates){
var name=DOMUtil.getLocalName(_a88);
switch(_a88.__updateType){
case Update.TYPE_INSERT:
switch(name){
case this._nodename_tab:
case this._nodename_tabpanel:
var _a92=_a88.parentNode;
if(_a92==this._tabsElement||_a92==this._tabPanelsElement){
...
if(_a88==this._tabsElement||_a88==this._tabPanelsElement){
this._hasBastardUpdates=true;
}
break;
}
...
TabBoxBinding.prototype.select=function(arg,_a94){
var _a95=this.getBindingForArgument(arg);
if(_a95!=null&&!_a95.isSelected){
...
_a95.select(_a94);
this.getTabPanelBinding(_a95).select(_a94);
var _a96=this.getProperty("selectedindex");
if(_a96!=null){
this.setProperty("selectedindex",DOMUtil.getOrdinalPosition(_a95.bindingElement,true));
}
this._selectedTabBinding=_a95;
this.dispatchAction(TabBoxBinding.ACTION_SELECTED);
this.dispatchAction(FocusBinding.ACTION_UPDATE);
if(_a95.getImage()==TabBoxBinding.BALLOON_TAB_IMAGE){
var _a97=this.getTabPanelBinding(_a95);
this._showBalloon(_a97,false);
}
}
};
TabBoxBinding.prototype.registerTabBoxPair=function(tab,_a99){
var key=KeyMaster.getUniqueKey();
tab.setAttribute(TabBoxBinding.ASSOCIATION_KEY,key);
_a99.setAttribute(TabBoxBinding.ASSOCIATION_KEY,key);
this._tabBoxPairs[key]={tab:tab,tabPanel:_a99};
};
...
TabBoxBinding.prototype.getTabPanelBinding=function(_a9d){
var _a9e=null;
try{
var key=_a9d.getProperty(TabBoxBinding.ASSOCIATION_KEY);
var _aa0=this._tabBoxPairs[key].tabPanel;
_a9e=UserInterface.getBinding(_aa0);
}
catch(exception){
this.logger.error(exception);
SystemDebug.stack(arguments);
...
TabBoxBinding.prototype.getTabBinding=function(_aa1){
var key=_aa1.getProperty(TabBoxBinding.ASSOCIATION_KEY);
var _aa3=this._tabBoxPairs[key].tab;
return UserInterface.getBinding(_aa3);
};
...
var _aa4=this._impl_tabpanel.newInstance(this.bindingDocument);
this._setupWarningSystem(_aa4);
return _aa4;
};
TabBoxBinding.prototype.appendTabByBindings=function(_aa5,_aa6){
var _aa7=_aa5.bindingElement;
_aa5.setProperty("selected",true);
var _aa8=this.summonTabPanelBinding();
var _aa9=_aa8.bindingElement;
if(_aa6){
_aa9.appendChild(_aa6 instanceof Binding?_aa6.bindingElement:_aa6);
}
this.registerTabBoxPair(_aa7,_aa9);
UserInterface.getBinding(this._tabsElement).add(_aa5);
this._tabPanelsElement.appendChild(_aa9);
_aa5.attach();
UserInterface.getBinding(_aa9).attachRecursive();
this.updateType=TabBoxBinding.UPDATE_ATTACH;
this.dispatchAction(TabBoxBinding.ACTION_UPDATED);
return _aa5;
};
TabBoxBinding.prototype.importTabBinding=function(_aaa){
var that=_aaa.containingTabBoxBinding;
var _aac=that.getTabPanelBinding(_aaa);
var _aad=_aac.getBindingElement();
var _aae=_aaa.getBindingElement();
that.dismissTabBinding(_aaa);
this._tabsElement.appendChild(_aae);
this._tabPanelsElement.appendChild(_aad);
this.registerTabBoxPair(_aae,_aad);
_aaa.containingTabBoxBinding=this;
this.select(_aaa);
this.dispatchAction(Binding.ACTION_ACTIVATED);
this.dispatchAction(TabBoxBinding.ACTION_UPDATED);
};
TabBoxBinding.prototype.removeTab=function(_aaf){
var _ab0=null;
if(_aaf.isSelected){
_ab0=this.getBestTab(_aaf);
this._selectedTabBinding=null;
}
var _ab1=this.getTabPanelBinding(_aaf);
this.unRegisterTabBoxPair(_aaf.bindingElement);
_aaf.dispose();
_ab1.dispose();
if(_ab0!=null){
this.select(_ab0);
...
TabBoxBinding.prototype.dismissTabBinding=function(_ab2){
if(_ab2.isSelected){
this.selectBestTab(_ab2);
}
};
TabBoxBinding.prototype.selectBestTab=function(_ab3){
var _ab4=this.getBestTab(_ab3);
if(_ab4){
this.select(_ab4);
}else{
this._selectedTabBinding=null;
...
TabBoxBinding.prototype.getBestTab=function(_ab5){
var _ab6=null;
var _ab7=_ab5.getOrdinalPosition(true);
var _ab8=this.getTabBindings();
var _ab9=_ab8.getLength();
var _aba=_ab9-1;
if(_ab9==1){
_ab6=null;
}else{
if(_ab7==_aba){
_ab6=_ab8.get(_ab7-1);
}else{
_ab6=_ab8.get(_ab7+1);
}
}
...
TabBoxBinding.prototype.moveToOrdinalPosition=function(_abb,_abc){
var _abd=this.bindingDocument.getElementById(_abb.bindingElement.id);
var tab=this.getTabElements().get(_abc);
this._tabsElement.insertBefore(_abd,tab);
...
var _abf=this._nodename_tab;
var _ac0=new List(this._tabsElement.childNodes);
var _ac1=new List();
while(_ac0.hasNext()){
var _ac2=_ac0.getNext();
...
var _ac3=this._nodename_tabpanel;
var _ac4=new List(this._tabPanelsElement.childNodes);
var _ac5=new List();
_ac4.each(function(_ac6){
...
var _ac7=new List();
var _ac8=this.getTabElements();
_ac8.each(function(_ac9){
_ac7.add(UserInterface.getBinding(_ac9));
});
return _ac7;
};
TabBoxBinding.prototype.getTabPanelBindings=function(){
var _aca=new List();
this.getTabPanelElements().each(function(_acb){
_aca.add(UserInterface.getBinding(_acb));
});
return _aca;
};
...
_acc=this.getTabPanelBinding(this._selectedTabBinding);
}
return _acc;
};
TabBoxBinding.prototype._showWarning=function(_acd,_ace){
var _acf=this.getTabBinding(_acd);
if(_ace){
if(_acf.labelBinding.hasImage){
_acf._backupImage=_acf.getImage();
}
_acf.setImage(TabBoxBinding.INVALID_TAB_IMAGE);
}else{
if(_acf._backupImage){
...
TabBoxBinding.prototype._showBalloon=function(_ad0,_ad1){
var _ad2=this.getTabBinding(_ad0);
if((_ad1&&!_ad2.isSelected)||!_ad1){
if(_ad2.getImage()!=TabBoxBinding.INVALID_TAB_IMAGE){
if(_ad1){
if(_ad2.labelBinding.hasImage){
_ad2._backupImage=_ad2.getImage();
}
_ad2.setImage(TabBoxBinding.BALLOON_TAB_IMAGE);
}else{
if(_ad2._backupImage!=null){
...
TabBoxBinding.prototype.advanceSelection=function(_ad3){
var tab=this.getSelectedTabBinding();
var tabs=this.getTabBindings();
var _ad6=tab.getOrdinalPosition(true);
var next=null;
var _ad8=new List();
...
var _adb=this.constructor.TABBUTTON_IMPLEMENTATION;
this.tabsButtonBinding=_adb.newInstance(this.bindingDocument);
this.shadowTree.tabsButton=this.tabsButtonBinding;
this.add(this.tabsButtonBinding);
this.tabsButtonBinding.attach();
};
TabsBinding.prototype.handleAction=function(_adc){
TabsBinding.superclass.handleAction.call(this,_adc);
switch(_adc.type){
...
function manage(){
if(Binding.exists(self)==true){
var _adf=self.bindingElement.offsetWidth;
if(_adf!=self._cachedOffsetWidth){
self.manage();
}
self._cachedOffsetWidth=_adf;
}
}
setTimeout(manage,0);
}
};
TabsBinding.prototype.add=function(_ae0){
if(_ae0 instanceof TabBinding){
if(this.tabsButtonBinding&&this.tabsButtonBinding.isVisible){
this.tabsButtonBinding.hide();
}
}
return TabsBinding.superclass.add.call(this,_ae0);
};
TabsBinding.prototype.manage=function(){
if(Binding.exists(this)==true&&this.isVisible){
this.isManaging=true;
var _ae1=false;
var _ae2,tab,tabs=this.containingTabBoxBinding.getTabElements();
var _ae5=this.constructor.TABBUTTON_IMPLEMENTATION;
var _ae6=this.bindingElement.offsetWidth-_ae5.RESERVED_SPACE;
var _ae7=null;
var sum=0,_ae9=0;
var _aea=true;
if(tabs.hasEntries()){
this.tabsButtonBinding.reset();
while(tabs.hasNext()&&_aea){
tab=tabs.getNext();
_ae2=UserInterface.getBinding(tab);
if(!_ae7){
_ae7=_ae2;
}
sum+=tab.offsetWidth;
...
_ae1=true;
if(_ae2.isSelected){
if(!DOMUtil.isFirstElement(_ae2.bindingElement,true)){
this.isManaging=false;
if(_ae7){
_ae7.hide();
...
this.containingTabBoxBinding.moveToOrdinalPosition(_ae2,_ae9-1);
_aea=false;
}
}else{
_ae2.hide();
this.tabsButtonBinding.registerHiddenTabBinding(_ae2);
}
}else{
_ae2.show();
_ae7=_ae2;
...
if(_aea){
if(_ae1&&this.tabsButtonBinding.hiddenTabBindings.hasEntries()){
var _aeb=_ae7.getBindingElement();
var _aec=_aeb.offsetLeft+_aeb.offsetWidth;
var _aed=this.tabsButtonBinding;
setTimeout(function(){
_aed.show(_aec+4);
},50);
}else{
...
var _aee=TabBinding.superclass.serialize.call(this);
if(_aee){
_aee.label=this.getLabel();
_aee.image=this.getImage();
_aee.tooltip=this.getToolTip();
}
return _aee;
};
...
var _aef=this.bindingElement.getAttribute("image");
var _af0=this.bindingElement.getAttribute("label");
var _af1=this.bindingElement.getAttribute("tooltip");
...
TabBinding.prototype.setLabel=function(_af3){
if(_af3!=null){
this.setProperty("label",_af3);
if(this.isAttached){
this.labelBinding.setLabel(_af3);
}
}
};
...
TabBinding.prototype.setToolTip=function(_af4){
if(_af4){
this.setProperty("tooltip",_af4);
if(this.isAttached){
this.labelBinding.setToolTip(_af4);
}
}
};
...
TabBinding.prototype.select=function(_af7){
this.show();
...
TabBinding.newInstance=function(_af8){
var _af9=DOMUtil.createElementNS(Constants.NS_UI,"ui:tab",_af8);
return UserInterface.registerBinding(_af9,TabBinding);
};
...
TabPanelBinding.prototype.select=function(_afd){
if(!this.isSelected){
if(this.isLazy){
this.wakeUp("select");
}else{
...
TabPanelBinding.prototype.handleAction=function(_afe){
TabPanelBinding.superclass.handleAction.call(this,_afe);
var _aff=_afe.target;
switch(_afe.type){
case BalloonBinding.ACTION_INITIALIZE:
_afe.consume();
break;
...
TabPanelBinding.newInstance=function(_b00){
var _b01=DOMUtil.createElementNS(Constants.NS_UI,"ui:tabpanel",_b00);
UserInterface.registerBinding(_b01,TabPanelBinding);
...
if(_b02){
_b02.orient=this.getOrient();
_b02.layout=this.getLayout();
}
return _b02;
};
...
var _b03=this.getSplitPanelElements();
if(_b03.hasEntries()){
var _b04=new List(this.getLayout().split(":"));
if(_b04.getLength()!=_b03.getLength()){
throw new Error(this+" DOM subree invalid");
}else{
_b03.each(function(_b05){
_b05.setAttribute("ratio",_b04.getNext());
});
}
}
...
var _b06=this.getProperty("orient");
if(_b06){
this._orient=_b06;
}
...
var _b07=this.getSplitterBindings();
while(_b07.hasNext()){
var _b08=_b07.getNext();
if(_b08&&_b08.getProperty("collapsed")==true){
_b08.collapse();
}
}
};
SplitBoxBinding.prototype.handleAction=function(_b09){
SplitBoxBinding.superclass.handleAction.call(this,_b09);
switch(_b09.type){
...
this.collapse(_b09.target);
_b09.consume();
break;
case SplitterBinding.ACTION_UNCOLLAPSE:
this.unCollapse(_b09.target);
_b09.consume();
break;
}
};
...
SplitBoxBinding.prototype.collapse=function(_b0a){
this._getSplitPanelBindingForSplitter(_b0a).collapse();
this.invokeLayout();
};
SplitBoxBinding.prototype.unCollapse=function(_b0b){
this._getSplitPanelBindingForSplitter(_b0b).unCollapse();
this.invokeLayout();
};
SplitBoxBinding.prototype._getSplitPanelBindingForSplitter=function(_b0c){
var _b0d=DOMUtil.getOrdinalPosition(_b0c.bindingElement,true);
var _b0e,_b0f=this.getSplitPanelElements();
switch(_b0c.getCollapseDirection()){
case SplitterBinding.COLLAPSE_BEFORE:
_b0e=_b0f.get(_b0d);
break;
case SplitterBinding.COLLAPSE_AFTER:
_b0e=_b0f.get(_b0d+1);
break;
}
return UserInterface.getBinding(_b0e);
};
SplitBoxBinding.prototype.invokeLayout=function(_b10){
var _b11=this.isHorizontalOrient();
var _b12=this.getSplitPanelBindings();
var _b13=this.getSplitterBindings();
var _b14=new List();
var _b15,sum=0;
var _b17=0;
_b12.each(function(_b18){
if(_b18.isFixed==true){
if(!_b12.hasNext()){
_b17+=_b18.getFix();
}
_b14.add(0);
...
if(_b14.getLength()!=_b12.getLength()){
throw new Error(this+" Invalid property (ratio)");
}else{
var _b19=_b11?this.getWidth():this.getHeight();
_b19-=_b17;
_b13.each(function(_b1a){
if(_b1a.isVisible){
_b19-=SplitterBinding.DIMENSION;
}
});
var unit=_b19/sum;
var _b1c=0;
var self=this;
_b12.each(function(_b1e){
var span=0;
var _b20=_b14.getNext();
if(_b1e.isFixed){
span=_b1e.getFix();
}else{
span=Math.round(unit*_b20);
if(isNaN(span)){
...
var _b21=this.getLayout();
if(_b21){
this.setProperty("layout",_b21);
}
}
};
...
var _b28=null;
var span=null;
_b23.each(function(_b2a){
if(!unit){
unit=_b22?_b2a.getWidth():_b2a.getHeight();
}
span=_b22?_b2a.getWidth():_b2a.getHeight();
if(_b28){
span-=_b28;
_b28=null;
}
...
SplitBoxBinding.prototype.setLayout=function(_b2b){
this.logger.debug(_b2b);
this.setProperty("layout",_b2b);
this._initializeLayout();
this.invokeLayout();
};
...
var _b2c="",_b2d=this.getSplitPanelBindings();
_b2d.each(function(_b2e){
_b2c+=_b2e.getRatio().toString();
_b2c+=_b2d.hasNext()?":":"";
});
...
_b2f.each(function(_b30){
layout+="1"+(_b2f.hasNext()?":":"");
});
this.setProperty("layout",layout);
};
SplitBoxBinding.prototype.setWidth=function(_b31){
this.bindingElement.style.width=_b31+"px";
};
SplitBoxBinding.prototype.getWidth=function(){
return this.bindingElement.offsetWidth;
};
SplitBoxBinding.prototype.setHeight=function(_b32){
this.bindingElement.style.height=_b32+"px";
};
...
SplitBoxBinding.prototype.fit=function(_b33){
if(!this.isFit||_b33){
if(this.isHorizontalOrient()){
var max=0;
var _b35=this.getSplitPanelBindings();
_b35.each(function(_b36){
var _b37=_b36.bindingElement.offsetHeight;
max=_b37>max?_b37:max;
});
...
SplitBoxBinding.newInstance=function(_b38){
var _b39=DOMUtil.createElementNS(Constants.NS_UI,"ui:splitbox",_b38);
return UserInterface.registerBinding(_b39,SplitBoxBinding);
};
...
var _b3c=this.getProperty("hidden");
if(_b3c){
this.hide();
}
};
...
if(!this.isVisible){
var _b3d=this.getProperty("ratiocache");
if(_b3d){
this.setRatio(_b3d);
...
SplitPanelBinding.prototype.setWidth=function(_b3e){
if(!this.isFixed){
if(_b3e!=this.getWidth()){
if(_b3e<0){
_b3e=this.getWidth();
this.logger.warn("SplitPanelBinding#setWidth bug in Internet Explorer!");
}
try{
this.bindingElement.style.width=_b3e+"px";
}
catch(exception){
alert("SplitPanelBinding#setWidth: Occult width: "+_b3e);
alert(arguments.caller.callee);
}
}
}
...
_b3f=this.bindingElement.offsetWidth;
}
return _b3f;
};
SplitPanelBinding.prototype.setHeight=function(_b40){
if(!this.isFixed){
if(_b40!=this.getHeight()){
try{
this.bindingElement.style.height=_b40+"px";
}
catch(exception){
...
_b41=this.bindingElement.offsetHeight;
}
return _b41;
};
SplitPanelBinding.prototype.setRatio=function(_b42){
this.setProperty("ratio",_b42);
};
SplitPanelBinding.prototype.getRatio=function(){
return this.getProperty("ratio");
};
SplitPanelBinding.prototype.setFix=function(_b43){
if(_b43){
this._fixedSpan=_b43;
...
SplitPanelBinding.newInstance=function(_b44){
var _b45=DOMUtil.createElementNS(Constants.NS_UI,"ui:splitpanel",_b44);
return UserInterface.registerBinding(_b45,SplitPanelBinding);
};
...
var _b46=SplitBoxBinding.superclass.serialize.call(this);
if(_b46){
_b46.collapse=this.getProperty("collapse");
_b46.collapsed=this.getProperty("collapsed");
_b46.disabled=this.getProperty("isdisabled");
}
return _b46;
};
...
this.buildDOMContent();
this.attachDOMEvents();
var _b47=this.getProperty("hidden");
if(_b47){
this.hide();
}
};
...
SplitterBinding.prototype.setCollapseDirection=function(_b49){
this.setProperty("collapse",_b49);
this._collapseDirection=_b49;
};
SplitterBinding.prototype.handleAction=function(_b4a){
SplitterBinding.superclass.handleAction.call(this,_b4a);
switch(_b4a.type){
case Binding.ACTION_DRAG:
...
_b4c.shadowTree.splitterBody.className=SplitterBinding.CLASSNAME_HOVER;
},250);
break;
case DOMEvents.MOUSEOUT:
...
if(_b4c.shadowTree.splitterBody.className==SplitterBinding.CLASSNAME_HOVER){
...
SplitterBinding.prototype.onDragStart=function(_b4d){
...
SplitterBinding.newInstance=function(_b58){
var _b59=DOMUtil.createElementNS(Constants.NS_UI,"ui:splitter",_b58);
return UserInterface.registerBinding(_b59,SplitterBinding);
};
...
var _b5a=this.getProperty("selectedindex");
var _b5b=this.getDeckElements();
if(_b5b.hasEntries()){
var _b5c=false;
var _b5d=0;
while(_b5b.hasNext()){
var deck=_b5b.getNext();
if(_b5a&&_b5d==_b5a){
...
if(!_b5c){
_b5b.getFirst().setAttribute("selected","true");
}
}
};
...
var _b60=this.getBindingForArgument(arg);
if(_b60!=null){
if(_b60!=this._selectedDeckBinding){
if(this._selectedDeckBinding){
this._selectedDeckBinding.unselect();
}
_b60.select();
this._selectedDeckBinding=_b60;
var _b61=this.getProperty("selectedindex");
if(_b61!=null){
this.setProperty("selectedindex",DOMUtil.getOrdinalPosition(_b60.bindingElement,true));
}
...
DecksBinding.newInstance=function(_b65){
var _b66=DOMUtil.createElementNS(Constants.NS_UI,"ui:decks",_b65);
return UserInterface.registerBinding(_b66,DecksBinding);
};
...
DeckBinding.prototype.handleAction=function(_b67){
DeckBinding.superclass.handleAction.call(this,_b67);
...
DeckBinding.newInstance=function(_b6a){
var _b6b=DOMUtil.createElementNS(Constants.NS_UI,"ui:deck",_b6a);
return UserInterface.registerBinding(_b6b,DeckBinding);
};
...
ToolBarBinding.prototype.onMemberInitialize=function(_b6c){
if(_b6c instanceof ToolBarBodyBinding){
if(_b6c.isRightAligned){
if(!this._toolBarBodyRight){
this._toolBarBodyRight=_b6c;
}
}else{
if(!this._toolBarBodyLeft){
this._toolBarBodyLeft=_b6c;
}
}
}
ToolBarBinding.superclass.onMemberInitialize.call(this,_b6c);
};
ToolBarBinding.prototype.parseDOMProperties=function(){
var _b6d=this.getProperty("imagesize");
var type=this.getProperty("type");
if(_b6d){
this.setImageSize(_b6d);
}
if(type){
this.setType(type);
}else{
...
var _b6f=ToolBarGroupBinding.newInstance(this.bindingDocument);
_b6f.add(ToolBarButtonBinding.newInstance(this.bindingDocument));
_b6f.isDefaultContent=true;
this.add(_b6f);
_b6f.attachRecursive();
this._hasDOMContent=true;
}
};
ToolBarBinding.prototype.flex=function(){
var left=this._toolBarBodyLeft;
var _b71=this._toolBarBodyRight;
if(left!=null&&left.hasClassName("max")){
this._maxToolBarGroup(left,_b71);
}
if(_b71!=null&&_b71.hasClassName("max")){
this._maxToolBarGroup(_b71,left);
}
};
ToolBarBinding.prototype._maxToolBarGroup=function(max,_b73){
var _b74=this.boxObject.getDimension().w;
var _b75=CSSComputer.getPadding(this.bindingElement);
_b74-=(_b75.left+_b75.right);
if(_b73!=null){
_b74-=_b73.boxObject.getDimension().w;
if(!Client.isWindows){
_b74-=1;
}
if(Client.isExplorer){
...
max.bindingElement.style.width=_b74+"px";
};
ToolBarBinding.prototype.getToolBarGroupByIndex=function(_b76){
return this.getDescendantBindingsByLocalName("toolbargroup").get(_b76);
};
ToolBarBinding.prototype.addLeft=function(_b77,_b78){
var _b79=null;
if(this._toolBarBodyLeft!=null){
_b79=this._toolBarBodyLeft.add(_b77,_b78);
}else{
throw new Error("No left toolbarbody");
}
return _b79;
};
ToolBarBinding.prototype.addLeftFirst=function(_b7a,_b7b){
var _b7c=null;
if(this._toolBarBodyLeft){
_b7c=this._toolBarBodyLeft.addFirst(_b7a,_b7b);
}else{
throw new Error("No left toolbarbody");
}
return _b7c;
};
ToolBarBinding.prototype.addRight=function(_b7d){
var _b7e=null;
if(this._toolBarBodyRight){
_b7e=this._toolBarBodyRight.add(_b7d);
}else{
throw new Error("No left toolbarbody");
}
return _b7e;
...
ToolBarBinding.newInstance=function(_b81){
var _b82=DOMUtil.createElementNS(Constants.NS_UI,"ui:toolbar",_b81);
return UserInterface.registerBinding(_b82,ToolBarBinding);
};
...
var _b83=this.getDescendantBindingsByLocalName("toolbargroup");
var _b84=new List();
var _b85=true;
_b83.each(function(_b86){
if(_b86.isVisible&&!_b86.isDefaultContent){
_b84.add(_b86);
}
});
while(_b84.hasNext()){
var _b87=_b84.getNext();
_b87.setLayout(ToolBarGroupBinding.LAYOUT_DEFAULT);
if(_b85){
_b87.setLayout(ToolBarGroupBinding.LAYOUT_FIRST);
_b85=false;
}
if(!_b84.hasNext()){
_b87.setLayout(ToolBarGroupBinding.LAYOUT_LAST);
}
}
...
while(list.hasNext()){
var _b8a=list.getNext();
var _b8b=_b8a.getEqualSizeWidth();
if(_b8b>max){
max=_b8b;
}
}
...
ToolBarBodyBinding.prototype.add=function(_b8c,_b8d){
var _b8e=ToolBarBinding.superclass.add.call(this,_b8c);
if(!_b8d){
...
ToolBarBodyBinding.prototype.addFirst=function(_b8f,_b90){
var _b91=ToolBarBinding.superclass.addFirst.call(this,_b8f);
if(!_b90){
...
ToolBarBodyBinding.newInstance=function(_b92){
var _b93=DOMUtil.createElementNS(Constants.NS_UI,"ui:toolbarbody",_b92);
return UserInterface.registerBinding(_b93,ToolBarBodyBinding);
};
...
ToolBarGroupBinding.prototype.setLayout=function(_b94){
switch(_b94){
...
var _b95=this.bindingElement.parentNode;
if(DOMUtil.getLocalName(_b95)=="toolbarbody"){
UserInterface.getBinding(_b95).refreshToolBarGroups();
}
};
...
ToolBarGroupBinding.newInstance=function(_b97){
var _b98=DOMUtil.createElementNS(Constants.NS_UI,"ui:toolbargroup",_b97);
return UserInterface.registerBinding(_b98,ToolBarGroupBinding);
};
...
ToolBarButtonBinding.newInstance=function(_b99){
var _b9a=DOMUtil.createElementNS(Constants.NS_UI,"ui:toolbarbutton",_b99);
return UserInterface.registerBinding(_b9a,ToolBarButtonBinding);
};
...
var _b9b=this.getProperty("label");
var _b9c=this.getProperty("image");
if(_b9b){
this.setLabel(_b9b);
}
if(_b9c){
...
ToolBarLabelBinding.prototype.setLabel=function(_b9d,_b9e){
if(this.isAttached){
this._labelBinding.setLabel(_b9d,_b9e);
}
this.setProperty("label",_b9d);
};
ToolBarLabelBinding.prototype.setImage=function(_b9f,_ba0){
if(this.isAttached){
this._labelBinding.setImage(_b9f,_ba0);
}
this.setProperty("image",_b9f);
};
ToolBarLabelBinding.newInstance=function(_ba1){
var _ba2=DOMUtil.createElementNS(Constants.NS_UI,"ui:toolbarlabel",_ba1);
return UserInterface.registerBinding(_ba2,ToolBarLabelBinding);
};
...
var _ba3=this.getDescendantBindingsByLocalName("clickbutton");
if(_ba3.hasEntries()){
while(_ba3.hasNext()){
var _ba4=_ba3.getNext();
if(_ba4.isDefault){
this._defaultButton=_ba4;
_ba4.attachClassName(ButtonBinding.CLASSNAME_DEFAULT);
}
if(!this._isListening&&_ba4.isFocusable){
...
DialogToolBarBinding.prototype.handleBroadcast=function(_ba5,arg){
DialogToolBarBinding.superclass.handleBroadcast.call(this,_ba5,arg);
switch(_ba5){
case BroadcastMessages.KEY_ENTER:
if(!PopupBinding.hasActiveInstances()&&!EditorBinding.isActive){
if(Binding.exists(this)){
var _ba7=this.getAncestorBindingByType(DialogBinding,true);
if(_ba7!=null&&_ba7.isActive){
...
DialogToolBarBinding.prototype.handleAction=function(_ba8){
DialogToolBarBinding.superclass.handleAction.call(this,_ba8);
var _ba9=_ba8.target;
var _baa=false;
var _bab=this._buttons.reset();
if(_ba9 instanceof ClickButtonBinding){
switch(_ba8.type){
case Binding.ACTION_FOCUSED:
_ba9.attachClassName(ButtonBinding.CLASSNAME_FOCUSED);
this._focusedButton=_ba9;
if(this._defaultButton){
this._defaultButton.detachClassName(ButtonBinding.CLASSNAME_DEFAULT);
}
break;
case Binding.ACTION_BLURRED:
_ba9.detachClassName(ButtonBinding.CLASSNAME_FOCUSED);
break;
}
}
if(this._defaultButton){
while(!_baa&&_bab.hasNext()){
...
var _bad=this._views;
for(var _bae in ViewDefinitions){
var def=ViewDefinitions[_bae];
var key=def.perspective;
if(key!=null){
if(!_bad.has(key)){
_bad.set(key,new List());
}
var list=_bad.get(key);
list.add(def);
}
}
}else{
...
ToolBoxToolBarButtonBinding.prototype.handleBroadcast=function(_bb2,arg){
ToolBoxToolBarButtonBinding.superclass.handleBroadcast.call(this,_bb2,arg);
switch(_bb2){
case BroadcastMessages.PERSPECTIVE_CHANGED:
var tag=arg;
if(tag!=this._lastGeneratedPerspective){
this._lastGeneratedPerspective=tag;
var _bb5=this.bindingWindow.bindingMap.toolboxpopupgroup;
_bb5.empty();
if(this._views.has(tag)){
var list=this._views.get(tag);
list.each(function(def){
var item=_bb5.add(StageViewMenuItemBinding.newInstance(_bb5.bindingDocument));
...
TreeBinding.grid=function(_bb9){
var _bba=TreeNodeBinding.HEIGHT;
var ceil=Math.ceil(_bb9);
var _bbc=_bb9%_bba;
if(_bbc>0){
_bb9=_bb9-_bbc+_bba;
}
return _bb9+TreeBodyBinding.PADDING_TOP;
};
...
var _bbd=this.getProperty("focusable");
if(_bbd!=null){
this._isFocusable=_bbd;
}
...
var _bbf=this.getProperty("builder");
if(_bbf){
this._buildFromTextArea(_bbf);
}else{
...
var _bc0=this.getProperty("selectable");
var _bc1=this.getProperty("selectionproperty");
var _bc2=this.getProperty("selectionvalue");
if(_bc0){
this.setSelectable(true);
if(_bc1){
this.setSelectionProperty(_bc1);
}
if(_bc2){
this.setSelectionValue(_bc2);
}
}
...
if(area!=null){
var _bc5=UserInterface.getBinding(area);
var _bc6=this._treeBodyBinding;
function build(){
_bc6.subTreeFromString(area.value);
}
_bc5.addActionListener(Binding.ACTION_UPDATED,{handleAction:function(){
build();
}});
setTimeout(build,0);
}
};
TreeBinding.prototype.registerTreeNodeBinding=function(_bc7){
var _bc8=_bc7.getHandle();
if(this._treeNodeBindings.has(_bc8)){
throw "Duplicate treenodehandles registered: "+_bc7.getLabel();
}else{
this._treeNodeBindings.set(_bc8,_bc7);
var map=this._openTreeNodesBackupMap;
if(map!=null&&map.has(_bc8)){
_bc7.open();
}
}
};
TreeBinding.prototype.unRegisterTreeNodeBinding=function(_bca){
this._treeNodeBindings.del(_bca.getHandle());
};
TreeBinding.prototype.getTreeNodeBindingByHandle=function(_bcb){
var _bcc=null;
if(this._treeNodeBindings.has(_bcb)){
_bcc=this._treeNodeBindings.get(_bcb);
}else{
throw "No such treenode: "+_bcb;
}
return _bcc;
};
TreeBinding.prototype.handleAction=function(_bcd){
TreeBinding.superclass.handleAction.call(this,_bcd);
...
this._blurDescendantBindings(_bce);
_bcd.consume();
break;
case TreeNodeBinding.ACTION_ONFOCUS:
this._nodePrimary=_bce;
this.focusSingleTreeNodeBinding(_bce);
if(!this.isFocused){
this.focus();
}
_bcd.consume();
...
TreeBinding.prototype._getVisibleTreeNodeBindingsInRange=function(_bcf,_bd0){
alert("TreeBinding#_getVisibleTreeNodeBindingsInRange");
};
TreeBinding.prototype.focusSingleTreeNodeBinding=function(_bd1){
if(_bd1!=null&&!_bd1.isFocused){
this.blurSelectedTreeNodes();
this._focusedTreeNodeBindings.add(_bd1);
_bd1.invokeManagedFocus();
if(this._isSelectable){
this._manageSelections();
}
}
};
TreeBinding.prototype.focusMultipeTreeNodeBindings=function(_bd2){
this.blurSelectedTreeNodes();
while(_bd2.hasNext()){
var _bd3=_bd2.getNext();
this._focusedTreeNodeBindings.add(_bd3);
_bd3.invokeManagedFocus();
}
if(this._isSelectable){
this._manageSelections();
}
...
var _bd4=this._selectedTreeNodeBindings;
this._selectedTreeNodeBindings={};
var _bd5=false;
var _bd6=null;
this._focusedTreeNodeBindings.reset();
while(this._focusedTreeNodeBindings.hasNext()){
var _bd7=this._focusedTreeNodeBindings.getNext();
var _bd8=_bd7.getProperty(this._selectionProperty);
if(_bd8!=null){
if(!this._selectionValue||this._selectionValue[_bd8]){
_bd6=(this._selectedTreeNodeBindings[_bd7.key]=_bd7);
var _bd9=_bd4[_bd7.key];
if(!_bd9||_bd9!=_bd6){
_bd5=true;
}
}
...
_bdb.add(this._selectedTreeNodeBindings[key]);
}
return _bdb;
};
TreeBinding.prototype.blurSelectedTreeNodes=function(){
this._focusedTreeNodeBindings.reset().each(function(_bdd){
_bdd.blur();
});
this._focusedTreeNodeBindings.clear();
};
TreeBinding.prototype._blurDescendantBindings=function(_bde){
var _bdf=_bde.getDescendantBindingsByLocalName("treenode");
var _be0=true;
var self=this;
_bdf.each(function(desc){
if(desc.isFocused){
desc.blur();
...
var _be3=this._treeBodyBinding.getChildBindingByLocalName("treenode");
if(_be3!=null){
this.focusSingleTreeNodeBinding(_be3);
_be3.callback();
}
};
...
TreeBinding.prototype.add=function(_be4){
var _be5=null;
if(this._treeBodyBinding){
_be5=this._treeBodyBinding.add(_be4);
}else{
this._treeNodeBuffer.add(_be4);
_be5=_be4;
}
return _be5;
};
TreeBinding.prototype.addFirst=function(_be6){
throw new Error("Not implemented");
};
TreeBinding.prototype.empty=function(){
this._treeBodyBinding.detachRecursive();
var _be7=this._treeBodyBinding.bindingElement;
_be7.innerHTML="";
};
...
this.blurSelectedTreeNodes();
this._treeNodeBindings.each(function(_be8,_be9){
if(_be9.isContainer&&_be9.isOpen){
_be9.close();
}
});
};
TreeBinding.prototype.setSelectable=function(_bea){
this._isSelectable=_bea;
if(_bea){
this._selectedTreeNodeBindings={};
}else{
this._selectedTreeNodeBindings=null;
...
TreeBinding.prototype.setSelectionProperty=function(_beb){
this._selectionProperty=_beb;
};
TreeBinding.prototype.setSelectionValue=function(_bec){
if(_bec){
var list=new List(_bec.split(" "));
...
TreeBinding.prototype.handleBroadcast=function(_bee,arg){
TreeBinding.superclass.handleBroadcast.call(this,_bee,arg);
switch(_bee){
case BroadcastMessages.TYPEDRAG_START:
...
var _bf3=this.getFocusedTreeNodeBindings();
if(_bf3.hasEntries()){
var node=_bf3.getFirst();
var next=null;
switch(key){
case KeyEventCodes.VK_UP:
...
if(next==null){
var _bf6=null;
while(next==null&&(_bf6=node.getAncestorBindingByLocalName("treenode"))!=null){
if(_bf6!=null){
next=_bf6.getNextBindingByLocalName("treenode");
}
node=_bf6;
}
}
...
var _bf8=DOMEvents.getTarget(e);
switch(e.type){
case DOMEvents.MOUSEMOVE:
try{
...
break;
case DOMEvents.BEFOREUPDATE:
var _bf9=new TreeCrawler();
var list=new List();
_bf9.mode=TreeCrawler.MODE_GETOPEN;
_bf9.crawl(this.bindingElement,list);
var map=new Map();
if(list.hasEntries()){
while(list.hasNext()){
var _bfc=list.getNext();
map.set(_bfc.getHandle(),true);
}
...
var _c01=this._positionIndicatorBinding;
...
if(y!=_c01.getPosition().y){
_c01.setPosition(new Point(this._acceptingPosition.x+TreeNodeBinding.INDENT,y));
}
if(!_c01.isVisible){
_c01.show();
}
...
TreeBinding.prototype.enablePositionIndicator=function(_c04){
this._acceptingTreeNodeBinding=_c04;
this._acceptingPosition=_c04.boxObject.getLocalPosition();
this._acceptingDimension=_c04.boxObject.getDimension();
this._acceptingPositions=this._getChildPositions(_c04);
};
...
TreeBinding.prototype._getChildPositions=function(_c05){
var map={};
var _c07=_c05.getChildBindingsByLocalName("treenode");
var _c08,pos,dim,y;
y=TreeBinding.grid(_c05.boxObject.getLocalPosition().y);
map[y]=true;
while(_c07.hasNext()){
_c08=_c07.getNext();
pos=_c08.boxObject.getLocalPosition();
dim=_c08.boxObject.getDimension();
...
var drop=0;
for(var _c0e in this._acceptingPositions){
if(_c0e==y){
break;
}else{
drop++;
...
TreeBinding.newInstance=function(_c0f){
var _c10=DOMUtil.createElementNS(Constants.NS_UI,"ui:tree",_c0f);
var _c11=UserInterface.registerBinding(_c10,TreeBinding);
_c11.treeBodyBinding=TreeBodyBinding.newInstance(_c0f);
return _c11;
};
...
TreeBodyBinding.prototype.accept=function(_c12){
if(_c12 instanceof TreeNodeBinding){
this.logger.debug(_c12);
}
};
TreeBodyBinding.prototype.handleAction=function(_c13){
TreeBodyBinding.superclass.handleAction.call(this,_c13);
switch(_c13.type){
case TreeNodeBinding.ACTION_FOCUSED:
this._scrollIntoView(_c13.target);
_c13.consume();
break;
}
};
TreeBodyBinding.prototype._scrollIntoView=function(_c14){
var a=this.boxObject.getDimension().h;
var y=_c14.boxObject.getLocalPosition().y;
var h=_c14.boxObject.getDimension().h;
var t=this.bindingElement.scrollTop;
var l=this.bindingElement.scrollLeft;
var _c1a=_c14.labelBinding.bindingElement;
if(y-t<0){
_c1a.scrollIntoView(true);
}else{
if(y-t+h>a){
_c1a.scrollIntoView(false);
}
}
try{
...
TreeBodyBinding.newInstance=function(_c1b){
var _c1c=DOMUtil.createElementNS(Constants.NS_UI,"ui:treebody",_c1b);
return UserInterface.registerBinding(_c1c,TreeBodyBinding);
};
...
var _c1d=TreeNodeBinding.superclass.serialize.call(this);
if(_c1d){
_c1d.label=this.getLabel();
_c1d.image=this.getImage();
var _c1e=this.getHandle();
if(_c1e&&_c1e!=this.key){
_c1d.handle=_c1e;
}
if(this.isOpen){
_c1d.open=true;
...
if(this.dragType){
_c1d.dragtype=this.dragType;
}
if(this.dragAccept){
_c1d.dragaccept=this.dragAccept;
}
}
return _c1d;
};
...
var _c20=UserInterface.getBinding(node);
if(_c20&&_c20.containingTreeBinding){
this.containingTreeBinding=_c20.containingTreeBinding;
}
}
...
var _c21=this.key;
var _c22=this.getProperty("handle");
if(_c22){
_c21=_c22;
}
return _c21;
};
TreeNodeBinding.prototype.setHandle=function(_c23){
this.setProperty("handle",_c23);
};
TreeNodeBinding.prototype.buildDOMContent=function(){
var url=this.getProperty("url");
var _c25=this.getProperty("label");
var _c26=this.getProperty("tooltip");
var _c27=this.getProperty("oncommand");
var _c28=this.getProperty("onbindingfocus");
var _c29=this.getProperty("onbindingblur");
var _c2a=this.getProperty("focused");
var _c2b=this.getProperty("callbackid");
if(url){
...
var _c2d=this.bindingWindow.WindowManager;
if(_c27!=null){
this.oncommand=function(){
Binding.evaluate(_c27,this);
};
}
if(_c28!=null){
...
if(_c2b!=null){
Binding.dotnetify(this,_c2b);
}
};
TreeNodeBinding.prototype.handleAction=function(_c2e){
TreeNodeBinding.superclass.handleAction.call(this,_c2e);
switch(_c2e.type){
case TreeNodeBinding.ACTION_FOCUSED:
if(_c2e.target!=this){
...
TreeNodeBinding.prototype.accept=function(_c2f,_c30){
var _c31=true;
if(_c2f instanceof TreeNodeBinding){
var _c32=false;
var _c33=this.bindingElement;
var _c34=this.containingTreeBinding.bindingElement;
while(!_c32&&_c33!=_c34){
if(_c33==_c2f.getBindingElement()){
_c32=true;
}else{
_c33=_c33.parentNode;
}
}
if(_c32){
...
this.acceptTreeNodeBinding(_c2f,_c30);
}
}else{
_c31=false;
}
...
TreeNodeBinding.prototype.acceptTreeNodeBinding=function(_c35,_c36){
var _c37=_c35.serializeToString();
var _c38=new BindingParser(this.bindingDocument);
var _c39=_c38.parseFromString(_c37).getFirst();
_c36=_c36?_c36:this.containingTreeBinding.getDropIndex();
var _c3a=this.getChildElementsByLocalName("treenode");
this.bindingElement.insertBefore(_c39,_c3a.get(_c36));
this.bindingWindow.DocumentManager.attachBindings(this.bindingElement);
_c35.dispose();
};
...
var _c3b=this.getProperty("image");
var _c3c=this.getProperty("image-active");
var _c3d=this.getProperty("image-disabled");
_c3c=_c3c?_c3c:this.isContainer?_c3b?_c3b:TreeNodeBinding.DEFAULT_FOLDER_OPEN:_c3b?_c3b:TreeNodeBinding.DEFAULT_ITEM;
_c3d=_c3d?_c3d:this.isContainer?_c3b?_c3b:TreeNodeBinding.DEFAULT_FOLDER_DISABLED:_c3b?_c3b:TreeNodeBinding.DEFAULT_ITEM_DISABLED;
_c3b=_c3b?_c3b:this.isContainer?TreeNodeBinding.DEFAULT_FOLDER_CLOSED:TreeNodeBinding.DEFAULT_ITEM;
this.imageProfile=new ImageProfile({image:_c3b,imageHover:null,imageActive:_c3c,imageDisabled:_c3d});
};
...
TreeNodeBinding.prototype.setLabel=function(_c3f){
this.setProperty("label",String(_c3f));
if(this.isAttached){
this.labelBinding.setLabel(String(_c3f));
}
};
TreeNodeBinding.prototype.setToolTip=function(_c40){
this.setProperty("tooltip",String(_c40));
if(this.isAttached){
this.labelBinding.setToolTip(String(_c40));
}
};
...
var _c41=this.imageProfile.getDefaultImage();
var _c42=this.imageProfile.getActiveImage();
_c42=_c42?_c42:_c41;
return this.isOpen?_c42:_c41;
};
TreeNodeBinding.prototype.handleEvent=function(e){
TreeNodeBinding.superclass.handleEvent.call(this,e);
var _c44=DOMEvents.getTarget(e);
var _c45=this.labelBinding.bindingElement;
var _c46=this.labelBinding.shadowTree.labelBody;
var _c47=this.labelBinding.shadowTree.labelText;
switch(e.type){
case DOMEvents.MOUSEDOWN:
switch(_c44){
case _c45:
...
if(_c44.parentNode==this.bindingElement&&_c44.__updateType==Update.TYPE_INSERT){
var _c45=this.labelBinding.bindingElement;
if(DOMUtil.getLocalName(_c44)=="treenode"){
if(_c44==this.bindingElement.firstChild){
this.bindingElement.insertBefore(_c44,_c45.nextSibling);
}
}
break;
}
...
var _c4b=true;
if(e.type=="mousedown"){
var _c4c=e.button==(e.target?0:1);
if(!_c4c){
_c4b=false;
}
}
...
this.dispatchAction(_c4e?TreeNodeBinding.ACTION_ONMULTIFOCUS:TreeNodeBinding.ACTION_ONFOCUS);
if(e!=null){
...
var _c51=this.getDescendantBindingsByLocalName("treenode");
_c51.each(function(_c52){
_c52.dispose();
});
};
...
TreeNodeBinding.prototype.handleElement=function(_c53){
var _c54=_c53.getAttribute("focused");
if(_c54=="true"){
if(!this.isFocused){
this.focus();
}
...
TreeNodeBinding.newInstance=function(_c55){
var _c56=DOMUtil.createElementNS(Constants.NS_UI,"ui:treenode",_c55);
return UserInterface.registerBinding(_c56,TreeNodeBinding);
};
...
TreeContentBinding.newInstance=function(_c57){
var _c58=DOMUtil.createElementNS(Constants.NS_UI,"ui:treecontent",_c57);
return UserInterface.registerBinding(_c58,TreeContentBinding);
};
...
TreePositionIndicatorBinding.prototype.setPosition=function(_c59){
this.bindingElement.style.left=_c59.x+"px";
this.bindingElement.style.top=_c59.y+"px";
this._geometry.x=_c59.x;
this._geometry.y=_c59.y;
};
TreePositionIndicatorBinding.prototype.getPosition=function(){
return new Point(this._geometry.x,this._geometry.y);
};
TreePositionIndicatorBinding.newInstance=function(_c5a){
var _c5b=DOMUtil.createElementNS(Constants.NS_UI,"ui:treepositionindicator",_c5a);
return UserInterface.registerBinding(_c5b,TreePositionIndicatorBinding);
};
...
var self=this;
this.addFilter(function(_c5d){
var _c5e=UserInterface.getBinding(_c5d);
var _c5f=null;
var _c5f=null;
if(!_c5e instanceof TreeNodeBinding){
_c5f=NodeCrawler.SKIP_NODE;
}
return _c5f;
});
this.addFilter(function(_c60,list){
var _c62=UserInterface.getBinding(_c60);
var _c63=null;
switch(self.mode){
...
ShadowBinding.prototype.shadow=function(_c64){
this.targetBinding=_c64;
_c64.addActionListener(Binding.ACTION_POSITIONCHANGED,this);
_c64.addActionListener(Binding.ACTION_DIMENSIONCHANGED,this);
_c64.addActionListener(Binding.ACTION_VISIBILITYCHANGED,this);
_c64.bindingElement.parentNode.appendChild(this.bindingElement);
if(_c64.isVisible){
this.show();
this.setPosition(_c64.getPosition());
this.setDimension(_c64.getDimension());
}else{
this.hide();
}
};
ShadowBinding.prototype.handleAction=function(_c65){
ShadowBinding.superclass.handleAction.call(this,_c65);
var _c66=_c65.target;
if(_c66==this.targetBinding){
switch(_c65.type){
...
if(_c66.isVisible){
this.show();
this.setPosition(_c66.getPosition());
this.setDimension(_c66.getDimension());
}else{
this.hide();
}
break;
...
ShadowBinding.prototype.setPosition=function(_c67){
var _c68=this.offset-this.expand;
this.bindingElement.style.left=new String(_c67.x+_c68)+"px";
this.bindingElement.style.top=new String(_c67.y+_c68)+"px";
};
...
ShadowBinding.newInstance=function(_c6a){
var _c6b=DOMUtil.createElementNS(Constants.NS_UI,"ui:shadow",_c6a);
return UserInterface.registerBinding(_c6b,ShadowBinding);
};
...
function DockControlImageProfile(_c6c){
this.binding=_c6c;
}
...
DockTabsButtonBinding.newInstance=function(_c6d){
var _c6e=DOMUtil.createElementNS(Constants.NS_UI,"ui:toolbarbutton",_c6d);
_c6e.setAttribute("type","checkbox");
_c6e.setAttribute("popup","app.bindingMap.tabsbuttonpopup");
_c6e.className="tabbutton";
return UserInterface.registerBinding(_c6e,DockTabsButtonBinding);
};
...
var _c6f=DockBinding.superclass.serialize.call(this);
if(_c6f){
_c6f.active=this.isActive?true:null;
_c6f.collapsed=this.isCollapsed?true:null;
}
return _c6f;
};
...
var _c70=UserInterface.getBinding(this.bindingElement.parentNode);
var _c71=MatrixBinding.newInstance(this.bindingDocument);
_c71.attachClassName("dockliner");
this.shadowTree.dockLiner=_c71;
_c70.add(_c71);
_c71.attach();
_c71.manifest();
var type=this.getProperty("type");
...
DockBinding.prototype.interceptDisplayChange=function(_c73){
var _c74=this.getSelectedTabPanelBinding();
if(_c74){
_c74.isVisible=_c73;
_c74.dispatchAction(Binding.ACTION_VISIBILITYCHANGED);
}
};
DockBinding.prototype.prepareNewView=function(_c75){
var _c76=this._getBindingForDefinition(_c75);
var _c77=DockTabBinding.newInstance(this.bindingDocument);
_c77.setHandle(_c75.handle);
_c77.setLabel(this.type==DockBinding.TYPE_EDITORS?null:_c75.label);
_c77.setImage(_c75.image);
_c77.setToolTip(_c75.toolTip);
_c77.setEntityToken(_c75.entityToken);
_c77.setAssociatedView(_c76);
this.appendTabByBindings(_c77,null);
this._setupPageBindingListeners(_c77);
var _c78=this.getTabPanelBinding(_c77);
_c76.snapToBinding(_c78);
var _c79=this.bindingWindow.bindingMap.views;
_c79.add(_c76);
if(!this.isActive){
this.activate();
}
...
DockBinding.prototype.prepareOpenView=function(_c7a,_c7b){
this.logger.debug("DockBinding.prototype.prepareOpenView: _setupDirtyStuff required?");
_c7b.setLabel(_c7a.label);
_c7b.setImage(_c7a.image);
_c7b.setToolTip(_c7a.toolTip);
this._setupPageBindingListeners(_c7b);
var _c7c=this.getTabPanelBinding(_c7b);
var _c7d=this._getBindingForDefinition(_c7a);
_c7b.setAssociatedView(_c7d);
_c7d.snapToBinding(_c7c);
UserInterface.getBinding(this.bindingDocument.body).add(_c7d);
_c7d.attach();
};
DockBinding.prototype._getBindingForDefinition=function(_c7e){
var _c7f=this.bindingWindow.bindingMap.views;
var view=ViewBinding.newInstance(_c7f.bindingDocument);
view.setDefinition(_c7e);
return view;
};
DockBinding.prototype._setupPageBindingListeners=function(_c81){
var _c82=this.getTabPanelBinding(_c81);
var self=this;
var _c84={handleAction:function(_c85){
...
case PageBinding.ACTION_INITIALIZED:
_c86.reflex(true);
var view=_c81.getAssociatedView();
if(_c86.bindingWindow==view.getContentWindow()){
_c81.updateDisplay(_c86);
EventBroadcaster.broadcast(BroadcastMessages.VIEW_COMPLETED,view.getHandle());
if(StatusBar.state==StatusBar.BUSY){
StatusBar.clear();
}
}
_c81.onPageInitialize(_c86);
_c85.consume();
break;
case DockTabBinding.ACTION_UPDATE_VISUAL:
_c81.updateDisplay(_c86);
...
new List([DockTabBinding.ACTION_UPDATE_VISUAL,DockTabBinding.ACTION_UPDATE_TOKEN,PageBinding.ACTION_ATTACHED,PageBinding.ACTION_INITIALIZED,EditorPageBinding.ACTION_DIRTY,EditorPageBinding.ACTION_CLEAN,EditorPageBinding.ACTION_SAVE,ViewBinding.ACTION_ONCLOSE,ViewBinding.ACTION_ONCLOSE_FORCE,DockPanelBinding.ACTION_FORCE_SELECT,Binding.ACTION_FORCE_REFLEX,DockTabBinding.ACTION_FORCE_CLEAN,WindowBinding.ACTION_ONLOAD]).each(function(_c88){
_c82.addActionListener(_c88,_c84);
});
};
DockBinding.prototype.summonTabPanelBinding=function(){
return DockPanelBinding.newInstance(this.bindingDocument);
};
DockBinding.prototype.handleAction=function(_c89){
DockBinding.superclass.handleAction.call(this,_c89);
var _c8a=_c89.target;
switch(_c89.type){
case Binding.ACTION_ACTIVATED:
if(!this.isActive){
this.activate();
...
break;
case TabBoxBinding.ACTION_UPDATED:
if(_c8a instanceof DockBinding){
if(_c8a.updateType==TabBoxBinding.UPDATE_DETACH){
...
this._viewBindingList.add(_c8a);
if(this.isActive){
_c8a.onActivate();
}
break;
case ViewBinding.ACTION_CLOSED:
this._viewBindingList.del(_c8a);
break;
}
};
DockBinding.prototype.handleBroadcast=function(_c8b,arg){
DockBinding.superclass.handleBroadcast.call(this,_c8b,arg);
switch(_c8b){
case BroadcastMessages.SYSTEMTREENODEBINDING_FOCUS:
var _c8d=arg;
if(_c8d.perspectiveNode==this.perspectiveNode){
this._selectTabByEntityToken(_c8d.node.getEntityToken());
}
break;
}
};
DockBinding.prototype._selectTabByEntityToken=function(_c8e){
var tabs=this.getTabBindings();
var _c90=false;
while(tabs.hasNext()&&!_c90){
var tab=tabs.getNext();
var _c92=tab.getEntityToken();
if(_c92!=null&&_c92==_c8e){
if(!tab.isSelected){
...
DockBinding.prototype.collapse=function(_c93){
this._handleCollapse(true,_c93);
};
DockBinding.prototype.unCollapse=function(_c94){
this._handleCollapse(false,_c94);
};
DockBinding.prototype._handleCollapse=function(_c95,_c96){
var _c97=this.getChildBindingByLocalName("dockpanels");
var _c98=this.getAncestorBindingByLocalName("splitbox");
if(_c95){
_c97.hide();
this.bindingElement.style.height="auto";
this.isFlexible=false;
this.isActivatable=false;
this.setProperty("collapsed",true);
if(_c96&&_c98.hasBothPanelsVisible()){
this.setWidth(200);
}
}else{
_c97.show();
...
this.interceptDisplayChange(!_c95);
this.isCollapsed=_c95;
};
...
DockBinding.prototype.closeTab=function(_c9d,_c9e){
if(_c9d.isDirty&&!_c9e){
var _c9f=Resolver.resolve(_c9d.getLabel());
var self=this;
Dialog.question(StringBundle.getString("ui","WebSite.Application.DialogSaveResource.Title"),StringBundle.getString("ui","WebSite.Application.DialogSaveResource.Text").replace("${resourcename}",_c9f),Dialog.BUTTONS_YES_NO_CANCEL,{handleDialogResponse:function(_ca1){
switch(_ca1){
case Dialog.RESPONSE_YES:
setTimeout(function(){
self.saveContainedEditor(_c9d);
},0);
break;
...
DockBinding.prototype.closeTabsExcept=function(_ca2){
var tabs=this.getTabBindings();
while(tabs.hasNext()){
var tab=tabs.getNext();
if(tab!=_ca2){
...
DockBinding.prototype.saveContainedEditor=function(_ca5){
var _ca6=_ca5.getAssociatedView();
_ca6.saveContainedEditor();
var self=this;
var _ca8={handleBroadcast:function(_ca9,arg){
switch(_ca9){
case BroadcastMessages.CURRENT_SAVED:
if(arg.handle==_ca6.getHandle()){
EventBroadcaster.unsubscribe(BroadcastMessages.CURRENT_SAVED,_ca8);
if(arg.isSuccess){
self.removeTab(_ca5);
}
}
...
EventBroadcaster.subscribe(BroadcastMessages.CURRENT_SAVED,_ca8);
};
DockBinding.prototype.appendTabByBindings=function(_cab,_cac){
if(this.isEmpty){
this.isEmpty=false;
this.isActivatable=true;
this.setWidth(false);
...
DockBinding.superclass.appendTabByBindings.call(this,_cab,_cac);
};
...
DockBinding.prototype.setWidth=function(_cad){
_cad=_cad?_cad+"px":"100%";
this.bindingElement.style.width=_cad;
};
...
DockBinding.prototype.showControls=function(_cae){
...
var _cb1=DockControlBinding.newInstance(this.bindingDocument);
_cb1.setControlType(type);
return _cb1;
};
...
DockTabsBinding.prototype.handleCrawler=function(_cb4){
DockTabsBinding.superclass.handleCrawler.call(this,_cb4);
switch(_cb4.id){
case FlexBoxCrawler.ID:
...
var self=this;
function fix(){
var _cb6=self.containingTabBoxBinding.getWidth();
if(!isNaN(_cb6)){
_cb6=_cb6>0?_cb6-1:0;
self.bindingElement.style.width=new String(_cb6)+"px";
}
}
setTimeout(fix,250);
fix();
...
DockTabsBinding.newInstance=function(_cb7){
var _cb8=DOMUtil.createElementNS(Constants.NS_UI,"ui:docktabs",_cb7);
return UserInterface.registerBinding(_cb8,DockTabsBinding);
};
...
DockTabBinding.prototype.setAssociatedView=function(_cb9){
this._viewBinding=_cb9;
};
DockTabBinding.prototype.getAssociatedView=function(){
return this._viewBinding;
};
DockTabBinding.prototype.serialize=function(){
var _cba=DockTabBinding.superclass.serialize.call(this);
if(_cba){
_cba.label=null;
_cba.image=null;
_cba.handle=this.getHandle();
}
return _cba;
};
DockTabBinding.prototype.setHandle=function(_cbb){
this.setProperty("handle",_cbb);
};
DockTabBinding.prototype.getHandle=function(){
return this.getProperty("handle");
};
DockTabBinding.prototype.setEntityToken=function(_cbc){
if(this._entityToken==null){
this.subscribe(BroadcastMessages.SYSTEMTREEBINDING_LOCKTOEDITOR);
}
this._entityToken=_cbc;
if(this.isAttached){
if(this.isSelected){
...
var _cbd=DialogControlBinding.newInstance(this.bindingDocument);
_cbd.setControlType(ControlBinding.TYPE_CLOSE);
this._controlGroupBinding.add(_cbd);
this._controlGroupBinding.attachRecursive();
};
DockTabBinding.prototype.setDirty=function(_cbe){
if(this.containingTabBoxBinding.type==DockBinding.TYPE_EDITORS){
if(this.isDirty!=_cbe){
this.isDirty=_cbe;
if(Binding.exists(this.labelBinding)){
var _cbf=this.labelBinding.getLabel();
if(_cbf!=null){
this.labelBinding.setLabel(_cbe?"*"+_cbf:_cbf.slice(1,_cbf.length));
}else{
this.labelBinding.setLabel(_cbe?"*":"");
}
}
}
var _cc0=top.app.bindingMap.broadcasterCurrentTabDirty;
...
DockTabBinding.prototype.updateDisplay=function(_cc1){
this.setLabel(_cc1.getLabel());
this.setImage(_cc1.getImage());
this.setToolTip(_cc1.getToolTip());
};
DockTabBinding.prototype.updateEntityToken=function(_cc2){
this.setEntityToken(_cc2.getEntityToken());
};
DockTabBinding.prototype.handleAction=function(_cc3){
DockTabBinding.superclass.handleAction.call(this,_cc3);
var _cc4=_cc3.target;
switch(_cc3.type){
case ControlBinding.ACTION_COMMAND:
if(_cc4.controlType==ControlBinding.TYPE_CLOSE){
this.close();
}
break;
case MenuItemBinding.ACTION_COMMAND:
if(_cc3.listener==this.contextMenuBinding){
this._handleContextMenuItemBinding(_cc4);
}
break;
}
};
DockTabBinding.prototype._handleContextMenuItemBinding=function(_cc5){
var cmd=_cc5.getProperty("cmd");
switch(cmd){
...
DockTabBinding.prototype.setLabel=function(_cc7){
if(!_cc7){
if(!this.getLabel()){
_cc7=DockTabBinding.LABEL_TABLOADING;
}else{
if(this.getLabel()==DockTabBinding.LABEL_TABLOADING){
_cc7=DockTabBinding.LABEL_TABDEFAULT;
}
}
}
DockTabBinding.superclass.setLabel.call(this,_cc7);
};
DockTabBinding.prototype.setImage=function(_cc8){
if(!_cc8){
if(!this.getImage()){
_cc8=DockTabBinding.IMG_TABLOADING;
}else{
if(this.getImage()==DockTabBinding.IMG_TABLOADING){
_cc8=DockTabBinding.IMG_TABDEFAULT;
}
}
}
DockTabBinding.superclass.setImage.call(this,_cc8);
};
...
var _ccb=Resolver.resolve(this.getLabel());
switch(cmd){
case DockTabPopupBinding.CMD_VIEWSOURCE:
def.label="Source: "+_ccb;
break;
case DockTabPopupBinding.CMD_VIEWGENERATED:
def.label="Generated: "+_ccb;
break;
case DockTabPopupBinding.CMD_VIEWSERIALIZED:
def.label="Serialized: "+_ccb;
break;
}
...
var _ccd=this.bindingElement;
setTimeout(function(){
_ccd.style.bottom="auto";
},25);
}
};
DockTabBinding.prototype.handleBroadcast=function(_cce,arg){
DockTabBinding.superclass.handleBroadcast.call(this,_cce,arg);
...
DockTabBinding.prototype.select=function(_cd3){
DockTabBinding.superclass.select.call(this,_cd3);
this._updateBroadcasters();
if(_cd3!=true){
this._updateTree();
}
...
if(this.isSelected){
var _cd4=top.app.bindingMap.broadcasterCurrentTabDirty;
var _cd5=top.app.bindingMap.broadcasterCurrentIsEditor;
if(this._isEditorDockTab()){
_cd5.enable();
if(this.isDirty){
_cd4.enable();
...
DockTabBinding.prototype._updateTree=function(_cd6){
if(this._canUpdateTree||_cd6){
...
var _cd9=win.bindingMap.savebutton;
if(_cd9!=null){
_cd7=true;
}
}
...
DockTabBinding.newInstance=function(_cda){
var _cdb=DOMUtil.createElementNS(Constants.NS_UI,"ui:docktab",_cda);
return UserInterface.registerBinding(_cdb,DockTabBinding);
};
...
DockPanelsBinding.newInstance=function(_cdc){
var _cdd=DOMUtil.createElementNS(Constants.NS_UI,"ui:dockpanels",_cdc);
return UserInterface.registerBinding(_cdd,DockPanelsBinding);
};
...
DockPanelBinding.prototype.select=function(_cde){
DockPanelBinding.superclass.select.call(this,_cde);
this.dispatchAction(Binding.ACTION_VISIBILITYCHANGED);
};
...
DockPanelBinding.prototype.handleCrawler=function(_cdf){
DockPanelBinding.superclass.handleCrawler.call(this,_cdf);
if(_cdf.response==null){
if(_cdf.type==NodeCrawler.TYPE_DESCENDING){
if(this.viewBinding!=null){
if(_cdf.id==FocusCrawler.ID){
_cdf.nextNode=this.viewBinding.bindingElement;
}
}
}
}
};
DockPanelBinding.newInstance=function(_ce0){
var _ce1=DOMUtil.createElementNS(Constants.NS_UI,"ui:dockpanel",_ce0);
return UserInterface.registerBinding(_ce1,DockPanelBinding);
};
...
DockControlBinding.newInstance=function(_ce2){
var _ce3=DOMUtil.createElementNS(Constants.NS_UI,"ui:toolbarbutton",_ce2);
return UserInterface.registerBinding(_ce3,DockControlBinding);
};
...
ViewBinding.getInstance=function(_ce4){
var _ce5=ViewBinding._instances.get(_ce4);
if(!_ce5){
var cry="ViewBinding.getInstance: No such instance: "+_ce4;
...
var _ce8=!System.hasActivePerspectives&&Client.isExplorer;
if(this.isFreeFloating==true&&!_ce8){
if(snap.isVisible==true){
if(snap.isAttached==true){
var _ce9=snap.boxObject.getGlobalPosition();
var _cea=snap.boxObject.getDimension();
if(!Point.isEqual(_ce9,this._lastknownposition)){
this.setPosition(_ce9);
this._lastknownposition=_ce9;
}
if(!Dimension.isEqual(_cea,this._lastknowndimension)){
this.setDimension(_cea);
this._lastknowndimension=_cea;
var _ceb=_cea.h-ViewBinding.VERTICAL_ADJUST;
_ceb=_ceb<0?0:_ceb;
this.windowBinding.getBindingElement().style.height=new String(_ceb)+"px";
...
var _cec=this._viewDefinition.flowHandle;
if(_cec!=null){
FlowControllerService.CancelFlow(_cec);
}
}
if(this._viewDefinition!=null){
var _ced=this._viewDefinition.handle;
EventBroadcaster.broadcast(BroadcastMessages.VIEW_CLOSED,_ced);
this.logger.fine("ViewBinding closed: \""+_ced+"\"");
}
...
var _cef=null;
if(this._viewDefinition!=null){
_cef=this._viewDefinition.handle;
}
return _cef;
};
...
ViewBinding.prototype.setDefinition=function(_cf0){
this._viewDefinition=_cf0;
if(_cf0.position==DockBinding.MAIN){
...
ViewBinding.prototype.handleAction=function(_cf1){
ViewBinding.superclass.handleAction.call(this,_cf1);
var _cf2=_cf1.target;
switch(_cf1.type){
case RootBinding.ACTION_PHASE_1:
case RootBinding.ACTION_PHASE_2:
case RootBinding.ACTION_PHASE_3:
if(_cf1.type==RootBinding.ACTION_PHASE_1){
if(this.isActivated&&!_cf2.isActivated){
_cf2.onActivate();
}
}
_cf1.consume();
...
case WindowBinding.ACTION_ONLOAD:
if(_cf2.getContentWindow().isPostBackDocument){
if(_cf1.type==WindowBinding.ACTION_ONLOAD){
var arg=this._viewDefinition.argument;
if(arg!=null&&arg.list!=null&&arg.url!=null){
_cf2.post(arg.list,arg.url);
arg.list=null;
arg.url=null;
}
}
...
if(Client.isExplorer==true){
if(_cf2==this.windowBinding){
var self=this;
DOMEvents.addEventListener(_cf2.getContentWindow(),DOMEvents.UNLOAD,{handleEvent:function(e){
...
if(_cf1.type==WindowBinding.ACTION_ONLOAD){
var win=_cf2.getContentWindow();
if(win.WindowManager==null){
if(!this._isLoaded){
this._onLoadingCompleted(_cf2);
}
}
}
_cf1.consume();
break;
case PageBinding.ACTION_ATTACHED:
if(!_cf2.label&&this._viewDefinition.label){
_cf2.label=this._viewDefinition.label;
}
if(!_cf2.image&&this._viewDefinition.image){
_cf2.image=this._viewDefinition.image;
}
if(_cf2.bindingWindow==this.getContentWindow()){
this._pageBinding=_cf2;
...
if(this.isFreeFloating&&_cf2==this._snapBinding){
...
ViewBinding.prototype.handleBroadcast=function(_cf7,arg){
ViewBinding.superclass.handleBroadcast.call(this,_cf7,arg);
switch(_cf7){
...
if(page!=null){
var _cfb=def.argument;
if(_cfb!=null){
page.setPageArgument(_cfb);
}
var _cfc=def.width;
if(_cfc!=null){
page.width=_cfc;
...
ViewBinding.prototype.handleCrawler=function(_cfe){
ViewBinding.superclass.handleCrawler.call(this,_cfe);
switch(_cfe.type){
case NodeCrawler.TYPE_DESCENDING:
if(this.isFreeFloating==true){
if(_cfe.id==FocusCrawler.ID){
if(_cfe.previousNode!=this._snapBinding.bindingElement){
_cfe.response=NodeCrawler.SKIP_NODE;
}
}
}
break;
case NodeCrawler.TYPE_ASCENDING:
if(this.isFreeFloating==true){
_cfe.nextNode=this._snapBinding.bindingElement;
}
break;
}
};
...
ViewBinding.prototype.setPosition=function(_cff){
_cff.x+=ViewBinding.HORIZONTAL_ADJUST;
this.bindingElement.style.left=_cff.x+"px";
this.bindingElement.style.top=_cff.y+"px";
};
ViewBinding.prototype.setDimension=function(_d00){
_d00.h-=ViewBinding.VERTICAL_ADJUST;
_d00.w-=ViewBinding.HORIZONTAL_ADJUST;
_d00.w-=1;
if(_d00.h<0){
_d00.h=0;
}
...
this.bindingElement.style.width=String(_d00.w)+"px";
this.bindingElement.style.height=String(_d00.h)+"px";
};
ViewBinding.prototype.snapToBinding=function(_d01){
this.isFlexBoxBehavior=false;
_d01.addActionListener(Binding.ACTION_DIMENSIONCHANGED,this);
_d01.addActionListener(Binding.ACTION_POSITIONCHANGED,this);
_d01.addActionListener(Binding.ACTION_VISIBILITYCHANGED,this);
_d01.addActionListener(Binding.ACTION_DISPOSED,this);
...
var _d02=null;
if(this.isFreeFloating==true){
_d02=this._snapBinding.getBindingElement();
}else{
_d02=ViewBinding.superclass.getMigrationParent.call(this);
}
return _d02;
};
...
ViewBinding.prototype.reload=function(_d03){
this._isLoaded=false;
this.windowBinding.reload(_d03);
EventBroadcaster.broadcast(BroadcastMessages.VIEW_OPENING,this.getHandle());
};
...
ViewBinding.newInstance=function(_d08){
var _d09=DOMUtil.createElementNS(Constants.NS_UI,"ui:view",_d08);
var _d0a=UserInterface.registerBinding(_d09,ViewBinding);
_d0a.windowBinding=_d0a.add(WindowBinding.newInstance(_d08));
_d0a.windowBinding.isFlexible=false;
return _d0a;
};
...
var _d12=this.bindingWindow.__doPostBack;
var _d13=false;
if(!form.__isSetup){
...
this.bindingWindow.__doPostBack=function(_d14,_d15){
if(!form.__isSetup){
...
PageBinding.prototype.postMessage=function(_d16,list){
var _d18=this.bindingWindow.bindingMap.__REQUEST;
if(_d18!=null&&this._isDotNet()){
switch(_d16){
...
if(list!=null){
this._postMessageToDescendants(_d16,list);
}
};
PageBinding.prototype._postMessageToDescendants=function(_d19,list){
var _d1b=this.getDescendantBindingsByType(WindowBinding);
_d1b.each(function(win){
var page=win.getPageBinding();
if(page!=null){
page.postMessage(_d19,list);
}
});
};
PageBinding.prototype._debugDotNetPostback=function(){
var list=new List();
new List(this.bindingDocument.forms[0].elements).each(function(_d1f){
list.add({name:_d1f.name,value:_d1f.value});
});
var out="";
list.each(function(_d21){
out+=_d21.name+": "+_d21.value+"\n";
});
this.logger.debug(out);
};
PageBinding.prototype.handleAction=function(_d22){
PageBinding.superclass.handleAction.call(this,_d22);
var _d23=_d22.target;
switch(_d22.type){
case RootBinding.ACTION_PHASE_3:
if(_d23==UserInterface.getBinding(this.bindingDocument.body)){
_d23.removeActionListener(RootBinding.ACTION_PHASE_3,this);
if(!this._isPageBindingInitialized){
try{
...
case PageBinding.ACTION_DOPOSTBACK:
if(this._isDotNet()){
this.doPostBack(_d23);
}
_d22.consume();
break;
case PageBinding.ACTION_DOVALIDATEDPOSTBACK:
if(this._isDotNet()){
var _d24=this.validateAllDataBindings();
if(_d24){
this.doPostBack(_d23);
}
}
...
this._initBlockers.set(_d23.key,true);
break;
case PageBinding.ACTION_UNBLOCK_INIT:
if(this._initBlockers!=null){
if(this._initBlockers.has(_d23.key)){
this._initBlockers.del(_d23.key);
...
var self=this;
var _d26={handleAction:function(_d27){
if(_d27.target==self){
self.removeActionListener(PageBinding.ACTION_UPDATED,_d26);
MessageQueue.udpdate();
}
}};
this.addActionListener(PageBinding.ACTION_UPDATED,_d26);
}else{
MessageQueue.udpdate();
}
_d22.consume();
...
PageBinding.prototype.handleBroadcast=function(_d28,arg){
PageBinding.superclass.handleBroadcast.call(this,_d28,arg);
switch(_d28){
case BroadcastMessages.MESSAGEQUEUE_REQUESTED:
var _d2a=arg;
if(!this._canPostBack&&!_d2a){
this._canPostBack=true;
Application.unlock(this);
}
break;
...
PageBinding.prototype.doPostBack=function(_d2c){
if(this._canPostBack){
if(_d2c!=null&&this._isDotNet()){
var _d2d=_d2c.getCallBackID();
var _d2e=_d2c.getCallBackArg();
if(_d2d!=null){
_d2d=_d2d.replace(/_/g,"$");
}else{
_d2d="";
}
if(_d2e==null){
...
this.bindingWindow.__doPostBack(_d2d,_d2e);
}
}
};
...
while(_d30.hasNext()&&_d2f){
var _d31=_d30.getNext();
if(_d31.isAttached){
var _d32=_d31.validate();
if(_d2f&&!_d32){
_d2f=false;
this.logger.debug("Invalid DataBinding: "+_d31.toString()+" ("+_d31.getName()+")");
break;
}
}
}
...
var _d37=this.bindingWindow.DataManager.getAllDataBindings();
while(_d37.hasNext()){
var _d38=_d37.getNext();
if(_d38.isAttached){
_d38.clean();
}
}
...
this.isActivated=false;
if(this._cachedFocus!=null){
var _d3a=this._cachedFocus.getBinding();
if(_d3a){
_d3a.blur();
}
}
...
if(this.width==null){
var _d3b=this.getProperty("width");
if(!_d3b){
_d3b=this.hasClassName(DialogPageBinding.CLASSNAME_TABBOXED)?DialogPageBinding.DEFAULT_TABBOXED_WIDTH:DialogPageBinding.DEFAULT_WIDTH;
}
this.width=_d3b;
}
if(this.height==null){
var _d3c=this.getProperty("height");
this.height=_d3c?_d3c:DialogPageBinding.DEFAULT_HEIGHT;
}
if(this.minheight==null){
var _d3d=this.getProperty("minheight");
if(_d3d!=null){
this.minheight=_d3d;
}
}
if(this.controls==null){
var _d3e=this.getProperty("controls");
this.controls=_d3e?_d3e:DialogPageBinding.DEFAULT_CONTROLS;
}
if(!this.isResizable){
var _d3f=this.getProperty("resizable");
this.isResizable=_d3f?_d3f:DialogPageBinding.DEFAULT_RESIZABLE;
}
if(this.height=="auto"){
this.enableAutoHeightLayoutMode(true);
}
};
DialogPageBinding.prototype.enableAutoHeightLayoutMode=function(_d40){
if(_d40!=this.isAutoHeightLayoutMode){
if(_d40){
this.attachClassName("auto");
}else{
this.detachClassName("auto");
}
this.isAutoHeightLayoutMode=_d40;
}
};
DialogPageBinding.prototype.handleAction=function(_d41){
DialogPageBinding.superclass.handleAction.call(this,_d41);
var _d42=_d41.target;
switch(_d41.type){
case PageBinding.ACTION_ATTACHED:
if(_d42!=this&&_d42.isFitAsDialogSubPage){
_d42.makeDialogSubPage();
}
break;
case ButtonBinding.ACTION_COMMAND:
_d41.consume();
if(_d42.response!=null){
this.response=_d42.response;
switch(_d42.response){
case Dialog.RESPONSE_ACCEPT:
...
DialogPageBinding.prototype._disableAcceptButton=function(_d43){
var _d44=this.bindingWindow.bindingMap.buttonAccept;
if(_d44!=null){
_d44.setDisabled(_d43);
}
};
...
DialogPageBodyBinding.prototype._setFitnessHeight=function(_d45){
var _d46=CSSComputer.getPadding(this.bindingElement);
var _d47=CSSComputer.getBorder(this.bindingElement);
_d45+=_d46.top+_d46.bottom;
_d45+=_d47.top+_d47.bottom;
if(_d45>this.bindingElement.offsetHeight){
this.bindingElement.style.height=_d45+"px";
}
};
...
EditorPageBinding.prototype.handleAction=function(_d4f){
EditorPageBinding.superclass.handleAction.call(this,_d4f);
...
var res=page.bindingWindow==_d50.bindingWindow;
if(res){
...
case Binding.ACTION_INVALID:
this.enableSave(false);
this._invalidBindings.set(_d50.key,_d50);
if(_d50 instanceof FieldsBinding){
this._updateStatusBar();
}
break;
case Binding.ACTION_VALID:
this._invalidBindings.del(_d50.key);
if(_d50 instanceof FieldsBinding){
this._updateStatusBar();
}
...
if(_d50==this._tabBoxBinding){
if(this._windowBinding!=null){
var tab=_d50.getSelectedTabBinding();
...
case WindowBinding.ACTION_ONLOAD:
if(_d50==this._windowBinding){
if(_d50.getContentWindow().isPostBackDocument!=true){
if(Client.isPrism){
Prism.enableCache();
}
var self=this;
...
var _d56=WindowBinding.getMarkup(this._windowBinding);
EventBroadcaster.broadcast(BroadcastMessages.XHTML_MARKUP_ON,_d56);
}
}
}
break;
...
var _d57=this.bindingWindow.bindingMap.savebutton;
if(_d57!=null&&!_d57.isDisabled){
_d57.fireCommand();
}
};
...
if(_d58!=null){
_d58.postback(EditorPageBinding.MESSAGE_SAVE);
}else{
...
EditorPageBinding.prototype.postMessage=function(_d59){
this._message=null;
switch(_d59){
case EditorPageBinding.MESSAGE_SAVE:
this._postMessageToDescendants(_d59,this._messengers);
if(!this._messengers.hasEntries()){
this._saveEditorPage();
}else{
this._message=_d59;
...
case EditorPageBinding.MESSAGE_PERSIST:
this._message=_d59;
EditorPageBinding.superclass.postMessage.call(this,_d59,this._messengers);
break;
...
EditorPageBinding.prototype.handleBroadcast=function(_d5a,arg){
EditorPageBinding.superclass.handleBroadcast.call(this,_d5a,arg);
switch(_d5a){
case BroadcastMessages.HIGHLIGHT_KEYWORDS:
var _d5c=arg;
if(UserInterface.isBindingVisible(this._windowBinding)){
WindowBinding.highlightKeywords(this._windowBinding,_d5c);
}
break;
}
};
...
var _d5d=new List();
this._invalidBindings.each(function(key,_d5f){
var list=_d5f.getInvalidLabels();
if(list){
...
var _d63=StringBundle.getString("ui","Website.App.StatusBar.ErrorInField");
StatusBar.error(_d63+" "+_d62);
}else{
StatusBar.clear();
}
};
...
EditorPageBinding.prototype.enableSave=function(_d64){
var _d65=this.bindingDocument.getElementById("broadcasterCanSave");
if(_d65){
var _d66=UserInterface.getBinding(_d65);
if(_d64){
_d66.enable();
}else{
_d66.disable();
...
var _d67=this.bindingDocument.getElementById(EditorPageBinding.ID_SAVEASBUTTON);
if(_d67!=null){
UserInterface.getBinding(_d67).enable();
}
};
...
var _d68=this._windowBinding.getContentDocument().title;
if(_d68==WindowBinding.POSTBACK_TITLE){
if(this.validateAllDataBindings()){
this.manifestAllDataBindings();
var _d69=this._tabBinding.getCallBackID();
var list=new List();
new List(this.bindingDocument.forms[0].elements).each(function(_d6b){
if(_d6b.name=="__EVENTTARGET"&&_d69){
_d6b.value=_d69;
}
list.add({name:_d6b.name,value:_d6b.value});
});
...
WizardPageBinding.prototype.handleAction=function(_d6d){
WizardPageBinding.superclass.handleAction.call(this,_d6d);
var _d6e=_d6d.target;
switch(_d6d.type){
case WizardPageBinding.ACTION_NAVIGATE_NEXT:
case WizardPageBinding.ACTION_FINISH:
if(this.validateAllDataBindings()==true){
this.doPostBack(_d6e);
}else{
_d6d.consume();
}
break;
...
WizardPageBinding.prototype._enableNextAndFinish=function(_d6f){
var next=this.bindingWindow.bindingMap.nextbutton;
var _d71=this.bindingWindow.bindingMap.finishbutton;
if(next){
next.setDisabled(!_d6f);
}
if(_d71){
_d71.setDisabled(!_d6f);
}
};
...
MarkupAwarePageBinding.prototype.handleBroadcast=function(_d72,arg){
MarkupAwarePageBinding.superclass.handleBroadcast.call(this,_d72,arg);
var self=this;
switch(_d72){
...
MarkupAwarePageBinding.prototype._handleMarkup=function(_d76){
};
MarkupAwarePageBinding.prototype._activate=function(_d77){
};
...
var _d78=this.bindingWindow.bindingMap.moreactionstoolbargroup;
this._moreActionsWidth=_d78.boxObject.getDimension().w;
_d78.hide();
var _d79=this.boxObject.getDimension().h;
this.bindingElement.style.height=_d79+"px";
var self=this;
var _d7b=this.bindingWindow.bindingMap.moreactionsbutton;
_d7b.addActionListener(ButtonBinding.ACTION_COMMAND,{handleAction:function(_d7c){
self._showMoreActions();
_d7c.consume();
}});
var _d7d=this.bindingWindow.bindingMap.moreactionspopup;
_d7d.addActionListener(MenuItemBinding.ACTION_COMMAND,{handleAction:function(_d7e){
var item=_d7e.target;
self._handleSystemAction(item.associatedSystemAction);
}});
SystemToolBarBinding.superclass.onBindingInitialize.call(this);
};
SystemToolBarBinding.prototype.handleBroadcast=function(_d80,arg){
SystemToolBarBinding.superclass.handleBroadcast.call(this,_d80,arg);
switch(_d80){
...
var _d84=self.bindingWindow.bindingMap.moreactionstoolbargroup;
if(_d84!=null){
_d84.hide();
}
},0);
...
break;
case this.bindingWindow.WindowManager.WINDOW_RESIZED_BROADCAST:
var _d85=this.bindingWindow.WindowManager;
...
var _d86=new String("");
this._actionProfile.each(function(_d87,list){
list.each(function(_d89){
_d86+=_d89.getHandle()+";"+_d89.getKey()+";";
if(_d89.isDisabled()){
_d86+="isDisabled='true';";
}
});
});
return _d86;
};
SystemToolBarBinding.prototype.handleAction=function(_d8a){
SystemToolBarBinding.superclass.handleAction.call(this,_d8a);
switch(_d8a.type){
case ButtonBinding.ACTION_COMMAND:
var _d8b=_d8a.target;
this._handleSystemAction(_d8b.associatedSystemAction);
break;
}
};
SystemToolBarBinding.prototype._handleSystemAction=function(_d8c){
if(_d8c!=null){
var list=ExplorerBinding.getFocusedTreeNodeBindings();
if(list.hasEntries()){
var _d8e=list.getFirst();
var _d8f=_d8e.node;
}
SystemAction.invoke(_d8c,_d8f);
}
};
...
var self=this;
this._actionProfile.each(function(_d92,list){
var _d94=new List();
list.reset();
while(list.hasNext()){
var _d95=list.getNext();
var _d96=null;
if(_d95.isInToolBar()){
if(_d95.isInFolder()){
alert("IsInFolder not implemented!");
}else{
_d96=self.getToolBarButtonBinding(_d95);
}
}
if(_d96!=null){
_d94.add(_d96);
...
if(_d94.hasEntries()){
var _d97=ToolBarGroupBinding.newInstance(doc);
_d94.each(function(_d98){
_d97.add(_d98);
});
self.addLeft(_d97);
}
...
var _d99=this.bindingWindow.bindingMap.toolsbutton;
var _d9a=this.bindingWindow.bindingMap.moreactionstoolbargroup;
var _d9b=_d99.bindingElement.offsetLeft-this._moreActionsWidth;
var _d9c=0;
var _d9d=new List();
var _d9e,_d9f=this._toolBarBodyLeft.getDescendantBindingsByLocalName("toolbarbutton");
while((_d9e=_d9f.getNext())!=null){
if(!_d9e.isVisible){
_d9e.show();
}
_d9c+=_d9e.boxObject.getDimension().w;
if(_d9c>=_d9b){
_d9d.add(_d9e);
_d9e.hide();
}
...
if(_d9d.hasEntries()){
var _da0=_d9d.getFirst().bindingElement.parentNode;
UserInterface.getBinding(_da0).setLayout(ToolBarGroupBinding.LAYOUT_LAST);
this._moreActions=new List();
while((_d9e=_d9d.getNext())!=null){
this._moreActions.add(_d9e.associatedSystemAction);
}
_d9a.show();
}else{
this._moreActions=null;
...
var _da1=this.bindingWindow.bindingMap.moreactionspopup;
_da1.empty();
while((action=this._moreActions.getNext())!=null){
var item=MenuItemBinding.newInstance(_da1.bindingDocument);
...
_da1.attachRecursive();
this._moreActions=null;
}
};
SystemToolBarBinding.prototype.getToolBarButtonBinding=function(_da3){
var _da4=ToolBarButtonBinding.newInstance(this.bindingDocument);
var _da5=_da3.getLabel();
var _da6=_da3.getToolTip();
var _da7=_da3.getImage();
var _da8=_da3.isDisabled();
if(_da7&&_da7.indexOf("size=")==-1){
_da7=_da7+"&size="+this.getImageSize();
_da4.imageProfile=new ImageProfile({image:_da7});
}
if(_da5){
_da4.setLabel(_da5);
}
if(_da6){
_da4.setToolTip(_da6);
}
if(_da3.isDisabled()){
_da4.disable();
}
_da4.associatedSystemAction=_da3;
return _da4;
};
SystemToolBarBinding.prototype._invokeDefaultAction=function(){
var _da9=this.getDescendantBindingByLocalName("toolbarbutton");
if(_da9!=null){
_da9.fireCommand();
}
};
...
SystemToolBarBinding.newInstance=function(_daa){
var _dab=DOMUtil.createElementNS(Constants.NS_UI,"ui:toolbar",_daa);
return UserInterface.registerBinding(_dab,SystemToolBarBinding);
};
...
SystemTreeBinding.prototype.add=function(_dac){
var _dad=SystemTreeBinding.superclass.add.call(this,_dac);
if(!this._defaultTreeNode){
if(_dac instanceof SystemTreeNodeBinding){
this._defaultTreeNode=_dac;
}
}
return _dad;
};
SystemTreeBinding.prototype.handleAction=function(_dae){
SystemTreeBinding.superclass.handleAction.call(this,_dae);
...
this._updateRefreshingTrees(_daf.key);
...
if(_dae.type==TreeNodeBinding.ACTION_BLUR){
this._restorableFocusHandle=_daf.getHandle();
}
break;
...
var _db1=this._treeNodeBindings.get(this._restorableFocusHandle);
...
SystemTreeBinding.prototype.registerTreeNodeBinding=function(_db2){
SystemTreeBinding.superclass.registerTreeNodeBinding.call(this,_db2);
var reg=this._entityTokenRegistry;
var _db4=_db2.node.getEntityToken();
if(reg.has(_db4)){
reg.get(_db4).add(_db2);
}else{
reg.set(_db4,new List([_db2]));
}
var _db5=null;
if(this.isLockedToEditor){
if(_db4==StageBinding.entityToken){
if(_db2.node.isTreeLockEnabled()){
_db5=_db2;
}
}
}else{
if(this._backupfocushandle!=null){
if(this._backupfocushandle==_db2.node.getHandle()){
_db5=_db2;
}
}
}
if(_db5!=null){
this.focusSingleTreeNodeBinding(_db5);
}
};
SystemTreeBinding.prototype.unRegisterTreeNodeBinding=function(_db6){
SystemTreeBinding.superclass.unRegisterTreeNodeBinding.call(this,_db6);
var reg=this._entityTokenRegistry;
var _db8=_db6.node.getEntityToken();
if(reg.has(_db8)){
var list=reg.get(_db8);
list.del(_db6);
if(!list.hasEntries()){
reg.del(_db8);
}
...
if(!this.isLockedToEditor){
if(_db6.isFocused&&this._backupfocushandle==null){
this._backupfocushandle=_db6.node.getHandle();
var self=this;
setTimeout(function(){
...
var _dbc=this._refreshingTreeNodes;
if(_dbc.hasEntries()&&_dbc.has(key)){
_dbc.del(key);
if(!_dbc.hasEntries()){
...
var _dbd=StageBinding.entityToken;
if(_dbd!=null){
this._focusTreeNodeByEntityToken(_dbd);
}
}
};
SystemTreeBinding.prototype._computeClipboardSetup=function(){
var _dbe=false;
var _dbf=this.getFocusedTreeNodeBindings();
if(this._activePosition==SystemAction.activePositions.SelectorTree){
_dbe=false;
}else{
if(_dbf.hasEntries()){
_dbe=true;
while(_dbe&&_dbf.hasNext()){
var _dc0=_dbf.getNext();
if(!_dc0.isDraggable){
_dbe=false;
}
}
...
SystemTreePopupBinding.isCutAllowed=_dbe;
};
...
SystemTreeBinding.prototype.handleBroadcast=function(_dc1,arg){
SystemTreeBinding.superclass.handleBroadcast.call(this,_dc1,arg);
switch(_dc1){
case BroadcastMessages.SYSTEMTREEBINDING_REFRESH:
if(arg!=null||this.isFocused){
this._handleCommandBroadcast(_dc1,arg);
}
break;
...
if(this.isFocused){
this._handleCommandBroadcast(_dc1);
}
break;
...
var self=this,_dc5=arg;
setTimeout(function(){
if(_dc5!=null){
self._focusTreeNodeByEntityToken(_dc5);
}
},250);
break;
}
...
var _dc7=tab.perspectiveNode==null;
if(!_dc7){
_dc7=tab.perspectiveNode==this.perspectiveNode;
}
if(_dc7){
var self=this,_dc9=tab.getEntityToken();
setTimeout(function(){
if(_dc9==null){
self.blurSelectedTreeNodes();
}else{
self._focusTreeNodeByEntityToken(_dc9);
}
},250);
}
};
SystemTreeBinding.prototype._focusTreeNodeByEntityToken=function(_dca,_dcb){
this.isLockFeatureFocus=true;
var _dcc=null;
if(this._entityTokenRegistry.has(_dca)){
var list=this._entityTokenRegistry.get(_dca);
...
if(_dcc!=null){
if(!_dcc.isFocused){
this.focusSingleTreeNodeBinding(_dcc,true);
}else{
_dcc.dispatchAction(TreeNodeBinding.ACTION_FOCUSED);
}
}
}
this.isLockFeatureFocus=false;
if(_dcc==null&&_dcb!=true){
Application.lock(this);
StatusBar.busy();
var self=this;
setTimeout(function(){
if(Binding.exists(self)){
self._fetchTreeForEntityToken(_dca);
self._focusTreeNodeByEntityToken(_dca,true);
}
Application.unlock(self);
StatusBar.clear();
},0);
...
SystemTreeBinding.prototype._fetchTreeForEntityToken=function(_dd1){
var _dd2=StageBinding.perspectiveNode.getEntityToken();
if(this._activePosition==SystemAction.activePositions.SelectorTree){
var _dd2=this.getRootTreeNodeBindings().getFirst().node.getEntityToken();
}
var _dd3=this.getOpenSystemNodes();
var map=System.getInvisibleBranch(_dd2,_dd1,_dd3);
if(map==null){
...
if(map.hasEntries()){
var self=this;
var _dd6=this._treeNodeBindings;
var _dd7=new Map();
function fix(_dd8,list){
if(!_dd8.hasBeenOpened){
if(list.hasEntries()){
list.each(function(node){
if(!_dd6.has(node.getHandle())){
var _ddb=SystemTreeNodeBinding.newInstance(node,self.bindingDocument);
_dd7.set(node.getHandle(),_ddb);
_dd8.add(_ddb);
}
});
...
map.each(function(_ddc,list){
if(_dd6.has(_ddc)){
var _dde=_dd6.get(_ddc);
fix(_dde,list);
}else{
if(_dd7.has(_ddc)){
var _ddf=_dd7.get(_ddc);
fix(_ddf,list);
}else{
}
}
...
SystemTreeBinding.prototype._handleCommandBroadcast=function(_de0,arg){
switch(_de0){
case BroadcastMessages.SYSTEMTREEBINDING_REFRESH:
var _de2=arg;
if(_de2!=null){
this._invokeServerRefresh(_de2);
}else{
...
var _de3=this.getFocusedTreeNodeBindings().getFirst();
SystemTreeBinding.clipboardOperation=SystemTreePopupBinding.CMD_CUT;
SystemTreeBinding.clipboard=_de3;
_de3.showDrag();
break;
case BroadcastMessages.SYSTEMTREEBINDING_COPY:
var _de3=this.getFocusedTreeNodeBindings().getFirst();
...
SystemTreeBinding.prototype._invokeServerRefresh=function(_de4){
if(_de4!=null&&_de4=="null"){
if(Application.isDeveloperMode){
alert("Saa har vi balladen.");
}
}
if(this._entityTokenRegistry.has(_de4)){
var list=this._entityTokenRegistry.get(_de4).reset();
this._refreshToken=_de4;
EventBroadcaster.broadcast(BroadcastMessages.SYSTEMTREEBINDING_REFRESHING,this._refreshToken);
while(list.hasNext()){
var _de6=list.getNext();
this._refreshingTreeNodes.set(_de6.key,true);
setTimeout(function(){
_de6.refresh(true);
},0);
}
...
var _de7=this.getFocusedTreeNodeBindings().getFirst();
if(_de7){
var _de8=_de7.getLabel();
var _de9=_de7.getAncestorBindingByLocalName("treenode");
if(_de9){
_de7=_de9;
}
this._refreshToken=null;
...
if(!StatusBar.state){
var _dea=StringBundle.getString("ui","Website.App.StatusBar.Refreshing");
StatusBar.busy(_dea,[_de8]);
}
_de7.refresh();
}
};
SystemTreeBinding.prototype._handlePaste=function(){
var _deb=SystemTreeBinding.clipboard;
if(_deb){
var type=_deb.dragType;
var _ded=this.getFocusedTreeNodeBindings().getFirst();
if(_ded.dragAccept){
if(_ded.acceptor.isAccepting(type)){
this._performPaste(_ded);
}else{
...
SystemTreeBinding.prototype._performPaste=function(_dee){
var self=this;
function update(){
MessageQueue.update();
Application.unlock(self);
}
if(_dee.node.hasDetailedDropSupport()){
if(_dee.node.hasChildren()){
var _df0=_dee.node.getChildren();
Dialog.invokeModal(SystemTreeBinding.URL_DIALOG_DETAILEDPASTE,{handleDialogResponse:function(_df1,_df2){
if(_df1==Dialog.RESPONSE_ACCEPT){
Application.lock(self);
var _df3=_df2.get("switch");
var _df4=_df2.get("sibling");
if(_df3=="after"){
_df4++;
}
var _df5=_dee.accept(SystemTreeBinding.clipboard,_df4);
if(_df5){
SystemTreeBinding.clipboard=null;
SystemTreeBinding.clipboardOperation=null;
setTimeout(update,0);
...
Application.lock(self);
var _df6=_dee.accept(SystemTreeBinding.clipboard,0);
if(_df6){
SystemTreeBinding.clipboard=null;
SystemTreeBinding.clipboardOperation=null;
setTimeout(update,0);
...
SystemTreeBinding.prototype.collapse=function(_df7){
EventBroadcaster.broadcast(BroadcastMessages.SYSTEM_ACTIONPROFILE_PUBLISHED,{position:this._activePosition});
if(_df7){
this.blurSelectedTreeNodes();
var _df8=this.getRootTreeNodeBindings();
_df8.each(function(_df9){
if(_df9.isContainer&&_df9.isOpen){
_df9.close();
_df9.hasBeenOpened=false;
_df9.empty();
}
});
}else{
...
SystemTreeBinding.prototype.setLockToEditor=function(_dfa){
if(_dfa!=this.isLockedToEditor){
this.isLockedToEditor=_dfa;
if(_dfa){
...
_dfc.each(function(_dfd){
var _dfe=_dfd.getOpenSystemNodes();
if(_dfe!=null&&_dfe.hasEntries()){
list.merge(_dfe);
}else{
if(_dfd.isOpen){
list.add(_dfd.node);
...
SystemTreeBinding.prototype.focusSingleTreeNodeBinding=function(_dff){
SystemTreeBinding.superclass.focusSingleTreeNodeBinding.call(this,_dff);
if(_dff!=null){
this._handleSystemTreeFocus();
}
};
...
var temp={};
var _e01=new Map();
var _e02=this.getFocusedTreeNodeBindings();
var _e03=_e02.getFirst().node.getActionProfile();
var self=this;
_e03.each(function(_e05,list){
var _e07=new List();
list.each(function(_e08){
if(_e08.getActivePositions()&self._activePosition){
_e07.add(_e08);
}
});
if(_e07.hasEntries()){
...
_e01.activePosition=this._activePosition;
return _e01;
};
...
SystemTreePopupBinding.prototype.handleBroadcast=function(_e09,arg){
SystemTreePopupBinding.superclass.handleBroadcast.call(this,_e09,arg);
switch(_e09){
case BroadcastMessages.SYSTEM_ACTIONPROFILE_PUBLISHED:
...
var _e0e=this.getMenuItemForCommand(SystemTreePopupBinding.CMD_PASTE);
cut.setDisabled(!SystemTreePopupBinding.isCutAllowed);
copy.setDisabled(!SystemTreePopupBinding.isCutAllowed);
_e0e.setDisabled(SystemTreeBinding.clipboard==null);
};
SystemTreePopupBinding.prototype._setupRefreshItem=function(){
var _e0f=this.getMenuItemForCommand(SystemTreePopupBinding.CMD_REFRESH);
_e0f.setDisabled(!SystemTreePopupBinding.isRefreshAllowed);
};
SystemTreePopupBinding.prototype.handleAction=function(_e10){
SystemTreePopupBinding.superclass.handleAction.call(this,_e10);
switch(_e10.type){
case MenuItemBinding.ACTION_COMMAND:
var _e11=_e10.target;
var _e12=_e11.associatedSystemAction;
if(_e12){
var list=ExplorerBinding.getFocusedTreeNodeBindings();
if(list.hasEntries()){
var _e14=list.getFirst();
var _e15=_e14.node;
}
SystemAction.invoke(_e12,_e15);
}else{
var cmd=_e11.getProperty("cmd");
if(cmd){
...
_e18=BroadcastMessages.SYSTEMTREEBINDING_CUT;
break;
case SystemTreePopupBinding.CMD_COPY:
_e18=BroadcastMessages.SYSTEMTREEBINDING_COPY;
break;
case SystemTreePopupBinding.CMD_PASTE:
_e18=BroadcastMessages.SYSTEMTREEBINDING_PASTE;
break;
case SystemTreePopupBinding.CMD_REFRESH:
_e18=BroadcastMessages.SYSTEMTREEBINDING_REFRESH;
break;
}
if(_e18){
setTimeout(function(){
EventBroadcaster.broadcast(_e18);
},0);
}
};
SystemTreePopupBinding.prototype.disposeContent=function(){
var _e19=new List(DOMUtil.getElementsByTagName(this.bindingElement,"menugroup"));
while(_e19.hasNext()){
var _e1a=UserInterface.getBinding(_e19.getNext());
if(!_e1a.getProperty("rel")){
_e1a.dispose();
}
}
};
...
var _e1c=new List();
var self=this;
this._actionProfile.each(function(_e1e,list){
var _e20=MenuGroupBinding.newInstance(doc);
list.each(function(_e21){
var _e22=self.getMenuItemBinding(_e21);
_e20.add(_e22);
});
_e1c.add(_e20);
});
_e1c.reverse();
while(_e1c.hasNext()){
this._bodyBinding.addFirst(_e1c.getNext());
}
this._bodyBinding.attachRecursive();
}
};
SystemTreePopupBinding.prototype.getMenuItemBinding=function(_e23){
var _e24=MenuItemBinding.newInstance(this.bindingDocument);
var _e25=_e23.getLabel();
var _e26=_e23.getToolTip();
var _e27=_e23.getImage();
var _e28=_e23.getDisabledImage();
var _e29=_e23.isCheckBox();
if(_e25){
_e24.setLabel(_e25);
}
if(_e26){
_e24.setToolTip(_e26);
}
if(_e27){
_e24.imageProfile=new ImageProfile({image:_e27,imageDisabled:_e28});
}
if(_e29){
_e24.setType(MenuItemBinding.TYPE_CHECKBOX);
if(_e23.isChecked()){
_e24.check(true);
}
}
...
_e24.associatedSystemAction=_e23;
return _e24;
};
...
if(node!=null){
_e2d=UserInterface.getBinding(node);
if(_e2d.isDisabled){
_e2d=null;
}
}
...
if(_e2d!=null&&_e2d.node!=null&&_e2d.node.getActionProfile()!=null){
...
var _e2e=this.node.getLabel();
if(_e2e){
this.setLabel(_e2e);
}
var _e2f=this.node.getToolTip();
if(_e2f){
this.setToolTip(_e2f);
}
var _e30=this.node.getHandle();
if(_e30){
this.setHandle(_e30);
}
...
this.setProperty("dragaccept",_e33);
}
SystemTreeNodeBinding.superclass._initializeBindingDragAndDropFeatures.call(this);
};
SystemTreeNodeBinding.prototype.handleAction=function(_e35){
SystemTreeNodeBinding.superclass.handleAction.call(this,_e35);
switch(_e35.type){
...
SystemTreeNodeBinding.prototype.handleBroadcast=function(_e36,arg){
SystemTreeNodeBinding.superclass.handleBroadcast.call(this,_e36,arg);
switch(_e36){
...
var _e39=null;
var _e3a=this.node.getImageProfile();
if(_e3a){
if(this.isOpen){
_e39=_e3a.getActiveImage();
}else{
_e39=_e3a.getDefaultImage();
}
}
if(!_e39){
_e39=SystemTreeNodeBinding.superclass.computeImage.call(this);
}
return _e39;
};
SystemTreeNodeBinding.prototype.open=function(_e3b){
var _e3c=this.isContainer&&!this.isOpen;
var _e3d=!this.hasBeenOpened;
SystemTreeNodeBinding.superclass.open.call(this);
if(_e3c&&(_e3d||SystemTreeBinding.HAS_NO_MEMORY)&&_e3b!=true){
this.refresh();
...
SystemTreeNodeBinding.prototype._performRefresh=function(_e40){
if(_e40!=null){
this._refreshBranch(_e40);
}else{
...
var _e41=new List();
var _e42=this.node.getChildren();
this.empty();
if(_e42.hasEntries()){
this._insertTreeNodesRegulated(_e42);
}
};
SystemTreeNodeBinding.prototype._insertTreeNodesRegulated=function(_e43){
var _e44=0;
var _e45=new List([]);
while(_e43.hasEntries()&&_e44<=SystemTreeNodeBinding.MAX_CHILD_IMPORT){
var _e46=SystemTreeNodeBinding.newInstance(_e43.extractFirst(),this.bindingDocument);
_e46.autoExpand=this.autoExpand;
this.add(_e46);
_e46.attach();
_e44++;
if(this.autoExpand){
if(_e44==1&&!_e43.hasEntries()||LastOpenedSystemNodes.isOpen(_e46)){
_e45.add(_e46);
}
}
}
if(_e43.hasEntries()){
this._insertBufferTreeNode(_e43);
}
_e45.each(function(node){
if(node.isContainer&&!node.isOpen){
var self=node;
setTimeout(function(){
self.open();
...
SystemTreeNodeBinding.prototype._insertBufferTreeNode=function(_e49){
...
var _e4b=this.node.getDescendantBranch(list);
if(_e4b.hasEntries()){
this.XXX(_e4b);
}
};
SystemTreeNodeBinding.prototype.XXX=function(_e4c){
var self=this;
var map=new Map();
this.empty();
_e4c.each(function(key,_e50){
if(_e50.hasEntries()){
_e50.each(function(node){
var _e52=SystemTreeNodeBinding.newInstance(node,self.bindingDocument);
map.set(node.getHandle(),_e52);
if(map.has(key)){
var _e53=map.get(key);
_e53.add(_e52);
_e53.isOpen=true;
_e53.hasBeenOpened=true;
}else{
...
var _e54=new TreeCrawler();
var _e55=new List();
_e54.mode=TreeCrawler.MODE_GETOPEN;
_e54.crawl(this.bindingElement,_e55);
if(_e55.hasEntries()){
_e55.extractFirst();
}
_e54.dispose();
...
SystemTreeNodeBinding.prototype.acceptTreeNodeBinding=function(_e59,_e5a){
var _e5b=(SystemTreeBinding.clipboardOperation==SystemTreePopupBinding.CMD_COPY);
if(_e59 instanceof SystemTreeNodeBinding){
if(TreeService.ExecuteDropElementAction){
TreeService.ExecuteDropElementAction(_e59.node.getData(),this.node.getData(),_e5a?_e5a:this.containingTreeBinding.getDropIndex(),Application.CONSOLE_ID,_e5b);
}
}
};
...
SystemTreeNodeBinding.newInstance=function(node,_e5f){
var _e60=DOMUtil.createElementNS(Constants.NS_UI,"ui:treenode",_e5f);
var _e61=UserInterface.registerBinding(_e60,SystemTreeNodeBinding);
_e61.node=node;
return _e61;
};
...
SystemPageBinding.prototype.setPageArgument=function(_e62){
this.node=_e62;
SystemPageBinding.superclass.setPageArgument.call(this,_e62);
};
...
var _e63=this.node.getChildren();
if(_e63.hasEntries()){
while(_e63.hasNext()){
var node=SystemTreeNodeBinding.newInstance(_e63.getNext(),this.bindingDocument);
this._tree.add(node);
node.attach();
}
}
...
var _e65=this._tree._treeBodyBinding.getChildBindingsByLocalName("treenode");
_e65.each(function(root){
if(!root.isContainer){
root.isOpen=true;
}
});
var _e67=new TreeCrawler();
var _e68=new List();
_e67.mode=TreeCrawler.MODE_GETOPEN;
_e67.crawl(this.bindingElement,_e68);
_e67.dispose();
var list=new List([this.node]);
_e68.each(function(_e6a){
list.add(_e6a.node);
});
this._tree.empty();
var _e6b=this.node.getDescendantBranch(list);
if(_e6b.hasEntries()){
var self=this;
var map=new Map();
_e6b.each(function(key,_e6f){
_e6f.each(function(node){
var _e71=SystemTreeNodeBinding.newInstance(node,self.bindingDocument);
map.set(node.getHandle(),_e71);
if(map.has(key)){
var _e72=map.get(key);
_e72.add(_e71);
_e72.isOpen=true;
}else{
if(key==self.node.getHandle()){
...
SystemPageBinding.prototype.handleAction=function(_e73){
SystemPageBinding.superclass.handleAction.call(this,_e73);
switch(_e73.type){
case ButtonBinding.ACTION_COMMAND:
var _e74=_e73.target;
switch(_e74.getID()){
case "locktreebutton":
this._tree.setLockToEditor(_e74.isChecked);
break;
case "collapsebutton":
this._tree.collapse();
break;
...
SystemPageBinding.prototype.handleBroadcast=function(_e75,arg){
SystemPageBinding.superclass.handleBroadcast.call(this,_e75,arg);
switch(_e75){
case BroadcastMessages.SYSTEMTREEBINDING_REFRESH:
var _e77=arg;
if(this.node&&this.node.getEntityToken()==_e77){
try{
EventBroadcaster.broadcast(BroadcastMessages.SYSTEMTREEBINDING_REFRESHING,_e77);
var self=this;
Application.lock(this);
setTimeout(function(){
self._refreshTree();
EventBroadcaster.broadcast(BroadcastMessages.SYSTEMTREEBINDING_REFRESHED,_e77);
Application.unlock(self);
},0);
}
catch(exception){
...
StageContainerBinding.prototype.handleBroadcast=function(_e79,arg){
StageContainerBinding.superclass.handleBroadcast.call(this,_e79,arg);
var _e7b=this.bindingWindow.WindowManager;
switch(_e79){
case BroadcastMessages.APPLICATION_OPERATIONAL:
this.subscribe(_e7b.WINDOW_RESIZED_BROADCAST);
this._fit();
this.reflex();
break;
case _e7b.WINDOW_RESIZED_BROADCAST:
if(Client.isMozilla==true){
this._fit();
this.reflex();
}else{
...
var _e7d=this.bindingWindow.WindowManager;
this.bindingElement.style.width=_e7d.getWindowDimensions().w+"px";
};
...
StageBinding.handleViewPresentation=function(_e7e){
if(StageBinding.isViewOpen(_e7e)){
EventBroadcaster.broadcast(BroadcastMessages.CLOSE_VIEW,_e7e);
}else{
var _e7f=ViewDefinitions[_e7e];
StageBinding.presentViewDefinition(_e7f);
}
};
StageBinding.isViewOpen=function(_e80){
return StageBinding.bindingInstance._activeViewDefinitions[_e80]!=null;
};
StageBinding.presentViewDefinition=function(_e81){
if(_e81.label!=null){
var _e82=StringBundle.getString("ui","Website.App.StatusBar.Opening");
StatusBar.busy(_e82,[_e81.label]);
}else{
StatusBar.busy();
}
StageBinding.bindingInstance._presentViewDefinition(_e81);
};
...
EventBroadcaster.subscribe(BroadcastMessages.SYSTEMTREEBINDING_REFRESH,{handleBroadcast:function(_e84,arg){
if(arg==root.getEntityToken()){
EventBroadcaster.broadcast(BroadcastMessages.SYSTEMTREEBINDING_REFRESHALL);
}
}});
var _e86=System.getPerspectiveNodes();
if(_e86.hasEntries()){
this._initializeSystemViewDefinitions(_e86);
}else{
...
var _e88=null;
if(LocalStore.isEnabled){
_e88=LocalStore.getProperty(LocalStore.SELECTED_PERSPECTIVE_HANDLE);
}
if(_e88&&ViewDefinitions[_e88]){
alert("StageBinding#_initializeWorkbenchLayout !!!!");
this._explorerBinding.setSelectionByHandle(unescape(_e88));
}else{
...
var _e8a=root.getActionProfile();
if(_e8a&&_e8a.hasEntries()){
var _e8b=top.app.bindingMap.toolsmenugroup;
if(_e8b){
_e8a.each(function(_e8c,list){
list.each(function(_e8e){
var item=MenuItemBinding.newInstance(_e8b.bindingDocument);
item.setLabel(_e8e.getLabel());
item.setToolTip(_e8e.getToolTip());
item.setImage(_e8e.getImage());
item.setDisabled(_e8e.isDisabled());
item.associatedSystemAction=_e8e;
var _e90=_e8b;
var tag=_e8e.getTag();
if(tag!=null){
switch(tag){
case SystemAction.TAG_CHANGEFROMLANGUAGE:
_e90=top.app.bindingMap.translationsmenugroup;
break;
}
}
_e90.add(item);
...
_e8b.attachRecursive();
}
}
};
StageBinding.prototype._initializeSystemViewDefinitions=function(_e92){
while(_e92.hasNext()){
var node=_e92.getNext();
var _e94=node.getHandle();
ViewDefinitions[_e94]=new SystemViewDefinition(node);
}
};
StageBinding.prototype.handleAction=function(_e95){
StageBinding.superclass.handleAction.call(this,_e95);
...
this._decksBinding=_e96;
this._inflateBinding(_e96);
_e95.consume();
break;
...
this.handlePerspectiveChange(_e96);
_e95.consume();
break;
case TabBoxBinding.ACTION_ATTACHED:
if(_e96 instanceof DockBinding){
switch(_e96.reference){
...
this._dockBindings.set(_e96.reference,_e96);
break;
}
this.handleAttachedDock(_e96);
_e95.consume();
}
break;
case TabBoxBinding.ACTION_SELECTED:
if(_e96 instanceof DockBinding){
this.handleSelectedDockTab(_e96.getSelectedTabBinding());
_e95.consume();
}
break;
case WindowBinding.ACTION_LOADED:
...
StageBoxHandlerAbstraction.handleAction.call(this,_e95);
};
StageBinding.prototype.handleBroadcast=function(_e98,arg){
StageBinding.superclass.handleBroadcast.call(this,_e98,arg);
switch(_e98){
...
StageBinding.prototype._showStart=function(_e9c){
if(_e9c!=this._isShowingStart){
var view=ViewBinding.getInstance("Composite.Management.Start");
var dock=this._dockBindings.get(DockBinding.START);
var _e9f=this.bindingWindow.bindingMap.maindecks;
if(_e9c){
_e9f.select("startdeck");
view.show();
}else{
view.hide();
_e9f.select("stagedeck");
if(dock!=null&&dock.isActive){
dock.deActivate();
}
}
this._isShowingStart=_e9c;
}
};
StageBinding.prototype._inflateBinding=function(_ea0){
for(var _ea1 in ViewDefinitions){
var _ea2=ViewDefinitions[_ea1];
if(_ea2 instanceof SystemViewDefinition){
_ea0.mountDefinition(_ea2);
}
}
var _ea3=(this._decksBinding!=null&&this._explorerBinding!=null);
if(_ea3){
var self=this;
setTimeout(function(){
...
var _ea6=new StageCrawler();
_ea6.mode=mode;
_ea6.crawl(this.bindingElement);
_ea6.dispose();
};
StageBinding.prototype.handlePerspectiveChange=function(_ea7){
var _ea8=_ea7.getSelectionHandle();
this._decksBinding.setSelectionByHandle(_ea8);
if(LocalStore.isEnabled){
LocalStore.setProperty(LocalStore.SELECTED_PERSPECTIVE_HANDLE,escape(_ea8));
}
};
StageBinding.prototype.handleAttachedDock=function(_ea9){
var _eaa=_ea9.getTabBindings();
if(_eaa.hasEntries()){
while(_eaa.hasNext()){
var _eab=_eaa.getNext();
var _eac=_eab.getHandle();
if(_eac){
if(_eac=="Composite.Management.Start"&&(!Application.hasStartPage||!Application.hasExternalConnection)){
}else{
var _ead=ViewDefinitions[_eac];
if(_ead){
this._view(_ea9,_eab,_ead,false);
}else{
alert("StageBinding: no such predefined viewdefinition ("+_eac+")");
}
}
}
}
...
StageBinding.prototype._presentViewDefinition=function(_eae){
var _eaf=null;
var _eb0=false;
switch(_eae.position){
case Dialog.MODAL:
_eaf=app.bindingMap.masterdialogset.getModalInstance();
break;
case Dialog.NON_MODAL:
_eaf=app.bindingMap.masterdialogset.getInstance();
break;
default:
...
case DockBinding.ABSRIGHTTOP:
case DockBinding.ABSRIGHTBOTTOM:
_eaf=this._dockBindings.get(_eae.position);
break;
case DockBinding.EXTERNAL:
window.open(_eae.url);
_eb0=true;
break;
default:
var _eb1=this._decksBinding.getSelectedDeckBinding();
_eaf=_eb1.getDockBindingByReference(_eae.position);
if(this._isShowingStart){
EventBroadcaster.broadcast(BroadcastMessages.STOP_COMPOSITE);
}else{
if(this._isShowingDefaultStart){
var _eb2=this.bindingWindow.bindingMap.maindecks;
_eb2.select("stagedeck");
this._isShowingDefaultStart=false;
}
}
break;
...
if(!_eb0){
if(_eaf!=null){
this._view(_eaf,null,_eae,true);
}else{
throw "StageBinding: Could not position view: "+_eae.handle;
}
}
};
StageBinding.prototype._view=function(_eb3,_eb4,_eb5,_eb6){
var _eb7=_eb5.handle;
if(_eb5.isMutable){
_eb7+=KeyMaster.getUniqueKey();
}
if(this._activeViewDefinitions[_eb7]){
var _eb8=ViewBinding.getInstance(_eb7);
if(_eb8!=null){
_eb8.update();
}else{
...
this._activeViewDefinitions[_eb7]=_eb5;
Application.lock(this);
switch(_eb3.constructor){
case DockBinding:
if(_eb6){
_eb3.prepareNewView(_eb5);
}else{
_eb3.prepareOpenView(_eb5,_eb4);
}
break;
case StageDialogBinding:
if(_eb6){
...
StageBinding.prototype._dontView=function(_eb9){
if(this._activeViewDefinitions[_eb9]!=null){
delete this._activeViewDefinitions[_eb9];
}else{
this.logger.debug("Could not unregister active view: "+_eb9);
}
};
StageBinding.prototype.handleSelectedDockTab=function(_eba){
};
...
var self=this;
this.addFilter(function(_ebc){
var _ebd=UserInterface.getBinding(_ebc);
var _ebe=null;
if(_ebd){
switch(_ebd.constructor){
case StageSplitBoxBinding:
case StageSplitPanelBinding:
case StageSplitterBinding:
switch(self.mode){
case StageCrawler.MODE_MAXIMIZE:
_ebd.handleMaximization();
break;
case StageCrawler.MODE_UNMAXIMIZE:
_ebd.handleUnMaximization();
break;
}
break;
case DockBinding:
_ebe=NodeCrawler.SKIP_NODE;
break;
}
}
return _ebe;
...
var _ebf=null;
this._dialogs.each(function(_ec0){
if(!_ec0.isVisible){
_ebf=_ec0;
}
return _ebf!=null;
...
if(!_ebf){
this._newInstance();
_ebf=this._dialogs.getLast();
}
_ebf.setModal(false);
return _ebf;
};
StageDialogSetBinding.prototype.getModalInstance=function(){
var _ec1=this.getInstance();
_ec1.setModal(true);
return _ec1;
};
StageDialogSetBinding.prototype._newInstance=function(){
var _ec2=this.add(StageDialogBinding.newInstance(this.bindingDocument));
this._dialogs.add(_ec2);
_ec2.attach();
};
...
StageDialogBinding.prototype.prepareNewView=function(_ec3){
if(_ec3 instanceof DialogViewDefinition){
var _ec4=ViewBinding.newInstance(this.bindingDocument);
_ec4.setDefinition(_ec3);
_ec4.setType(ViewBinding.TYPE_DIALOGVIEW);
if(_ec3.handler){
if(Interfaces.isImplemented(IDialogResponseHandler,_ec3.handler)){
this._dialogResponseHandler=_ec3.handler;
}else{
throw "IDialogResponseHandler not implemented";
}
}
this._viewBinding=_ec4;
this._body.add(_ec4);
_ec4.attach();
_ec4.initialize();
}
};
StageDialogBinding.prototype.handleAction=function(_ec5){
StageDialogBinding.superclass.handleAction.call(this,_ec5);
var _ec6=_ec5.target;
switch(_ec5.type){
case PageBinding.ACTION_INITIALIZED:
this._handleInitializedPageBinding(_ec6);
_ec5.consume();
break;
case PageBinding.ACTION_DETACHED:
if(_ec6.bindingDocument==this._viewBinding.getContentDocument()){
this._pageBinding=null;
}
_ec5.consume();
break;
...
if(_ec6.response){
this._handleDialogPageResponse(_ec6);
}
_ec5.consume();
break;
case Binding.ACTION_INVALID:
...
StageDialogBinding.prototype.handleBroadcast=function(_ec7,arg){
StageDialogBinding.superclass.handleBroadcast.call(this,_ec7,arg);
switch(_ec7){
case BroadcastMessages.KEY_ESCAPE:
if(this.isVisible==true){
...
StageDialogBinding.prototype._fit=function(_ec9){
var _eca=new FitnessCrawler();
var list=new List();
if(_ec9){
_eca.mode=FitnessCrawler.MODE_BRUTAL;
}
_eca.crawl(this.bindingElement,list);
_eca.dispose();
if(list.hasEntries()){
list.reverse();
list.each(function(_ecc){
_ecc.fit(_ec9);
});
list.dispose();
this._fitMe();
...
var _ecd=this.getDimension().h;
this.reflex(true);
var self=this;
if(this.getDimension().h==_ecd){
var self=this;
setTimeout(function(){
self.reflex(true);
},0);
...
StageDialogBinding.prototype._handleContextMenuItemBinding=function(_ecf){
var cmd=_ecf.getProperty("cmd");
switch(cmd){
...
StageDialogBinding.prototype._handleInitializedPageBinding=function(_ed1){
if(_ed1.bindingDocument==this._viewBinding.getContentDocument()){
if(_ed1 instanceof DialogPageBinding){
if(this._pageBinding==null){
this._parsePageBinding(_ed1);
}
this._pageBinding=_ed1;
if(_ed1.height=="auto"){
_ed1.enableAutoHeightLayoutMode(true);
this._fixAutoHeight(_ed1);
_ed1.enableAutoHeightLayoutMode(false);
this.reflex(true);
}
}
if(StatusBar.state==StatusBar.BUSY){
...
StageDialogBinding.prototype._disableDialogAcceptButton=function(_ed2){
var _ed3=this._viewBinding.getContentDocument().getElementById("dialogacceptbutton");
if(_ed3){
var _ed4=UserInterface.getBinding(_ed3);
_ed4.setDisabled(_ed2);
}
};
StageDialogBinding.prototype._handleDialogPageResponse=function(_ed5){
if(this._dialogResponseHandler!=null){
this._dialogResponseHandler.handleDialogResponse(_ed5.response,_ed5.result!=null?_ed5.result:null);
}
this.close();
};
StageDialogBinding.prototype.handleInvokedControl=function(_ed6){
if(_ed6.controlType==ControlBinding.TYPE_CLOSE){
this._defaultClose();
}
StageDialogBinding.superclass.handleInvokedControl.call(this,_ed6);
};
...
var self=this;
this._titlebar.handleAction=function(_ed8){
switch(_ed8.type){
case MenuItemBinding.ACTION_COMMAND:
if(_ed8.listener==this.contextMenuBinding){
self._handleContextMenuItemBinding(_ed8.target);
}
break;
}
};
};
StageDialogBinding.prototype._parsePageBinding=function(_ed9){
var _eda=_ed9.label;
var _edb=_ed9.image;
var _edc=_ed9.width;
var _edd=_ed9.height;
var _ede=_ed9.controls;
var _edf=_ed9.isResizable;
if(_eda){
this.setLabel(_eda);
}
if(_edb){
...
if(this._isFirstPage){
nev.w=_edc?_edc:old.w;
}else{
nev.w=old.w;
}
nev.h=(_edd!=null&&_edd!="auto")?_edd:old.h;
...
var type,_ee3=new List(_ede.split(" "));
while((type=_ee3.getNext())!=null){
this.controlBindings[type].show();
}
}
if(_edf!=this._isResizable){
this.setResizable(_edf);
}
if(_edd=="auto"){
this._fixAutoHeight(_ed9);
}
if(_ed9==this._pageBinding){
this.centerOnScreen();
}
if(!this.isOpen){
this.reflex(true);
...
StageDialogBinding.prototype._fixAutoHeight=function(_ee4){
var dim=this.getDimension();
var _ee6=0;
var _ee7=0;
if(_ee4.isDialogSubPage){
_ee4=this._pageBinding;
}
if(this._isFirstPage){
_ee6=_ee4.width!=null?_ee4.width:dim.w;
}else{
_ee6=dim.w;
}
_ee7=_ee4.bindingElement.offsetHeight;
_ee7+=this._titlebar.bindingElement.offsetHeight;
_ee7+=4;
if(_ee7<dim.h){
_ee7=dim.h;
}
if(_ee4.minheight!=null){
if(_ee7<_ee4.minheight){
_ee7=_ee4.minheight;
}
}
this.setDimension(new Dimension(_ee6,_ee7));
};
...
StageDialogBinding.newInstance=function(_eea){
var _eeb=DOMUtil.createElementNS(Constants.NS_UI,"ui:dialog",_eea);
var _eec=UserInterface.registerBinding(_eeb,StageDialogBinding);
_eec.setProperty("controls","minimize maximize close");
return _eec;
};
FitnessCrawler.prototype=new Crawler;
FitnessCrawler.prototype.constructor=FitnessCrawler;
...
FitnessCrawler.prototype._construct=function(){
FitnessCrawler.superclass._construct.call(this);
this.addFilter(function(_eed,list){
var _eef=null;
var _ef0=UserInterface.getBinding(_eed);
if(!_ef0.isVisible){
_eef=NodeCrawler.SKIP_NODE+NodeCrawler.SKIP_CHILDREN;
}
return _eef;
});
this.addFilter(function(_ef1,list){
var _ef3=null;
var _ef4=UserInterface.getBinding(_ef1);
if(_ef4.isAttached){
if(Interfaces.isImplemented(IFit,_ef4)){
if(!_ef4.isFit||this.mode==FitnessCrawler.MODE_BRUTAL){
list.add(_ef4);
}
}
}
...
StageDecksBinding.prototype.mountDefinition=function(_ef5){
var _ef6=StageDeckBinding.newInstance(this.bindingDocument);
_ef6.handle=_ef5.handle;
_ef6.perspectiveNode=_ef5.node;
this._decks[_ef6.handle]=_ef6;
this.add(_ef6);
_ef6.attach();
};
StageDecksBinding.prototype.setSelectionByHandle=function(_ef7){
var _ef8=this._decks[_ef7];
StageBinding.perspectiveNode=_ef8.perspectiveNode;
this.select(_ef8);
};
...
StageDeckBinding.prototype.handleAction=function(_ef9){
StageDeckBinding.superclass.handleAction.call(this,_ef9);
var _efa=_ef9.target;
switch(_ef9.type){
case WindowBinding.ACTION_LOADED:
if(_efa==this.windowBinding){
...
break;
case TabBoxBinding.ACTION_ATTACHED:
if(_efa instanceof DockBinding){
this._dockBindings.set(_efa.reference,_efa);
_efa.perspectiveNode=this.perspectiveNode;
}
break;
...
StageBoxHandlerAbstraction.handleAction.call(this,_ef9);
StageDeckBinding.superclass.handleAction.call(this,_ef9);
};
StageDeckBinding.prototype.iterateContainedStageBoxBindings=function(mode){
var _efc=new StageCrawler();
_efc.mode=mode;
_efc.crawl(this.windowBinding.getContentDocument().body);
_efc.dispose();
};
...
StageDeckBinding.prototype.getDockBindingByReference=function(_efd){
return this._dockBindings.get(_efd);
};
...
StageDeckBinding.newInstance=function(_eff){
var _f00=DOMUtil.createElementNS(Constants.NS_UI,"ui:stagedeck",_eff);
var _f01=UserInterface.registerBinding(_f00,StageDeckBinding);
return _f01;
};
...
StageSplitBoxBinding.prototype.handleAction=function(_f02){
StageSplitBoxBinding.superclass.handleAction.call(this,_f02);
StageBoxAbstraction.handleAction.call(this,_f02);
var _f03=_f02.target;
var _f04=null;
var _f05=null;
switch(_f02.type){
case DockBinding.ACTION_EMPTIED:
_f05=this.getChildBindingByLocalName("splitter");
if(_f05.isVisible){
_f05.hide();
}
_f04=this.getDescendantBindingsByLocalName("dock");
if(_f04.getFirst().isEmpty&&_f04.getLast().isEmpty){
if(_f04.getFirst().type!=DockBinding.TYPE_EDITORS){
...
if(_f06.getFirst().isVisible&&_f06.getLast().isVisible){
_f05=this.getChildBindingByLocalName("splitter");
if(!_f05.isVisible){
_f05.show();
}
...
StageSplitBoxBinding.prototype.handleCrawler=function(_f07){
StageSplitBoxBinding.superclass.handleCrawler.call(this,_f07);
switch(_f07.id){
case FlexBoxCrawler.ID:
if(this.isMaximizedForReal==false){
_f07.response=NodeCrawler.SKIP_CHILDREN;
}
break;
}
};
StageSplitBoxBinding.prototype.hasBothPanelsVisible=function(){
var _f08=this.getChildBindingsByLocalName("splitpanel");
return _f08.getFirst().isVisible&&_f08.getLast().isVisible;
};
StageSplitBoxBinding.prototype.hasBothPanelsFixed=function(){
var _f09=this.getChildBindingsByLocalName("splitpanel");
return _f09.getFirst().isFixed&&_f09.getLast().isFixed;
};
...
StageSplitPanelBinding.prototype.handleAction=function(_f0a){
StageSplitPanelBinding.superclass.handleAction.call(this,_f0a);
StageBoxAbstraction.handleAction.call(this,_f0a);
switch(_f0a.type){
case DockBinding.ACTION_EMPTIED:
case StageSplitBoxBinding.ACTION_HIDE:
...
if(_f0a.type==StageSplitBoxBinding.ACTION_HIDE){
_f0a.consume();
}
}else{
this.hide();
...
if(_f0a.type==DockBinding.ACTION_EMPTIED){
var self=this;
setTimeout(function(){
...
if(_f0a.type==StageSplitBoxBinding.ACTION_SHOW){
_f0a.consume();
}
}else{
this.show();
...
break;
case StageSplitPanelBinding.ACTION_LAYOUTUPDATE:
var _f0d=_f0a.target;
if(_f0d!=this&&_f0d.getContainedDock()){
if(this._containingSplitBoxBinding.getOrient()==SplitBoxBinding.ORIENT_VERTICAL){
var _f0e=_f0d._containingSplitBoxBinding;
if(_f0e.getOrient()==SplitBoxBinding.ORIENT_HORIZONTAL){
var _f0f=_f0e.getChildBindingsByLocalName("splitpanel");
var _f10=_f0f.getFirst();
var _f11=_f0f.getLast();
if(this.isFixed==true){
if(!_f10.isFixed||!_f11.isFixed||(!_f0e.hasBothPanelsVisible()&&_f0d.isMinimizedForReal)){
this.setFix(false);
_f0a.consume();
this.dispatchAction(StageSplitPanelBinding.ACTION_LAYOUTUPDATE);
}
}else{
if(_f0e.hasBothPanelsFixed()||(!_f0e.hasBothPanelsVisible()&&_f0d.isMinimizedForReal)){
this.setFix(_f0d.getContainedDock().getHeight());
_f0a.consume();
this.dispatchAction(StageSplitPanelBinding.ACTION_LAYOUTUPDATE);
}
}
...
StageBoxAbstraction.handleMaximization.call(this);
var _f12=this.getContainedDock();
if(_f12){
if(this.isMaximizePrepared==true){
}else{
_f12.interceptDisplayChange(false);
}
}
};
...
if(_f13){
if(_f13.type==DockBinding.TYPE_EDITORS){
if(_f13.isEmpty){
this._invisibilize(true);
}
}
...
_f13.interceptDisplayChange(true);
}
}
};
...
if(_f14){
_f14.activate();
EventBroadcaster.broadcast(BroadcastMessages.DOCK_MAXIMIZED,_f14);
}
};
...
_f16.collapse(_f15);
if(!_f15){
this.setFix(_f16.getHeight());
}else{
this.setFix(_f16.getWidth());
}
}
if(this.isMaximized==true){
this.normalize(true);
...
this.dispatchAction(StageSplitPanelBinding.ACTION_LAYOUTUPDATE);
if(_f16&&_f16.isActive){
_f16.deActivate();
EventBroadcaster.broadcast(BroadcastMessages.DOCK_MINIMIZED,_f16);
}
};
StageSplitPanelBinding.prototype.normalize=function(_f17){
var _f18=this._containingSplitBoxBinding.getOrient()==SplitBoxBinding.ORIENT_HORIZONTAL;
var _f19=this.getContainedDock();
if(_f19){
if(this.isMinimized==true){
_f19.unCollapse(_f18);
this.setFix(false);
}
}
...
if(_f19){
_f19.activate();
EventBroadcaster.broadcast(BroadcastMessages.DOCK_NORMALIZED,_f19);
}
}
};
...
StageSplitPanelBinding.prototype.invisibilize=function(_f1a){
var _f1b=true;
var dock=this.getContainedDock();
...
if(_f1b==true){
this._invisibilize(_f1a);
}
};
StageSplitPanelBinding.prototype._invisibilize=function(_f1d){
if(_f1d!=this._isInvisibilized){
if(_f1d){
this.bindingElement.style.visibility="hidden";
}else{
this.bindingElement.style.visibility="visible";
...
StageSplitterBinding.prototype.onDragStart=function(_f1e){
var _f1f=top.app.bindingMap.stagesplittercover;
var _f20=this._containingSplitBoxBinding.getOrient();
switch(_f20){
case SplitBoxBinding.ORIENT_HORIZONTAL:
_f1f.bindingElement.style.cursor="e-resize";
break;
case SplitBoxBinding.ORIENT_VERTICAL:
_f1f.bindingElement.style.cursor="n-resize";
break;
}
_f1f.show();
...
StageSplitterBodyBinding.prototype.setOrient=function(_f26){
this._orient=_f26;
this.attachClassName(_f26);
};
...
StageBoxAbstraction.handleAction=function(_f2b){
switch(_f2b.type){
...
break;
case TabBoxBinding.ACTION_UPDATED:
if(_f2b.target instanceof DockBinding){
...
this.isFlexible=false;
if(Client.isMozilla==true){
var _f2c=this.bindingElement.style;
_f2c.position="absolute";
_f2c.width="100%";
_f2c.height="100%";
_f2c.top="0";
_f2c.left="0";
...
StageBoxAbstraction._emulateBasicCSS=function(_f2e,_f2f){
var _f30=_f2e.bindingElement.style;
var _f31=_f2e.bindingElement.parentNode;
var box=_f2e._containingSplitBoxBinding;
if(Client.isExplorer==true){
if(_f2f){
_f2e._unmodifiedFlexMethod=_f2e.flex;
_f2e.flex=function(){
_f30.width=_f31.offsetWidth+"px";
_f30.height=_f31.offsetHeight+"px";
};
}else{
_f30.width="100%";
_f30.height="100%";
...
_f2e.flex=_f2e._unmodifiedFlexMethod;
_f2e._unmodifiedFlexMethod=null;
}
}
};
...
StageBoxHandlerAbstraction.handleAction=function(_f33){
var _f34=_f33.target;
switch(_f33.type){
case ControlBoxBinding.ACTION_MAXIMIZE:
case ControlBoxBinding.ACTION_NORMALIZE:
if(_f34 instanceof StageSplitPanelBinding){
StageBoxHandlerAbstraction.handleControlBoxAction.call(this,_f33);
_f33.consume();
}
break;
...
StageBoxHandlerAbstraction.handleControlBoxAction=function(_f35){
var mode=null;
switch(_f35.type){
case ControlBoxBinding.ACTION_MAXIMIZE:
if(!this.isSubPanelMaximized){
...
StageMenuBarBinding.prototype.handleAction=function(_f37){
StageMenuBarBinding.superclass.handleAction.call(this,_f37);
switch(_f37.type){
case MenuItemBinding.ACTION_COMMAND:
var _f38=_f37.target.associatedSystemAction;
if(Application.isLoggedIn){
if(!this._rootNode){
this._rootNode=System.getRootNode();
}
if(_f38){
SystemAction.invoke(_f38,this._rootNode);
}
}
_f37.consume();
break;
...
var _f39=this.getProperty("handle");
if(_f39){
this._handle=_f39;
if(StageBinding.isViewOpen(_f39)){
if(this.type==MenuItemBinding.TYPE_CHECKBOX){
this.check(true);
}
}
...
Application.lock(self);
setTimeout(function(){
StageBinding.handleViewPresentation(_f39);
Application.unlock(self);
...
StageViewMenuItemBinding.prototype.setHandle=function(_f3b){
this.setProperty("handle",_f3b);
};
StageViewMenuItemBinding.prototype.handleBroadcast=function(_f3c,arg){
StageViewMenuItemBinding.superclass.handleBroadcast.call(this,_f3c,arg);
if(this.type==MenuItemBinding.TYPE_CHECKBOX){
switch(_f3c){
...
StageViewMenuItemBinding.newInstance=function(_f3e){
var _f3f=DOMUtil.createElementNS(Constants.NS_UI,"ui:menuitem",_f3e);
UserInterface.registerBinding(_f3f,StageViewMenuItemBinding);
return UserInterface.getBinding(_f3f);
};
...
StageStatusBarBinding.prototype.setLabel=function(_f40){
this._label.setLabel(_f40);
};
StageStatusBarBinding.prototype.setImage=function(_f41){
this._label.setImage(_f41);
};
StageStatusBarBinding.prototype.clear=function(){
this._label.setLabel(null);
this._label.setImage(false);
};
StageStatusBarBinding.prototype.startFadeOut=function(_f42){
...
var _f43=ExplorerBinding.bindingInstance.getSelectedDeckBinding();
var _f44=_f43.getAssociatedView();
var _f45=_f44.getContentWindow().bindingMap.tree;
var _f46=_f45.getFocusedTreeNodeBindings();
if(!_f46.hasEntries()&&StageBinding.treeSelector){
_f46=StageBinding.treeSelector.getFocusedTreeNodeBindings();
}
return _f46;
};
...
ExplorerBinding.prototype.handleAction=function(_f47){
ExplorerBinding.superclass.handleAction.call(this,_f47);
...
break;
case Binding.ACTION_DRAG:
if(_f48 instanceof ExplorerSplitterBinding){
_f48.dragger.registerHandler(this);
}
_f47.consume();
}
};
ExplorerBinding.prototype.setSelectionByHandle=function(_f4a){
this._menuBinding.setSelectionByHandle(_f4a);
};
...
ExplorerBinding.prototype.mountDefinition=function(_f4b){
if(_f4b instanceof SystemViewDefinition){
this._decksBinding.mountDefinition(_f4b);
this._menuBinding.mountDefinition(_f4b);
}
};
ExplorerBinding.prototype.onDragStart=function(_f4c){
var _f4d=this._menuBinding.getDescendantBindingsByLocalName("explorertoolbarbutton");
if(_f4d.hasEntries()){
var _f4e=_f4d.getFirst();
this._dragStart=_f4e.boxObject.getLocalPosition().y;
this._dragSlot=0;
if(this._dragHeight==0){
this._dragHeight=_f4e.boxObject.getDimension().h;
}
...
ExplorerDecksBinding.prototype.mountDefinition=function(_f52){
if(_f52 instanceof SystemViewDefinition){
var _f53=ViewBinding.newInstance(this.bindingDocument);
_f53.setType(ViewBinding.TYPE_EXPLORERVIEW);
_f53.setDefinition(_f52);
var _f54=ExplorerDeckBinding.newInstance(this.bindingDocument);
_f54.setAssociatedView(_f53);
this._decks[_f52.handle]=_f54;
_f54.add(_f53);
this.add(_f54);
function attach(){
_f54.attach();
...
ExplorerDecksBinding.prototype.setSelectionByHandle=function(_f55){
var _f56=this._decks[_f55];
this.select(_f56);
};
DecksBinding.prototype.expandBy=function(_f57){
var deck=this.getSelectedDeckBinding();
if(deck){
var _f59=this.bindingElement.offsetHeight+_f57;
var view=deck.getAssociatedView();
this.bindingElement.style.height=_f59+"px";
this.reflex(true);
}
};
ExplorerDecksBinding.newInstance=function(_f5b){
var _f5c=DOMUtil.createElementNS(Constants.NS_UI,"ui:explorerdecks",_f5b);
return UserInterface.registerBinding(_f5c,ExplorerDecksBinding);
};
...
ExplorerDeckBinding.prototype.setAssociatedView=function(_f5d){
this._viewBinding=_f5d;
};
...
Application.lock(this);
var _f5e=StringBundle.getString("ui","Website.App.StatusBar.Loading");
var _f5f=this._viewBinding.getDefinition().label;
StatusBar.busy(_f5e,[_f5f]);
...
ExplorerDeckBinding.prototype.handleAction=function(_f60){
ExplorerDeckBinding.superclass.handleAction.call(this,_f60);
var _f61=_f60.target;
switch(_f60.type){
case PageBinding.ACTION_INITIALIZED:
if(_f61 instanceof SystemPageBinding){
this._isExplorerDeckBindingInitialized=true;
this._entityToken=_f61.node.getEntityToken();
...
ExplorerDeckBinding.prototype.handleBroadcast=function(_f62,arg){
ExplorerDeckBinding.superclass.handleBroadcast.call(this,_f62,arg);
switch(_f62){
...
var _f64=null;
if(this._isExplorerDeckBindingInitialized){
_f64=this._viewBinding.getDefinition().label;
}else{
_f64=DockTabBinding.LABEL_TABLOADING;
}
return _f64;
};
...
var _f65=null;
if(this._isExplorerDeckBindingInitialized){
_f65=this._viewBinding.getDefinition().image;
}else{
_f65=DockTabBinding.IMG_TABLOADING;
}
return _f65;
};
...
var _f66=null;
if(this._isExplorerDeckBindingInitialized){
_f66=this._viewBinding.getDefinition().toolTip;
}
return _f66;
};
ExplorerDeckBinding.newInstance=function(_f67){
var _f68=DOMUtil.createElementNS(Constants.NS_UI,"ui:explorerdeck",_f67);
return UserInterface.registerBinding(_f68,ExplorerDeckBinding);
};
...
ExplorerMenuBinding.prototype.onMemberInitialize=function(_f69){
switch(_f69.constructor){
case ExplorerToolBarBinding:
this._maxGroup=_f69.getToolBarGroupByIndex(0);
break;
case ToolBarBinding:
this._minGroup=_f69.getToolBarGroupByIndex(0);
break;
}
ExplorerMenuBinding.superclass.onMemberInitialize.call(this,_f69);
};
ExplorerMenuBinding.prototype.mountDefinition=function(_f6a){
this._maxButtons.set(_f6a.handle,this._mountMaxButton(_f6a));
this._minButtons.set(_f6a.handle,this._mountMinButton(_f6a));
this._index++;
};
ExplorerMenuBinding.prototype._mountMaxButton=function(_f6b){
var _f6c=ExplorerToolBarButtonBinding.newInstance(this.bindingDocument,ExplorerToolBarButtonBinding.TYPE_LARGE);
_f6c.setLabel(_f6b.label);
_f6c.setToolTip(_f6b.toolTip);
_f6c.handle=_f6b.handle;
_f6c.node=_f6b.node;
this._maxGroup.add(_f6c);
this._maxList.add(_f6c);
_f6c.attach();
return _f6c;
};
ExplorerMenuBinding.prototype._mountMinButton=function(_f6d){
var _f6e=ExplorerToolBarButtonBinding.newInstance(this.bindingDocument,ExplorerToolBarButtonBinding.TYPE_NORMAL);
_f6e.setLabel(_f6d.label);
_f6e.setToolTip(_f6d.label);
_f6e.handle=_f6d.handle;
_f6e.node=_f6d.node;
this._minGroup.addFirst(_f6e);
this._minList.add(_f6e);
_f6e.attach();
_f6e.hide();
return _f6e;
};
ExplorerMenuBinding.prototype.handleAction=function(_f6f){
ExplorerMenuBinding.superclass.handleAction.call(this,_f6f);
switch(_f6f.type){
case RadioGroupBinding.ACTION_SELECTIONCHANGED:
var _f70=_f6f.target;
var _f71=_f70.getCheckedButtonBinding();
var _f72=_f71.handle;
switch(_f70){
case this._maxGroup:
this._minGroup.setCheckedButtonBinding(this._minButtons.get(_f72),true);
break;
case this._minGroup:
this._maxGroup.setCheckedButtonBinding(this._maxButtons.get(_f72),true);
break;
}
this._selectedHandle=_f72;
this._selectedTag=_f71.node.getTag();
this.dispatchAction(ExplorerMenuBinding.ACTION_SELECTIONCHANGED);
_f6f.consume();
break;
}
};
ExplorerMenuBinding.prototype.setSelectionByHandle=function(_f73){
var _f74=this._maxButtons.get(_f73);
if(_f74){
_f74.check();
}else{
...
ExplorerToolBarBinding.newInstance=function(_f78){
var _f79=DOMUtil.createElementNS(Constants.NS_UI,"ui:explorertoolbar",_f78);
return UserInterface.registerBinding(_f79,ExplorerToolBarBinding);
};
...
var _f7a=this.explorerToolBarButtonType==ExplorerToolBarButtonBinding.TYPE_LARGE;
var _f7b=_f7a?ToolBarBinding.IMAGESIZE_LARGE:ToolBarBinding.IMAGESIZE_NORMAL;
this.imageProfile=this.node.getImageProfile(_f7b);
ExplorerToolBarButtonBinding.superclass.onBindingAttach.call(this);
};
ExplorerToolBarButtonBinding.newInstance=function(_f7c,_f7d){
var _f7e=(_f7d==ExplorerToolBarButtonBinding.TYPE_LARGE?"ui:explorertoolbarbutton":"ui:toolbarbutton");
var _f7f=DOMUtil.createElementNS(Constants.NS_UI,_f7e,_f7c);
var _f80=UserInterface.registerBinding(_f7f,ExplorerToolBarButtonBinding);
_f80.explorerToolBarButtonType=_f7d;
return _f80;
};
...
EditorBinding.registerComponent=function(_f81,_f82){
var _f83=EditorBinding._components;
var _f84=EditorBinding._editors;
var key=_f82.key;
var _f86=Interfaces.isImplemented(IWysiwygEditorComponent,_f81);
if(!_f86){
_f86=Interfaces.isImplemented(ISourceEditorComponent,_f81);
}
if(_f86){
if(_f84.has(key)){
_f84.get(key).initializeEditorComponent(_f81);
}else{
if(!_f83.has(key)){
_f83.set(key,new List());
}
_f83.get(key).add(_f81);
}
}else{
throw "Editor component interface not implemented: "+_f81;
}
};
EditorBinding.claimComponents=function(_f87,_f88){
var _f89=EditorBinding._components;
var _f8a=EditorBinding._editors;
var key=_f88.key;
_f8a.set(key,_f87);
var list=null;
if(_f89.has(key)){
list=_f89.get(key).copy();
_f89.del(key);
}
return list;
};
...
var _f8e=this.getProperty("value");
if(_f8e!=null){
_f8e=decodeURIComponent(_f8e);
this._startContent=_f8e;
}
};
...
EditorBinding.prototype.initializeEditorComponents=function(_f92){
var _f93=EditorBinding.claimComponents(this,_f92);
if(_f93!=null){
while(_f93.hasNext()){
this.initializeEditorComponent(_f93.getNext());
}
}
};
EditorBinding.prototype._registerWithDataManager=function(name){
if(name&&name!=""){
var _f95=this.bindingWindow.DataManager;
if(_f95.getDataBinding(name)){
_f95.unRegisterDataBinding(name);
}
_f95.registerDataBinding(name,this);
}
};
EditorBinding.prototype.addEditorEvents=function(){
var _f96=this.getEditorDocument();
if(_f96!=null){
Application.framework(_f96);
DOMEvents.addEventListener(_f96,DOMEvents.CONTEXTMENU,this);
DOMEvents.addEventListener(_f96,DOMEvents.KEYPRESS,this);
DOMEvents.addEventListener(_f96,DOMEvents.MOUSEDOWN,this);
DOMEvents.addEventListener(_f96,DOMEvents.MOUSEMOVE,this);
}
...
EditorBinding.prototype.checkForDirty=function(_f98){
...
var _f9a=this.getCheckSum();
if(_f9a!=this._checksum){
this.bindingWindow.DataManager.dirty(this);
this._checksum=_f9a;
}
};
...
_f9b=this._pageBinding.getCheckSum(this._checksum);
}
return _f9b;
};
...
break;
case DOMEvents.MOUSEDOWN:
if(_f9d.ownerDocument==this.getEditorDocument()){
if(!this._isActivated||this.isFocusable&&!this.isFocused){
this._activateEditor(true);
}
}
...
EditorBinding.prototype.handleBroadcast=function(_f9f,arg){
EditorBinding.superclass.handleBroadcast.call(this,_f9f,arg);
var _fa1=null;
switch(_f9f){
...
_fa1=DOMEvents.getTarget(arg);
if(_fa1&&_fa1.ownerDocument==this.getEditorDocument()){
_fa2=false;
}
}
if(_fa2){
...
EditorBinding.prototype._activateEditor=function(_fa3){
if(_fa3!=this._isActivated){
this._isActivated=_fa3;
EditorBinding.isActive=_fa3;
var _fa4=this.getEditorWindow().standardEventHandler;
var _fa5=this.getContentWindow().bindingMap.broadcasterIsActive;
if(_fa5!=null){
if(_fa3){
if(this.hasBookmark()){
this.deleteBookmark();
...
this.focus();
_fa4.enableNativeKeys(true);
}else{
_fa5.disable();
_fa4.disableNativeKeys();
this.blur();
}
}else{
...
try{
if(!Client.isExplorer){
var _fa8=this.getEditorWindow().getSelection();
if(_fa8!=null){
_fa7=_fa8.toString().length>0;
if(!_fa7){
var _fa9=_fa8.getRangeAt(0);
var frag=_fa9.cloneContents();
var _fab=this.getEditorDocument().createElement("element");
while(frag.hasChildNodes()){
_fab.appendChild(frag.firstChild);
}
var img=_fab.getElementsByTagName("img").item(0);
if(img!=null){
...
var _fa9=this.getEditorDocument().selection.createRange();
_fa7=(_fa9&&_fa9.text)&&_fa9.text.length>0;
if(_fa9.commonParentElement&&VisualEditorBinding.isImageElement(_fa9.commonParentElement())){
_fa7=true;
}
}
}
...
EditorBinding.prototype.isCommandEnabled=function(_fad){
var _fae=true;
switch(_fad){
case "Cut":
case "Copy":
case "Paste":
_fae=this.getEditorDocument().queryCommandEnabled(_fad);
break;
}
return _fae;
};
...
_fb3=this.hasSelection();
}
try{
this.getEditorDocument().execCommand(cmd,gui,_fb3);
}
...
var _fb5=this.getContentWindow().bindingMap.toolbar;
var _fb6=_fb5.getButtonForCommand(cmd);
if(!_fb6){
...
var _fb9=this.getContentDocument().getElementById("focusableinput");
if(_fb9!=null){
_fb9.style.display="block";
FocusBinding.focusElement(_fb9);
_fb9.style.display="none";
}else{
throw "Required element not found: focusableinput";
}
};
EditorBinding.prototype.handleAction=function(_fba){
EditorBinding.superclass.handleAction.call(this,_fba);
var _fbb=_fba.target;
var self=this;
var _fbd=this.shadowTree.iframe;
switch(_fba.type){
case Binding.ACTION_DIRTY:
if(_fba.target!=this){
this.checkForDirty();
...
EditorBinding.prototype._onPageInitialize=function(_fbe){
if(this._pageBinding==null){
this.reflex();
...
EditorBinding.superclass._onPageInitialize.call(this,_fbe);
};
EditorBinding.prototype.handleElement=function(_fbf){
return true;
};
EditorBinding.prototype.updateElement=function(_fc0){
return true;
};
...
this._menuGroups[rel].each(function(_fc3){
_fc3.show();
});
};
EditorPopupBinding.prototype._hideMenuGroups=function(rel){
this._menuGroups[rel].each(function(_fc5){
_fc5.hide();
});
};
EditorPopupBinding.prototype.handleAction=function(_fc6){
EditorPopupBinding.superclass.handleAction.call(this,_fc6);
var _fc7=_fc6.target;
if(_fc6.type==MenuItemBinding.ACTION_COMMAND){
this.hide();
var cmd=_fc7.getProperty("cmd");
var gui=_fc7.getProperty("gui");
var val=_fc7.getProperty("val");
...
var _fcb=this.bindingWindow.bindingMap.tinywindow;
var _fcc=this.bindingWindow.bindingMap.codepresswindow;
if(_fcb){
EditorBinding.registerComponent(this,_fcb);
}else{
if(_fcc){
...
EditorClickButtonBinding.prototype.initializeComponent=function(_fcd,_fce,_fcf,_fd0){
this._editorBinding=_fcd;
this._tinyEngine=_fce;
this._tinyInstance=_fcf;
this._tinyTheme=_fd0;
this._setupEditorBookmarking();
};
EditorClickButtonBinding.prototype.initializeSourceEditorComponent=function(_fd1,_fd2,_fd3){
this._editorBinding=_fd1;
this._codePressFrame=_fd2;
this._codePressEngine=_fd3;
};
...
var _fd5=this._editorBinding;
if(_fd5!=null){
var self=this;
var _fd7={handleEvent:function(e){
switch(e.type){
case DOMEvents.MOUSEDOWN:
if(!_fd5.hasBookmark()){
_fd5.createBookmark();
...
DOMEvents.addEventListener(this.bindingElement,DOMEvents.MOUSEDOWN,_fd7);
DOMEvents.addEventListener(this.bindingElement,DOMEvents.MOUSEUP,_fd7);
}
};
EditorClickButtonBinding.newInstance=function(_fd9){
var _fda=DOMUtil.createElementNS(Constants.NS_UI,"ui:clickbutton",_fd9);
return UserInterface.registerBinding(_fda,EditorClickButtonBinding);
};
...
EditorToolBarButtonBinding.newInstance=function(_fdb){
var _fdc=DOMUtil.createElementNS(Constants.NS_UI,"ui:toolbarbutton",_fdb);
return UserInterface.registerBinding(_fdc,EditorToolBarButtonBinding);
};
...
var _fdd=this.bindingWindow.bindingMap.tinywindow;
EditorBinding.registerComponent(this,_fdd);
...
EditorSelectorBinding.prototype.initializeComponent=function(_fde,_fdf,_fe0,_fe1){
this._editorBinding=_fde;
this._tinyEngine=_fdf;
this._tinyInstance=_fe0;
this._tinyTheme=_fe1;
};
EditorSelectorBinding.prototype.handleAction=function(_fe2){
EditorSelectorBinding.superclass.handleAction.call(this,_fe2);
switch(_fe2.type){
case MenuItemBinding.ACTION_COMMAND:
...
EditorMenuItemBinding.newInstance=function(_fe5){
var _fe6=DOMUtil.createElementNS(Constants.NS_UI,"ui:menuitem",_fe5);
return UserInterface.registerBinding(_fe6,EditorMenuItemBinding);
};
...
VisualEditorBinding.getTinyLessClassName=function(_fe7){
var i=0,_fe9,_fea="",_feb=_fe7.split(" ");
while((_fe9=_feb[i])!=null){
if(_fe9.length>=3&&_fe9.substring(0,3)=="mce"){
_fe9="";
}else{
if(_fe9.length>=14&&_fe9.substring(0,14)=="compositemedia"){
_fe9="";
}
}
_fea+=_fe9;
...
VisualEditorBinding.getStructuredContent=function(_fec){
var _fed=null;
WebServiceProxy.isFaultHandler=false;
var soap=XhtmlTransformationsService.TinyContentToStructuredContent(_fec);
if(soap instanceof SOAPFault){
}else{
_fed=soap.XhtmlFragment;
if(!_fed){
_fed="";
}
}
...
VisualEditorBinding.getTinyContent=function(_fef,_ff0){
var _ff1=null;
if(_fef==null||_fef==""){
_fef=VisualEditorBinding.DEFAULT_CONTENT;
}
WebServiceProxy.isFaultHandler=false;
var soap=XhtmlTransformationsService.StructuredContentToTinyContent(_fef);
if(soap instanceof SOAPFault){
var _ff3=soap;
var _ff4={handleDialogResponse:function(){
_ff0.dispatchAction(Binding.ACTION_VALID);
}};
Dialog.invokeModal(VisualEditorBinding.URL_DIALOG_CONTENTERROR,_ff4,_ff3);
}else{
_ff1=soap.XhtmlFragment;
if(_ff1==null){
_ff1=new String("");
}
}
...
VisualEditorBinding.extractByIndex=function(html,_ff6){
var _ff7=null;
var doc=XMLParser.parse(html);
if(doc!=null){
var _ff9=new List(doc.documentElement.childNodes);
var _ffa=new List();
_ff9.each(function(_ffb){
if(_ffb.nodeType==Node.ELEMENT_NODE){
_ffa.add(_ffb);
}
});
var _ffc=_ffa.get(_ff6);
if(_ffc==null){
if(Application.isDeveloperMode){
alert("VisualEditorBinding: Bad HTML!"+"\n\n"+html);
}
}else{
if(_ffc.hasChildNodes()){
var frag=doc.createDocumentFragment();
while(_ffc.hasChildNodes()){
frag.appendChild(_ffc.firstChild);
}
doc.removeChild(doc.documentElement);
doc.appendChild(DOMUtil.createElementNS(Constants.NS_XHTML,"ROOT",doc));
doc.documentElement.appendChild(frag);
_ff7=DOMSerializer.serialize(doc.documentElement);
_ff7=_ff7.substring(_ff7.indexOf(">")+1,_ff7.length);
_ff7=_ff7.substring(0,_ff7.lastIndexOf("<"));
}
}
}
if(_ff7==null){
...
VisualEditorBinding.isImage=function(_ffe){
result=_ffe&&_ffe.nodeName=="IMG";
return result;
};
VisualEditorBinding.isImageElement=function(_fff){
return VisualEditorBinding.isImage(_fff)&&!VisualEditorBinding.isReservedElement(_fff);
};
VisualEditorBinding.isReservedElement=function(_1000){
if(VisualEditorBinding.isFunctionElement(_1000)){
return true;
}
if(VisualEditorBinding.isFieldElement(_1000)){
return true;
}
if(VisualEditorBinding.isHtmlElement(_1000)){
return true;
}
return false;
};
VisualEditorBinding.isFunctionElement=function(_1001){
return VisualEditorBinding.isImage(_1001)&&CSSUtil.hasClassName(_1001,VisualEditorBinding.FUNCTION_CLASSNAME);
};
VisualEditorBinding.isFieldElement=function(_1002){
return VisualEditorBinding.isImage(_1002)&&CSSUtil.hasClassName(_1002,VisualEditorBinding.FIELD_CLASSNAME);
};
VisualEditorBinding.isHtmlElement=function(_1003){
return VisualEditorBinding.isImage(_1003)&&CSSUtil.hasClassName(_1003,VisualEditorBinding.HTML_CLASSNAME);
};
...
var _1004=this.getProperty("embedablefieldstypenames");
if(_1004!=null){
this.embedableFieldConfiguration=VisualEditorFieldGroupConfiguration.getConfiguration(_1004);
}
var _1005=this.getProperty("formattingconfiguration");
if(_1005!=null){
this._url+="?config="+_1005;
}
...
VisualEditorBinding.prototype.handleBroadcast=function(_1006,arg){
VisualEditorBinding.superclass.handleBroadcast.call(this,_1006,arg);
var _1008=this.getContentWindow().bindingMap.tinywindow;
var _1009=_1008.getContentWindow();
switch(_1006){
case BroadcastMessages.VISUALEDITOR_HACKED:
if(arg.broadcastWindow==_1009){
...
this.initializeEditorComponents(_1008);
this._initialize();
...
VisualEditorBinding.prototype.initializeEditorComponent=function(_100a){
_100a.initializeComponent(this,this._tinyEngine,this._tinyInstance,this._tinyTheme);
};
VisualEditorBinding.prototype._finalize=function(){
VisualEditorBinding.superclass._finalize.call(this);
this._maybeShowEditor();
};
VisualEditorBinding.prototype._onPageInitialize=function(_100b){
VisualEditorBinding.superclass._onPageInitialize.call(this,_100b);
this._maybeShowEditor();
};
...
VisualEditorBinding.prototype.normalizeToDocument=function(_100e){
var _100f=_100e;
if(!this._isNormalizedDocument(_100e)){
_100f=VisualEditorBinding.XHTML.replace("${head}",this._getHeadSection()).replace("${body}",_100e);
}
return _100f;
};
VisualEditorBinding.prototype._isNormalizedDocument=function(_1010){
var _1011=false;
var doc=XMLParser.parse(_1010,true);
if(doc!=null){
...
var _1016=VisualEditorBinding.superclass.handleCommand.call(this,cmd,gui,val);
if(!_1016){
try{
...
var _1018=DOMEvents.getTarget(e);
this._popupBinding.configure(this._tinyInstance,this._tinyEngine,_1018);
...
VisualEditorBinding.prototype.setResult=function(_101a){
};
...
VisualEditorPopupBinding.prototype.configure=function(_101b,_101c,_101d){
var _101e=this.editorBinding.hasSelection();
this.tinyInstance=_101b;
this.tinyEngine=_101c;
this.tinyElement=_101d;
this.hasSelection=_101e;
...
var _1023=this.getMenuItemForCommand("compositeInsertLink");
var _1024=this.getMenuItemForCommand("unlink");
var _1025=this.editorBinding.getButtonForCommand("compositeInsertLink");
var _1026=this.editorBinding.getButtonForCommand("unlink");
_1024.setDisabled(_1026.isDisabled);
if(_1024.isDisabled){
_1023.setLabel("${string:Composite.Web.VisualEditor:ContextMenu.LabelLink}");
}else{
_1023.setLabel("${string:Composite.Web.VisualEditor:ContextMenu.LabelLinkProperties}");
}
};
VisualEditorPopupBinding.prototype._configureInsertGroup=function(){
var _1027=this.editorBinding.embedableFieldConfiguration;
...
_102a.each(function(_102e){
var _102f=_1027.getFieldNames(_102e);
_102f.each(function(_1030){
var i=group.add(MenuItemBinding.newInstance(doc));
i.setLabel(_1030);
i.setImage("${icon:field}");
i.setProperty("cmd","compositeInsertField");
i.setProperty("val",_102e+":"+_1030);
group.add(i);
});
});
item.add(popup);
...
var _1032=this.tinyInstance.dom.getParent(this.tinyElement,"table,td");
var _1033=null;
var _1034=null;
if(_1032){
if(_1032.nodeName=="TD"){
_1033=_1032.getAttribute("colspan");
_1034=_1032.getAttribute("rowspan");
}
this._menuItems["mceTableSplitCells"].setDisabled(_1033=="1"&&_1034=="1");
...
VisualEditorFormattingConfiguration.getConfiguration=function(_1035){
var _1036=VisualEditorFormattingConfiguration._configurations;
if(!_1036.has(_1035)){
_1036.set(_1035,new VisualEditorFormattingConfiguration());
}
return _1036.get(_1035);
};
...
function VisualEditorFormattingConfiguration(_1038){
...
VisualEditorFieldGroupConfiguration.getConfiguration=function(_1039){
var _103a=null;
var _103b=VisualEditorFieldGroupConfiguration._configurations;
if(!_103b.has(_1039)){
_103b.set(_1039,new VisualEditorFieldGroupConfiguration(EditorConfigurationService.GetEmbedableFieldGroupConfigurations(_1039)));
}
return _103b.get(_1039);
};
function VisualEditorFieldGroupConfiguration(_103c){
var _103d=new Map();
new List(_103c).each(function(group){
var map=new Map();
...
VisualEditorFieldGroupConfiguration.prototype.getFieldNames=function(_1041){
return this._groups.get(_1041).toList(true);
};
VisualEditorFieldGroupConfiguration.prototype.getTinyMarkup=function(_1042,_1043){
return this._groups.get(_1042).get(_1043).xhtml;
};
...
this._heads=new Map();
var _1045=this.getDescendantElementsByLocalName("textarea");
while(_1045.hasNext()){
var _1046=_1045.getNext();
if(_1046.getAttribute("selected")=="true"){
this._startContent=_1046.value;
this._textareaname=_1046.getAttribute("placeholderid");
}
}
if(this._startContent==null){
this._startContent=VisualEditorBinding.DEFAULT_CONTENT;
...
var _1048=this.getContentWindow().bindingMap.templatetree;
_1048.addActionListener(TreeBinding.ACTION_SELECTIONCHANGED,{handleAction:function(_1049){
var _104a=_1048.getSelectedTreeNodeBindings().getFirst();
self._placeHolderSelected(_104a.textareaname);
_1049.consume();
}});
_1048.addActionListener(Binding.ACTION_FOCUSED,{handleAction:function(_104b){
self._activateEditor(false);
}});
this._updatePlaceHolders();
var _104c=this.getContentWindow().bindingMap.toolsplitter;
_104c.unCollapse();
...
var _104d=this.getDescendantElementsByLocalName("textarea");
templatetree.empty();
if(_104d.hasEntries()){
this._hasPlaceHolders=true;
this._parsePlaceHolders(_104d);
if(this._isFinalized){
this._pageBinding.showEditor(true);
}
}else{
...
VisualMultiEditorBinding.prototype._parsePlaceHolders=function(_104e){
this._textareas=new Map();
while(_104e.hasNext()){
var _104f=_104e.getNext();
var _1050=_104f.getAttribute("placeholderid");
this._textareas.set(_1050,{placeholderid:_1050,placeholdername:_104f.getAttribute("placeholdername"),placeholdermarkup:_104f.value,textareaelement:_104f,isSelected:_104f.getAttribute("selected")=="true"});
}
var _1051=new Map();
this._textareas.each(function(name,_1053){
var _1054=templatetree.add(TreeNodeBinding.newInstance(templatetree.bindingDocument));
_1054.setLabel(_1053.placeholdername);
_1054.setImage("${icon:placeholder}");
_1054.setProperty("placeholder",true);
_1054.textareaname=name;
_1051.set(_1053.placeholdername,_1054);
if(_1053.isSelected){
selected=_1054;
}
});
...
if(selected!=null){
var _1055=this._textareas.get(selected.textareaname);
this._textareaname=selected.textareaname;
this._placeholdername=_1055.placeholdername;
this._setContentFromPlaceHolder(selected.textareaname);
selected.focus();
}
};
VisualMultiEditorBinding.prototype._noPlaceHolders=function(){
var _1056=this.getContentWindow().bindingMap.templatetree;
var _1057=_1056.add(TreeNodeBinding.newInstance(_1056.bindingDocument));
_1057.setLabel(StringBundle.getString("Composite.Web.VisualEditor","TemplateTree.NoTemplateWarning"));
_1057.setImage("${icon:warning}");
_1057.attach();
var _1058=this.getContentWindow().bindingMap.statusbar;
_1058.setPlaceHolderName(null);
};
VisualMultiEditorBinding.prototype._setContentFromPlaceHolder=function(name){
if(this._isFinalized==true){
var _105a=this._textareas.get(name);
var _105b=_105a.placeholdermarkup;
this.setValue(this.normalizeToDocument(_105b));
this.resetUndoRedo();
}
};
VisualMultiEditorBinding.prototype._placeHolderSelected=function(_105c){
if(this._isFinalized==true){
...
this._textareaname=_105c;
this._placeholdername=this._textareas.get(this._textareaname).placeholdername;
var _105d=this.getContentWindow().bindingMap.statusbar;
_105d.setPlaceHolderName(this._placeholdername);
if(this._isFinalized==true){
var self=this;
Application.lock(self);
setTimeout(function(){
self._setContentFromPlaceHolder(_105c);
Application.unlock(self);
},0);
}
};
...
_1060=this._heads.get(this._textareaname);
if(_1060==null){
_1060=new String("");
}
}
...
this._textareas.get(this._textareaname).placeholdermarkup=this.getValue();
this._textareas.each(function(name,_1062){
_1062.textareaelement.value=_1062.placeholdermarkup;
});
}
};
VisualMultiEditorBinding.prototype.updateElement=function(_1063,_1064){
var _1065=_1063.getElementsByTagName("div").item(0);
var _1066=_1064.getElementsByTagName("div").item(0);
var _1067=new List(_1065.getElementsByTagName("textarea"));
var _1068=new List(_1066.getElementsByTagName("textarea"));
var _1069=false;
if(_1067.getLength()!=_1068.getLength()){
_1069=true;
}else{
var index=0;
_1067.each(function(_106b,index){
var _106d=_1068.get(index);
var newid=_106b.getAttribute("placeholderid");
var oldid=_106d.getAttribute("placeholderid");
var _1070=_106b.getAttribute("placeholdername");
var _1071=_106d.getAttribute("placeholdername");
if(newid!=oldid||_1070!=_1071){
_1069=true;
}
return !_1069;
});
...
if(_1069){
var html=null;
if(_1065.innerHTML!=null){
html=_1065.innerHTML;
}else{
html=DOMSerializer.serialize(_1065);
...
var self=this;
var _1075=this.getDescendantBindingByLocalName("selector");
_1075.attach();
this._populateTemplateSelector();
var _1076=this.getContentWindow().bindingMap.templateselector;
_1076.addActionListener(SelectorBinding.ACTION_SELECTIONCHANGED,{handleAction:function(){
setTimeout(function(){
...
_1077.selections.each(function(_1079){
_1079.imageProfile=new ImageProfile({image:"${icon:page-template-template}"});
});
_1078.populateFromList(_1077.selections);
};
VisualMultiTemplateEditorBinding.prototype._onTemplateSelectionChanged=function(){
var _107a=this.getDescendantBindingByLocalName("selector");
var _107b=this.getContentWindow().bindingMap.templateselector;
_107a.selectByValue(_107b.getValue());
_107a.dispatchAction(PageBinding.ACTION_DOPOSTBACK);
this.checkForDirty(true);
};
VisualMultiTemplateEditorBinding.prototype._parsePlaceHolders=function(_107c){
...
this._textareas=new Map();
function compute(_1081,_1082){
var _1083=_1082;
if(old.has(_1081)){
_1083=old.get(_1081).placeholdermarkup;
}
return _1083;
}
while(_107c.hasNext()){
var _1084=_107c.getNext();
var _1085=_1084.getAttribute("placeholderid");
this._textareas.set(_1085,{placeholderid:_1085,placeholdername:_1084.getAttribute("placeholdername"),placeholdermarkup:compute(_1085,_1084.value),textareaelement:_1084,isSelected:_1084.getAttribute("selected")=="true"});
}
var _1086=null;
var _1087=this.getContentWindow().bindingMap.templatetree;
var _1088=new Map();
this._textareas.each(function(name,_108a){
var _108b=_1087.add(TreeNodeBinding.newInstance(_1087.bindingDocument));
...
_1087.attachRecursive();
if(_1086!=null){
var _108c=true;
if(this._oldtextareas.hasEntries()){
_108c=false;
var map=new Map();
this._textareas.each(function(id,_108f){
map.set(_108f.placeholdername,true);
});
...
if(_108c){
var _1090=this._textareas.get(_1086.textareaname);
this._textareaname=_1086.textareaname;
this._placeholdername=_1090.placeholdername;
this._setContentFromPlaceHolder(_1086.textareaname);
_1086.focus();
}else{
var _1091=_1088.get(this._placeholdername);
this._textareaname=_1091.textareaname;
_1091.focus();
}
}
};
VisualMultiTemplateEditorBinding.prototype.updateElement=function(_1092,_1093){
var _1094=_1092.getElementsByTagName("ui:selector").item(0);
var _1095=_1093.getElementsByTagName("ui:selector").item(0);
var _1096=false;
if(_1094!=null&&_1095!=null){
var _1097=new List(_1094.getElementsByTagName("ui:selection"));
var _1098=new List(_1095.getElementsByTagName("ui:selection"));
if(_1097.getLength()!=_1098.getLength()){
_1096=true;
}else{
_1097.each(function(_1099,index){
var _109b=_1099.getAttribute("value");
var _109c=_1098.get(index).getAttribute("value");
if(_109b!=_109c){
_1096=true;
}
return !_1096;
...
div.innerHTML=DOMSerializer.serialize(_1094);
this.bindingWindow.DocumentManager.attachBindings(div);
this._populateTemplateSelector();
}
return VisualMultiTemplateEditorBinding.superclass.updateElement.call(this,_1092,_1093);
};
...
CodeMirrorEditorPopupBinding.prototype.configure=function(_109e,frame,_10a0){
this._editorBinding=_109e;
this._codePressFrame=frame;
this._codePressEngine=_10a0;
...
var _10a6=this.getProperty("validate");
if(_10a6==true){
this._hasStrictValidation=true;
}
var _10a7=this.getProperty("validator");
if(_10a7!=null){
...
CodeMirrorEditorBinding.prototype.handleBroadcast=function(_10a8,arg){
CodeMirrorEditorBinding.superclass.handleBroadcast.call(this,_10a8,arg);
switch(_10a8){
case BroadcastMessages.CODEMIRROR_LOADED:
var _10aa=this.getContentWindow().bindingMap.codemirrorwindow;
if(_10aa!=null){
var _10ab=_10aa.getContentWindow();
if(arg.broadcastWindow==_10ab){
this._codemirrorWindow=_10ab;
...
this.initializeEditorComponents(_10aa);
var self=this;
...
this.unsubscribe(_10a8);
}
}
break;
}
};
CodeMirrorEditorBinding.prototype._onPageInitialize=function(_10af){
CodeMirrorEditorBinding.superclass._onPageInitialize.call(this,_10af);
if(Client.isExplorer||this._codemirrorEditor!=null){
this._initialize();
}
};
CodeMirrorEditorBinding.prototype._activateEditor=function(_10b0){
if(_10b0!=this._isActivated||this.isFocusable&&!this.isFocused){
this._isActivated=_10b0;
EditorBinding.isActive=_10b0;
var _10b1=this.getContentWindow().standardEventHandler;
if(_10b0){
_10b1.enableNativeKeys(true);
}else{
_10b1.disableNativeKeys();
}
var _10b2=this.getContentWindow().bindingMap.broadcasterIsActive;
if(_10b2!=null){
if(_10b0){
_10b2.enable();
}else{
...
if(_10b0){
this.focus();
var _10b3=this._codemirrorEditor;
}else{
this.blur();
}
}
...
var _10b7=CodeMirrorEditorBinding.superclass.handleCommand.call(this,cmd,val);
return _10b7;
};
...
CodeMirrorEditorBinding.prototype.initializeEditorComponent=function(_10b8){
_10b8.initializeSourceEditorComponent(this,this._codemirrorEditor);
};
...
CodeMirrorEditorBinding.prototype.setContent=function(_10ba){
if(!this._isFinalized){
if(_10ba!=this._startContent){
this._startContent=_10ba;
}
}
if(this.isInitialized&&this.getContentWindow().bindingMap!=null){
this.getContentWindow().bindingMap.editorpage.setContent(_10ba);
this.resetUndoRedo();
this._checksum=this.getCheckSum();
}
return true;
...
var _10bb=this.getContentWindow().bindingMap.editorpage.getContent();
return _10bb?_10bb:"";
};
CodeMirrorEditorBinding.prototype.resetUndoRedo=function(){
};
CodeMirrorEditorBinding.prototype.cover=function(_10bc){
if(this._pageBinding!=null){
this._pageBinding.cover(_10bc);
}
};
CodeMirrorEditorBinding.prototype.updateElement=function(_10bd){
if(_10bd!=null&&this.shadowTree.dotnetinput!=null){
var value=_10bd.getAttribute("value");
...
var _10bf=true;
var _10c0=this.getContent();
if(this._validator!=null){
_10bf=Validator.validateInformed(_10c0,this._validator);
}else{
switch(this.syntax){
case CodeMirrorEditorBinding.syntax.XML:
case CodeMirrorEditorBinding.syntax.XSL:
case CodeMirrorEditorBinding.syntax.HTML:
_10bf=XMLParser.isWellFormedDocument(_10c0,true);
if(_10bf==true&&this._hasStrictValidation){
switch(this.syntax){
case CodeMirrorEditorBinding.syntax.HTML:
_10bf=this._isValidHTML(_10c0);
break;
}
}
break;
...
_10c4.add("MissingHtml");
}
if(root.namespaceURI!=Constants.NS_XHTML){
_10c4.add("NamespaceURI");
}
var head=null,body=null;
var _10c8=new List(root.childNodes);
while(_10c8.hasNext()){
var child=_10c8.getNext();
if(child.nodeType==Node.ELEMENT_NODE){
switch(child.nodeName){
case "head":
if(head!=null){
_10c4.add("MultipleHead");
}
if(body!=null){
_10c4.add("HeadBodyIndex");
}
head=child;
break;
case "body":
if(body!=null){
_10c4.add("MultipleBody");
}
body=child;
break;
}
...
if(head==null){
_10c4.add("MissingHead");
}
if(body==null){
_10c4.add("MissingBody");
}
}
if(_10c4.hasEntries()){
_10c2=false;
if(Client.isWebKit){
alert(StringBundle.getString("Composite.Web.SourceEditor","Invalid.HTML."+_10c4.getFirst()));
}else{
Dialog.error(StringBundle.getString("Composite.Web.SourceEditor","Invalid.HTML.DialogTitle"),StringBundle.getString("Composite.Web.SourceEditor","Invalid.HTML."+_10c4.getFirst()));
}
}
return _10c2;
};
...
ThrobberBinding.prototype.handleBroadcast=function(_10cc,arg){
ThrobberBinding.superclass.handleBroadcast.call(this,_10cc,arg);
switch(_10cc){
case BroadcastMessages.COMPOSITE_START:
...
ProgressBarBinding.notch=function(_10cf){
...
ProgressBarBinding.prototype.notch=function(_10d1){
_10d1=_10d1?_10d1:1;
var width=this._cover.getWidth()-(ProgressBarBinding.NOTCH*_10d1);
...
StartMenuItemBinding.prototype.handleBroadcast=function(_10d3,arg){
StartMenuItemBinding.superclass.handleBroadcast.call(this,_10d3,arg);
switch(_10d3){
case BroadcastMessages.COMPOSITE_START:
if(!this.isChecked){
this.check(true);
...
StartMenuItemBinding.prototype.setChecked=function(_10d5,_10d6){
StartMenuItemBinding.superclass.setChecked.call(this,_10d5,_10d6);
if(!_10d6){
if(this.isChecked){
EventBroadcaster.broadcast(BroadcastMessages.START_COMPOSITE);
}else{
...
StartMenuItemBinding.newInstance=function(_10d7){
var _10d8=DOMUtil.createElementNS(Constants.NS_UI,"ui:menuitem",_10d7);
UserInterface.registerBinding(_10d8,StartMenuItemBinding);
return UserInterface.getBinding(_10d8);
};
...
KeySetBinding.registerKeyEventHandler=function(doc,key,_10db,_10dc){
var _10dd=KeySetBinding.keyEventHandlers;
if(Interfaces.isImplemented(IKeyEventHandler,_10dc,true)==true){
if(_10db!="*"){
_10db=KeySetBinding._sanitizeKeyModifiers(_10db);
}
...
_10dd[doc][code][_10db]=_10dc;
}
};
KeySetBinding.handleKey=function(doc,e){
var _10e1=false;
var code=e.keyCode;
var _10e3=KeySetBinding.keyEventHandlers;
if(_10e3[doc]&&_10e3[doc][code]){
var _10e4="[default]";
_10e4+=code!=KeyEventCodes.VK_SHIFT?e.shiftKey?" shift":"":"";
_10e4+=code!=KeyEventCodes.VK_CONTROL?e.ctrlKey?" control":"":"";
var _10e5=_10e3[doc][code][_10e4];
if(_10e5==null){
_10e5=_10e3[doc][code]["*"];
}
if(_10e5!=null){
_10e5.handleKeyEvent(e);
_10e1=true;
}
}
return _10e1;
};
KeySetBinding._sanitizeKeyModifiers=function(_10e6){
var _10e7="[default]";
var mods={};
if(_10e6){
new List(_10e6.split(" ")).each(function(_10e9){
mods[_10e9]=true;
});
function check(_10ea){
if(mods[_10ea]){
_10e7+=" "+_10ea;
}
}
...
var _10ee=key.getAttribute("oncommand");
var _10ef=key.getAttribute("preventdefault")=="true";
...
var _10f1=self.bindingWindow.WindowManager;
top.setTimeout(function(){
Binding.evaluate(_10ee,self);
},0);
}});
});
};
...
CursorBinding.fadeIn=function(_10f2){
if(_10f2 instanceof CursorBinding){
_10f2.setOpacity(0);
_10f2.show();
new Animation({modifier:Client.isExplorer?18:9,onstep:function(_10f3){
_10f2.setOpacity(Math.sin(_10f3*Math.PI/180));
},onstop:function(){
_10f2.setOpacity(1);
}}).play();
}
};
CursorBinding.fadeOut=function(_10f4){
if(_10f4 instanceof CursorBinding){
new Animation({modifier:Client.isExplorer?18:9,onstep:function(_10f5){
_10f4.setOpacity(Math.cos(_10f5*Math.PI/180));
},onstop:function(){
_10f4.hide();
}}).play();
}
};
CursorBinding.moveOut=function(_10f6,_10f7,_10f8){
if(_10f6 instanceof CursorBinding){
_10f8.x-=16;
_10f8.y-=16;
new Animation({modifier:3,onstep:function(_10f9){
var tal=Math.sin(_10f9*Math.PI/180);
_10f6.setPosition(new Point(((1-tal)*_10f7.x)+((0+tal)*_10f8.x),((1-tal)*_10f7.y)+((0+tal)*_10f8.y)));
},onstop:function(){
CursorBinding.fadeOut(_10f6);
}}).play();
}
};
...
CursorBinding.prototype.setOpacity=function(_10ff){
if(Client.isMozilla){
this.bindingElement.style.MozOpacity=new String(_10ff);
}else{
this.bindingElement.style.filter="progid:DXImageTransform.Microsoft.Alpha(opacity="+new String(_10ff*100)+")";
}
this._opacity=_10ff;
};
...
if(Client.isMozilla){
cover.bindingElement.style.opacity=new String(_1102);
}else{
...
new Animation({modifier:Client.isExplorer?30:18,onstep:function(_1103){
if(Binding.exists(cover)){
setOpacity(Math.cos(_1103*Math.PI/180));
}
},onstop:function(){
if(Binding.exists(cover)){
cover.hide();
...
function setOpacity(_1105){
if(Client.isMozilla){
cover.bindingElement.style.MozOpacity=new String(_1105);
}else{
cover.bindingElement.style.filter="progid:DXImageTransform.Microsoft.Alpha(opacity="+new String(_1105*100)+")";
}
}
if(cover instanceof CoverBinding){
...
},onstep:function(_1106){
if(Binding.exists(cover)){
setOpacity(Math.sin(_1106*Math.PI/180));
}
},onstop:function(){
setOpacity(1);
}}).play();
...
CoverBinding.prototype.setBusy=function(_1108){
if(_1108!=this._isBusy){
if(_1108){
this.bindingElement.style.cursor="wait";
}else{
...
CoverBinding.prototype.setHeight=function(_110b){
if(_110b>=0){
this.bindingElement.style.height=new String(_110b+"px");
}
};
CoverBinding.prototype.getHeight=function(){
return this.bindingElement.offsetHeight;
};
CoverBinding.newInstance=function(_110c){
var _110d=DOMUtil.createElementNS(Constants.NS_UI,"ui:cover",_110c);
return UserInterface.registerBinding(_110d,CoverBinding);
};
...
var _110f=UncoverBinding._bindingInstance;
if(Binding.exists(_110f)){
_110f.setPosition(pos);
}
};
...
TheatreBinding.prototype.play=function(_1113){
this._isFading=_1113==true;
if(!this._isPlaying){
Application.lock(this);
this.show();
this._isPlaying=true;
...
if(Client.isMozilla){
var _1114=this._canvas.getContext("2d");
var alpha=parseInt(0);
TheatreBinding._interval=top.setInterval(function(){
if(alpha<0.5){
_1114.fillStyle="rgba(0,0,0,"+new String(alpha)+")";
_1114.clearRect(0,0,300,150);
_1114.fillRect(0,0,300,150);
alpha+=0.002;
}else{
...
var _1116=this._canvas.getContext("2d");
_1116.clearRect(0,0,300,150);
}
}
...
var _1117=SourceCodeViewerBinding.stylesheets[this._syntax];
this._transformer=new XSLTransformer();
this._transformer.importStylesheet(_1117);
break;
default:
...
var _1118=DOMUtil.getElementsByTagName(this.bindingElement,"textarea").item(0);
if(_1118){
this._startcontent=_1118.value;
}
this.setURL(SourceCodeViewerBinding.URL_DEFAULT);
this.addActionListener(WindowBinding.ACTION_ONLOAD);
SourceCodeViewerBinding.superclass.onBindingAttach.call(this);
};
SourceCodeViewerBinding.prototype.handleAction=function(_1119){
SourceCodeViewerBinding.superclass.handleAction.call(this,_1119);
switch(_1119.type){
case WindowBinding.ACTION_ONLOAD:
if(_1119.target==this){
if(this._startcontent){
...
if(doc){
var _111d=this._transformer.transformToString(doc);
this._inject(_111d);
}
};
...
SourceCodeViewerBinding.prototype._inject=function(_1120){
this.getContentDocument().body.innerHTML=_1120;
};
...
while(list.hasNext()){
var _1128=list.getNext();
var id=_1128.getAttribute("id");
map[id]={};
var atts=this._resolver.resolveAll("p:att",_1128);
while(atts.hasNext()){
var att=atts.getNext();
...
for(var id in map){
var _1132=DOMUtil.createElementNS(Constants.NS_PERSISTANCE,"persist",doc);
_1132.setAttribute("id",id);
...
_1132.appendChild(att);
}
elm.appendChild(_1132);
}
return doc;
};
...
var doc=null;
var _113c=window.globalStorage[PersistanceBinding.GLOBALSTOREKEY].persistance;
if(_113c){
doc=XMLParser.parse(_113c);
}else{
var file=PersistanceBinding.TEMPLATE;
...
var _1140=DOMSerializer.serialize(doc,true);
window.globalStorage[PersistanceBinding.GLOBALSTOREKEY].persistance=_1140;
};
...
LocalizationSelectorBinding.prototype.handleBroadcast=function(_1141,arg){
LocalizationSelectorBinding.superclass.handleBroadcast.call(this,_1141,arg);
switch(_1141){
...
_1144.add(new SelectorBindingSelection(lang.Name,lang.SerializedActionToken,lang.IsCurrent,null));
});
this.populateFromList(_1144);
this.show();
}else{
this.hide();
}
...
var self=this;
Dialog.warning(StringBundle.getString(StringBundle.UI,"UserElementProvider.ChangeOtherActiveLocaleDialogTitle"),StringBundle.getString(StringBundle.UI,"UserElementProvider.ChangeOtherActiveLocaleDialogText"),Dialog.BUTTONS_ACCEPT_CANCEL,{handleDialogResponse:function(_1148){
switch(_1148){
case Dialog.RESPONSE_ACCEPT:
...
var _114b=new SystemAction({Label:"Generated Action: Change Locale",ActionToken:token});
SystemAction.invoke(_114b,root);
};
...
var _114c=this.getProperty("status");
if(_114c!=null){
switch(_114c){
case "success":
...
UserInterfaceMapping.prototype.merge=function(_114f){
for(var _1150 in _114f.map){
this.map[_1150]=_114f.getBindingImplementation(_1150);
}
};
UserInterfaceMapping.prototype.getBindingImplementation=function(_1151){
var _1152=null;
var name=_1151.nodeName;
if(Client.isExplorer){
...
if(_115b){
var key=KeyMaster.getUniqueKey();
_1159.setAttribute("key",key);
_115b.key=key;
if(!_1159.id){
_1159.id=key;
}
keys[key]={element:_1159,binding:_115b};
_115b.onBindingRegister();
}
}
}
return _115b;
};
this.unRegisterBinding=function(_1161){
terminate(_1161);
};
function terminate(_1162){
if(Binding.exists(_1162)==true){
var key=_1162.key;
Binding.destroy(_1162);
if(key){
if(keys[key]){
...
_1157.error("URGH: "+key);
}
}
}
}
this.getElement=function(_1164){
var _1165=null;
if(keys[_1164.key]){
_1165=keys[_1164.key].element;
}
return _1165;
};
this.getBinding=function(_1166){
var _1167=null;
if(_1166&&_1166.nodeType==Node.ELEMENT_NODE){
try{
var key=_1166.getAttribute("key");
if(key&&keys[key]){
...
var _116a=null;
if(keys[key]){
_116a=keys[key].binding;
}
return _116a;
};
this.hasBinding=function(_116b){
return this.getBinding(_116b)!=null;
};
this.isBindingVisible=function(_116c){
var _116d=Application.isOperational;
if(_116d==true){
var _116e=new Crawler();
_116e.type=NodeCrawler.TYPE_ASCENDING;
_116e.id="visibilitycrawler";
_116e.addFilter(function(_116f){
var b=UserInterface.getBinding(_116f);
var res=0;
if(!b.isVisible){
_116d=false;
...
_116e.crawl(_116c.bindingElement);
_116e.dispose();
}
return _116d;
};
...
this.autoTrackDisposedBindings=function(_117b){
if(_117b){
...
SOAPRequest.newInstance=function(_117c,_117d){
var _117e=_117c+"/"+_117d;
var _117f=new SOAPRequest(_117e);
var _1180=SOAPRequest.resolver;
_117f.document=Templates.getTemplateDocument("soapenvelope.xml");
_117f.envelope=_1180.resolve("soap:Envelope",_117f.document);
_117f.header=_1180.resolve("soap:Header",_117f.envelope);
_117f.body=_1180.resolve("soap:Body",_117f.envelope);
return _117f;
};
SOAPRequest._parseResponse=function(_1181){
var _1182=null;
var _1183=false;
var doc=_1181.responseXML;
if(doc!=null&&doc.documentElement!=null){
switch(doc.documentElement.namespaceURI){
case Constants.NS_ENVELOPE:
_1182=SOAPRequestResponse.newInstance(_1181.responseXML);
...
if(!Application.isOffLine){
var body=SOAPRequest.resolver.resolve("xhtml:html/xhtml:body",_1181.responseXML);
...
window.open("about:blank").document.write(_1181.responseText);
}
}
}
}
...
function SOAPRequest(_1188){
this.logger=SystemLogger.getLogger("SOAPRequest");
this.action=_1188;
return this;
}
SOAPRequest.prototype.invoke=function(url){
var _118a=DOMUtil.getXMLHTTPRequest();
var _118b=null;
_118a.open("post",url,false);
_118a.setRequestHeader("Content-Type","text/xml; charset=UTF-8");
_118a.setRequestHeader("SOAPAction",this.action);
try{
_118a.send(this.document);
_118b=SOAPRequest._parseResponse(_118a);
}
catch(exception){
...
SOAPRequest.prototype.asyncInvoke=function(url,_118e){
var _118f=DOMUtil.getXMLHTTPRequest();
_118f.open("post",url,true);
_118f.setRequestHeader("Content-Type","text/xml; charset=UTF-8");
_118f.setRequestHeader("SOAPAction",this.action);
_118f.onreadystatechange=function(){
if(_118f.readyState==4){
var _1190=SOAPRequest._parseResponse(_118f);
_118e(_1190);
_118f=null;
}
};
_118f.send(this.document);
};
...
return function(){
var _120e=new List(arguments);
var _120f=null;
if(typeof (_120e.getLast())=="function"){
var _1210=_120e.extractLast();
var _1211=_120d.encoder.encode(_120e);
this._log(_120d,_1211);
var self=this;
var _1213=_1211.asyncInvoke(_120d.address,function(_1214){
self._log(_120d,_1214);
if(_1214){
if(_1214.fault){
_120f=SOAPFault.newInstance(_120d,_1214.fault);
if(WebServiceProxy.isFaultHandler){
WebServiceProxy.handleFault(_120f,_1211,_1214);
}
}else{
if(WebServiceProxy.isDOMResult){
_120f=_1214.document;
}else{
_120f=_120d.decoder.decode(_1214);
}
}
}
_1211.dispose();
...
var _1211=_120d.encoder.encode(new List(arguments));
this._log(_120d,_1211);
var _1213=_1211.invoke(_120d.address);
this._log(_120d,_1213);
if(_1213){
if(_1213.fault){
_120f=SOAPFault.newInstance(_120d,_1213.fault);
if(WebServiceProxy.isFaultHandler){
WebServiceProxy.handleFault(_120f,_1211,_1213);
}
}else{
if(WebServiceProxy.isDOMResult){
_120f=_1213.document;
}else{
_120f=_120d.decoder.decode(_1213);
}
}
}
_1211.dispose();
...
WebServiceProxy.handleFault=function(_1215,_1216,_1217){
try{
Dialog.invokeModal(Dialog.URL_SERVICEFAULT,null,{soapFault:_1215,soapRequest:_1216,soapResponse:_1217});
}
catch(exception){
alert(_1215.getFaultString());
}
};
...
this._index={};
this.index=0;
var _1218=SystemLogger.getLogger("MessageQueue");
var _1219=null;
var _121a=0;
var _121b=null;
var _121c=new Map();
...
var _121e=false;
var _121f=false;
var _1220={"Main":DockBinding.MAIN,"External":DockBinding.EXTERNAL,"BottomLeft":DockBinding.BOTTOMLEFT,"BottomRight":DockBinding.BOTTOMRIGHT,"RightTop":DockBinding.RIGHTTOP,"RightBottom":DockBinding.RIGHTBOTTOM,"AbsBottomLeft":DockBinding.ABSBOTTOMLEFT,"AbsBottomRight":DockBinding.ABSBOTTOMRIGHT};
this.initialize=function(){
_1219=ConsoleMessageQueueService;
_121a=_1219.GetCurrentSequenceNumber("dummyparam!");
this.index=_121a;
...
var _1221=WebServiceProxy.isLoggingEnabled;
if(Application.isLoggedIn){
_121f=true;
WebServiceProxy.isLoggingEnabled=false;
MessageQueue.update();
WebServiceProxy.isLoggingEnabled=_1221;
_121f=false;
}
}
}
...
if(Application.isLoggedIn){
EventBroadcaster.broadcast(BroadcastMessages.MESSAGEQUEUE_REQUESTED,_121f);
var _1222=_1219.GetMessages(Application.CONSOLE_ID,this.index);
if(_1222!=null){
if(Types.isDefined(_1222.CurrentSequenceNumber)){
var _1223=_1222.CurrentSequenceNumber;
if(_1223<this.index){
_1218.debug("SERVER WAS RESTARTED! old messagequeue index: "+this.index+", new messagequeue index: "+_1223);
}
this.index=_1223;
var _1224=new List(_1222.ConsoleActions);
if(_1224.hasEntries()){
this.evaluate(_1224);
}else{
...
_1218.error("No sequencenumber in MessageQueue response!");
}
}
}
};
this.evaluate=function(_1225){
var _1226=new List();
if(_1225.hasEntries()){
_1225.each(function(_1227){
if(this._index[_1227.Id]!=true){
_1226.add(_1227);
}
this._index[_1227.Id]=true;
},this);
if(_1226.hasEntries()){
if(this._actions.hasEntries()){
this._actions.merge(_1226);
}else{
this._actions=_1226;
}
this._nextAction();
...
this._closeAllViews=function(_1228){
var _1229="(No reason)";
if(_1228!=null){
_1229=_1228.Reason;
}
...
text=text.replace("${reason}",_1229);
var self=this;
Dialog.warning(title,text,Dialog.BUTTONS_ACCEPT_CANCEL,{handleDialogResponse:function(_122d){
if(_122d==Dialog.RESPONSE_ACCEPT){
EventBroadcaster.broadcast(BroadcastMessages.CLOSE_VIEWS);
}
self._nextAction();
}});
...
var _122e=null;
if(this._actions.hasEntries()){
var _122f=this._actions.extractFirst();
_121a=_122f.SequenceNumber;
_1218.debug("MessageQueue action: "+_122f.ActionType+" > QUEUE-MAX-SEQNUM: "+this.index+" > CURRENT SEQNUM: "+_121a+" > ACTIONS-LEFT: "+this._actions.getLength());
switch(_122f.ActionType){
case "OpenView":
_122e=_122f.OpenViewParams;
if(_122e.ViewType=="ModalDialog"){
openDialogView(_122e);
}else{
_121b=_122e.ViewId;
openView(_122e);
}
...
EventBroadcaster.broadcast(BroadcastMessages.SYSTEMTREEBINDING_REFRESH,_122f.RefreshTreeParams.EntityToken);
var debug="REFRESHING TREES: "+_121c.countEntries()+"\n";
_121c.each(function(token){
debug+="\n\tTOKEN: "+token;
});
_1218.debug(debug);
if(!_121c.hasEntries()){
...
break;
case "SelectElement":
EventBroadcaster.broadcast(BroadcastMessages.SYSTEMTREEBINDING_FOCUS,_122f.BindEntityTokenToViewParams.EntityToken);
this._nextAction();
break;
case "MessageBox":
openMessageBox(_122f.MessageBoxParams);
break;
case "OpenViewDefinition":
_122e=_122f.OpenViewDefinitionParams;
_121b=_122e.Handle;
openViewDefinition(_122e);
break;
case "LogEntry":
logEntry(_122f.LogEntryParams);
this._nextAction();
break;
case "Reboot":
Application.reload(true);
...
_122e=_122f.BroadcastMessageParams;
_1218.debug("Server says: EventBroadcaster.broadcast ( \""+_122e.Name+"\", "+_122e.Value+" )");
EventBroadcaster.broadcast(_122e.Name,_122e.Value);
this._nextAction();
break;
...
break;
case "CloseAllViews":
this._closeAllViews(_122f.CloseAllViewsParams);
break;
case "SaveStatus":
saveStatus(_122f.SaveStatusParams);
this._nextAction();
break;
case "DownloadFile":
Download.init(_122f.DownloadFileParams.Url);
this._nextAction();
break;
case "ExpandTreeNode":
this._nextAction();
...
_122e=_122f.BindEntityTokenToViewParams;
EventBroadcaster.broadcast(BroadcastMessages.BIND_TOKEN_TO_VIEW,{handle:_122e.ViewId,entityToken:_122e.EntityToken});
this._nextAction();
break;
case "OpenGenericView":
_122e=_122f.OpenGenericViewParams;
openGenericView(_122e);
break;
case "OpenExternalView":
_122e=_122f.OpenExternalViewParams;
openExternalView(_122e);
break;
default:
Dialog.error("Dysfunction","Unhandled action: "+_122f.ActionType);
break;
}
}else{
broadcastUpdateEvaluated();
...
EventBroadcaster.broadcast(BroadcastMessages.MESSAGEQUEUE_EVALUATED,_121f);
}
function logEntry(_1232){
var _1233=_1232.Level.toLowerCase();
SystemLogger.getLogger(_1232.SenderId)[_1233](_1232.Message);
}
function openView(_1234){
var list=paramsToList(_1234.Argument);
if(list.hasEntries()){
var def=ViewDefinition.clone("Composite.Management.PostBackView",_1234.ViewId);
def.entityToken=_1234.EntityToken;
def.flowHandle=_1234.FlowHandle;
def.position=_1220[_1234.ViewType],def.label=_1234.Label;
def.image=_1234.Image;
def.toolTip=_1234.ToolTip;
def.argument={"url":_1234.Url,"list":list};
StageBinding.presentViewDefinition(def);
}else{
StageBinding.presentViewDefinition(new HostedViewDefinition({handle:_1234.ViewId,entityToken:_1234.EntityToken,flowHandle:_1234.FlowHandle,position:_1220[_1234.ViewType],url:_1234.Url,label:_1234.Label,image:_1234.Image,toolTip:_1234.ToolTip}));
}
}
function openDialogView(_1237){
StageBinding.presentViewDefinition(new DialogViewDefinition({handle:_1237.ViewId,flowHandle:_1237.FlowHandle,position:Dialog.MODAL,url:_1237.Url,handler:{handleDialogResponse:function(){
setTimeout(function(){
MessageQueue._nextAction();
},250);
}}}));
}
function openMessageBox(_1238){
var _1239=_1238.DialogType.toLowerCase();
if(_1239=="question"){
throw "Not supported!";
}else{
Dialog[_1239](_1238.Title,_1238.Message,null,{handleDialogResponse:function(){
setTimeout(function(){
MessageQueue._nextAction();
},250);
}});
...
function openViewDefinition(_123a){
var map={};
var _123c=false;
new List(_123a.Argument).each(function(entry){
map[entry.Key]=entry.Value;
_123c=true;
});
var proto=ViewDefinitions[_123a.Handle];
if(proto!=null){
var def=null;
...
def.handle=_123a.ViewId;
}
def.argument=_123c?map:null;
StageBinding.presentViewDefinition(def);
}else{
throw "Unknown ViewDefinition: "+param.Handle;
}
}
function openGenericView(_1241){
var def=ViewDefinition.clone("Composite.Management.GenericView",_1241.ViewId);
def.label=_1241.Label;
def.toolTip=_1241.ToolTip;
def.image=_1241.Image;
def.argument={"url":_1241.Url,"list":paramsToList(_1241.UrlPostArguments)};
StageBinding.presentViewDefinition(def);
}
function openExternalView(_1243){
var def=ViewDefinition.clone("Composite.Management.ExternalView",_1243.ViewId);
def.label=_1243.Label;
def.toolTip=_1243.ToolTip;
def.image=_1243.Image;
def.url=_1243.Url,StageBinding.presentViewDefinition(def);
}
function closeView(_1245){
if(StageBinding.isViewOpen(_1245.ViewId)){
EventBroadcaster.broadcast(BroadcastMessages.CLOSE_VIEW,_1245.ViewId);
}else{
MessageQueue._nextAction();
}
}
function saveStatus(_1246){
EventBroadcaster.broadcast(BroadcastMessages.CURRENT_SAVED,{handle:_1246.ViewId,isSuccess:_1246.Succeeded});
}
this._lockSystem=function(_1247){
var _1248=top.bindingMap.offlinetheatre;
if(_1247){
_1248.play(true);
...
this.handleBroadcast=function(_124a,arg){
switch(_124a){
case BroadcastMessages.APPLICATION_LOGIN:
this.initialize();
break;
...
_1218.debug("Saa har vi balladen!");
}
break;
case BroadcastMessages.SYSTEMTREEBINDING_REFRESHED:
if(_121c.hasEntries()){
_121c.del(arg);
_1218.debug("Refreshed tree: "+arg+"\n("+_121c.countEntries()+" trees left!)");
if(!_121c.hasEntries()){
EventBroadcaster.unsubscribe(BroadcastMessages.SYSTEMTREEBINDING_REFRESHING,this);
EventBroadcaster.unsubscribe(BroadcastMessages.SYSTEMTREEBINDING_REFRESHED,this);
setTimeout(function(){
...
function paramsToList(_124c){
var list=new List();
new List(_124c).each(function(entry){
...
this.handleBroadcast=function(_1256){
switch(_1256){
...
break;
case BroadcastMessages.APPLICATION_LOGIN:
var _1257=window.bindingMap.appwindow;
_1257.setURL("app.aspx");
break;
case BroadcastMessages.APPLICATION_OPERATIONAL:
showWorkbench();
break;
...
function fileEventBroadcasterSubscriptions(_1258){
new List([BroadcastMessages.AUDIO_INITIALIZED,BroadcastMessages.PERSISTANCE_INITIALIZED,BroadcastMessages.APPLICATION_STARTUP,BroadcastMessages.APPLICATION_LOGIN,BroadcastMessages.APPLICATION_OPERATIONAL]).each(function(_1259){
if(_1258){
EventBroadcaster.subscribe(_1259,KickStart);
}else{
EventBroadcaster.unsubscribe(_1259,KickStart);
}
});
}
function kickStart(_125a){
switch(_125a){
case BroadcastMessages.AUDIO_INITIALIZED:
_1250=true;
setTimeout(function(){
...
DataManager.getDataBinding("username").setValue(_1254);
DataManager.getDataBinding("password").setValue(_1255);
}
setTimeout(function(){
...
this.doLogin=function(_125d,_125e){
var _125f=WebServiceProxy.isLoggingEnabled;
WebServiceProxy.isLoggingEnabled=false;
WebServiceProxy.isFaultHandler=false;
var _1260=false;
var _1261=LoginService.ValidateAndLogin(_125d,_125e);
if(_1261 instanceof SOAPFault){
alert(_1261.getFaultString());
}else{
_1260=_1261;
}
if(_1260){
...
var _1262=DataManager.getDataBinding("username");
var _1263=DataManager.getDataBinding("password");
_1262.blur();
_1263.blur();
_1262.setValue("");
_1263.setValue("");
...
var _1264={handleAction:function(_1265){
document.getElementById("loginerror").style.display="none";
_1265.target.removeActionListener(Binding.ACTION_DIRTY,_1264);
}};
bindingMap.loginfields.addActionListener(Binding.ACTION_DIRTY,_1264);
}
