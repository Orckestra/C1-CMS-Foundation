var TinyMCE_CompositeFieldPlugin = new function () {
		...
		switch (command) {
			...
			case "compositeInsertField":
				...
				if ( value == "delete" ) {
					...
					var editor	= TinyMCE_CompositeTheme.editorBinding;
					var config	= editor.embedableFieldConfiguration;
...
tinyMCE.addPlugin ( "compositefield", TinyMCE_CompositeFieldPlugin );