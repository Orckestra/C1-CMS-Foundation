...
;bespin.tiki.register("::c1_syntax", {
    name: "c1_syntax",
    dependencies: { "standard_syntax": "0.0.0" }
});
bespin.tiki.module("c1_syntax:index",function(require,exports,module) {
/* ***** BEGIN LICENSE BLOCK *****
 * Version: MPL 1.1/GPL 2.0/LGPL 2.1
 *
 * The contents of this file are subject to the Mozilla Public License Version
...
"define metadata";
({
    "description": "C1 markup syntax highlighter",
    "dependencies": { "standard_syntax": "0.0.0" },
    "environments": { "worker": true },
    "provides": [
        {
...
states = {
    ...
    tagOpen: [
		...
		{
            regex:  /^f:|^rendering:|^asp:|^lang:/i, /* TODO: Verify regexp! */
            tag:    'identifier',
            then:   'tagName'
        },
        {
    ...
    tagName: [
		{
            regex:  /^rendering|function|form|switch/,
            tag:    'identifier',
