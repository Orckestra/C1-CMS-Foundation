...
Language.complete = [ // Auto complete only for 1 character
	...
	{input : '(', output : '\($0\)' },
	{input : '[', output : '\[$0\]' }		
]; // COMPOSITE : REMOVED { input : '{', output : '{\n\t$0\n}' } BECAUSE OF INDENT PROBLEM!
*/
