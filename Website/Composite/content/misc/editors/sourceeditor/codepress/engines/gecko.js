...
CodePress = {
	...
	syntaxHighlight : function(flag) {
		...
		//top.SystemLogger.getLogger ( "CodePress" ). debug ( "syntaxHighlight: " + flag + ": " + Math.random ());
	...
	setCode : function() {
		...
		code = code.replace ( /C1.LINE.BREAK.ENTITY.HACK/g, "&amp;#xA;" ); // // ADDED BY COMPOSITE!
