...
namespace Composite.StandardPlugins.Elements.ElementProviders.PackageElementProvider
{
    ...
    public sealed partial class InstallRemotePackageWorkflow : Composite.Workflow.Activities.FormsWorkflow
    {
        ...
        private void showErrorCodeActivity_Initialize_ExecuteCode(object sender, EventArgs e)
        {
            ...
            rowHeader.Add(StringResourceSystemFacade.ParseString("${Composite.StandardPlugins.PackageElementProvider, InstallRemoteAddOn.ShowError.MessageTitle}"));
