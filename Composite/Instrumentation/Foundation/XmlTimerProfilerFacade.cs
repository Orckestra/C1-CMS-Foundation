...
namespace Composite.Instrumentation.Foundation
{
    internal sealed class XmlTimerProfilerFacade : IDisposable
    {
        ...
        {
            Composite.Logging.LoggingService.LogVerbose("XmlTimerProfilerFacade", "XmlTimerProfiler running");
        ...
        public void Dispose()
        {
            ...
            {
                Composite.Logging.LoggingService.LogCritical("XmlTimerProfilerFacade", ex);
            }
        }
