var Welcome = new function () {
	 ...
	 * @param {List<Element>}
	 */
	function prepareLogin ( elements ) {
		
		var langs = new List ( SetupService.GetLanguages ( true ));
		var markup = "<select id=\"language\">";
		...
		selector.parentNode.innerHTML = markup + "</select>";
		...
		elements.each ( function ( element, index ) {
			...
			element.onfocus = function () {
				...
				tabindex = index;
				if ( this.id == "language" ) {
					// StandardEventHandler.hasNativeKeys = true;
				}
