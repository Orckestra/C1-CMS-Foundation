...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:ui="http://www.w3.org/1999/xhtml" xmlns:control="http://www.composite.net/ns/uicontrol">
	...
	<body>
		...
		<ui:page id="page" binding="HelpPageBinding">
			<ui:toolbar id="toolbar" type="imagesonly">
				<ui:toolbarbody>
					<ui:toolbargroup>
						...
						<ui:toolbarbutton id="refreshbutton" label="Refresh" image="${icon:refresh}" tooltip="${string:Website.Content.Views.Help.ToolTipRefresh}"/>
					</ui:toolbargroup>
				</ui:toolbarbody>
			...
			<ui:window id="helpwindow" alienwatch="true"/>
