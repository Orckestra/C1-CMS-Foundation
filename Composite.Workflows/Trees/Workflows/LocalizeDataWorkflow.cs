    ...
    public sealed partial class LocalizeDataWorkflow : Composite.Workflow.Activities.FormsWorkflow
    {
        ...
        private void ValidateReferencingPropertyies(object sender, ConditionalEventArgs e)
        {
            ...
            if (referenceFailingPropertyInfos.Where(f => f.OptionalReferenceWithValue == false).Any() == true)
            {
                ...
                row.Add(StringResourceSystemFacade.GetString("Composite.Trees", "LocalizeData.ShowError.Description"));
                ...
                {
                    row.Add(string.Format(StringResourceSystemFacade.GetString("Composite.Trees", "LocalizeData.ShowError.FieldErrorFormat"), referenceFailingPropertyInfo.DataFieldDescriptor.Name, referenceFailingPropertyInfo.ReferencedType.GetTypeTitle(), referenceFailingPropertyInfo.OriginLocaleDataValue.GetLabel()));
                }
        ...
        private void localizeDataCodeActivity_Localize_ExecuteCode(object sender, EventArgs e)
        {
            ...
            if (ExistsInLocale(data, targetCultureInfo) == true)
            {
                this.ShowMessage(
                    DialogType.Message,
                    StringResourceSystemFacade.GetString("Composite.Trees", "LocalizeData.ShowError.Layout.Label"),
                    StringResourceSystemFacade.GetString("Composite.Trees", "LocalizeData.ShowError.AlreadyTranslated")
                );
