var TinyMCE_CompositeImagePlugin = new function () {
	
	var logger = SystemLogger.getLogger ( "TinyMCE_CompositeImagePlugin" );
	
	var URL_IMAGETREESELECTOR = "${tinymce}/plugins/compositeimage/image.aspx";
...
tinyMCE.addPlugin("compositeimage", TinyMCE_CompositeImagePlugin);