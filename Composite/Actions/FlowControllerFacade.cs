    ...
    public static class FlowControllerFacade
    {
        ...
        public static void Initialize()
        {
            lock (_lock)
            {
                ...
                {
                    WorkflowInstance workflowInstance = WorkflowFacade.CreateNewWorkflow(WorkflowFacade.GetWorkflowType("Composite.Actions.Workflows.FlowInformationScavengerWorkflow"));
