    ...
    internal sealed class ShowElementInformationActionExecutor : IActionExecutor
    {
        public FlowToken Execute(EntityToken entityToken, ActionToken actionToken, FlowControllerServicesContainer flowControllerServicesContainer)
        {
            ...
            if (elementInformationService != null)
            {
                ...
                {
                    Serialization.StringConversionServices.SerializeKeyValuePair(sb, kvp.Key, kvp.Value);
                }
            }
            ...
            if ((element.ElementExternalActionAdding & ElementExternalActionAdding.AllowGlobal) == ElementExternalActionAdding.AllowGlobal)
            {
                element.AddAction(new ElementAction(new ActionHandle(new RelationshipGraphActionToken("ShowGraph")))
                {
                    VisualData = new ActionVisualizedData
                    {
                        ...
                        Icon = Composite.ResourceSystem.Icons.CommonElementIcons.Nodes,
                        Disabled = false,
                ...
                element.AddAction(new ElementAction(new ActionHandle(new ShowElementInformationActionToken()))
                {
                    VisualData = new ActionVisualizedData
                    {
                        ...
                        Icon = Composite.ResourceSystem.Icons.CommonElementIcons.Search,
                        Disabled = false,
                        ActionLocation = new ActionLocation
                        {
                            ActionType = ActionType.DeveloperMode,
                ...
                //        Icon = Composite.ResourceSystem.Icons.CommonCommandIcons.Search,
                //        Disabled = false,
                //        ActionLocation = new ActionLocation
                //        {
                ...
                {
                    element.AddAction(
                        new ElementAction(new ActionHandle(new UrlActionToken("My label", "/Composite/content/views/dev/flushadmin/Default.aspx", new PermissionType[] { PermissionType.Administrate })))
                        {
                            VisualData = new ActionVisualizedData
                            {
                                Label = "Develop Test",
                                ToolTip = "Develop Test",
                                Icon = GetIconHandle("unknown"),
                                Disabled = false,
                                ActionLocation = new ActionLocation
                                {
                                    ActionType = ActionType.DeveloperMode,
