...
namespace Composite.Validation.Plugins.ClientValidationRuleTranslator
{
    ...
    public class NonConfigurableClientValidationRuleTranslator : ClientValidationRuleTranslatorData
    {
    }

    public sealed class NonConfigurableClientValidationRuleTranslatorAssembler : IAssembler<IClientValidationRuleTranslator, ClientValidationRuleTranslatorData>
    {
