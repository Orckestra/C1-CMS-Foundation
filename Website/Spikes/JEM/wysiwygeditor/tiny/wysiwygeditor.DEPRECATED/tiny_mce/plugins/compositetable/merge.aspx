...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:ui="http://www.w3.org/1999/xhtml" xmlns:control="http://www.composite.net/ns/uicontrol">
	...
	<body>
		<ui:dialogpage binding="TableMergeCellsDialogPageBinding"
			label="${string:Website.Dialogs.WysiwygEditor.Tables.Merge.LabelMergeCells}" 
			image="${skin}/wysiwygeditor/table_merge_cells.png" 
			height="auto">
			<ui:fields>
				<ui:fieldgroup label="${string:Website.Dialogs.WysiwygEditor.Tables.Merge.LabelMergeCells}">
					<ui:field>
						<ui:fielddesc label="${string:Website.Dialogs.WysiwygEditor.Tables.Merge.Columns}"/>
						<ui:fielddata>
							<ui:datainput name="numcols" value="1" required="true" type="integer"/>
						</ui:fielddata>
					</ui:field>
					<ui:field>
						<ui:fielddesc label="${string:Website.Dialogs.WysiwygEditor.Tables.Merge.Rows}"/>
						<ui:fielddata>
