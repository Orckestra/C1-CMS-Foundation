...
new function () {
	...
	tinymce.create("tinymce.plugins.CompositeRenderingPlugin", {
		...
		init: function (ed, url) {
			...
			function inNonEditableContainer(node) {
			...
			ed.on('dragstart', function (event) {
				
				if (inNonEditableContainer(ed.selection.getStart())) {
					event.stopPropagation();
					event.preventDefault();
				}
			...
			ed.on('drop', function (event) {
				if (inNonEditableContainer(event.toElement)) {
