			...
			ed.on('KeyUp', function (e) {
				if (e.keyCode === tinymce.util.VK.ENTER) {
					if (state == FUNCTION_INSERT_P_BEFORE) {
						...
						stateElement.parentNode.insertBefore(p, stateElement);
						ed.selection.setCursorLocation(p, 0);
						state = FUNCTION_UNKNOWN;
				...
				if (e.keyCode === tinymce.util.VK.ENTER) {
					...
					if (VisualEditorBinding.isFunctionElement(element)) {
						if (element.parentNode.nodeName.toLowerCase() == "body") {
							state = FUNCTION_INSERT_P_BEFORE;
						...
						if (container.previousSibling && VisualEditorBinding.isFunctionElement(container.previousSibling))
						{
							state = FUNCTION_INSERT_P_BEFORE;
							stateElement = container;
							Event.cancel(e);
						}
					}
				}
