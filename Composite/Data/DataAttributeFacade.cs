...
namespace Composite.Data
{
    ...
    public static class DataAttributeFacade
    {
        ...
        public static bool TryGetImmutableTypeId(this Type interfaceType, out Guid immutableTypeId)
        {
			...
			if (_resourceLocker.Resources.InterfaceToImmutableTypeIdCache.TryGetValue(interfaceType, out immutableTypeId))
			{
				return true;
			}
            ...
            {
                _resourceLocker.Resources.InterfaceToImmutableTypeIdCache.Add(interfaceType, immutableTypeId);
            }
        ...
        private sealed class Resources
        {
            ...
            public Dictionary<Type, Guid> InterfaceToImmutableTypeIdCache { get; set; }
            ...
            {
                resources.UndefinedLableValue = StringResourceSystemFacade.GetString("Composite.StandardPlugins.GeneratedDataTypesElementProvider", "UndefinedLabelTemplate");
                resources.UndefinedDataLableValue = StringResourceSystemFacade.GetString("Composite.StandardPlugins.GeneratedDataTypesElementProvider", "UndefinedDataLavelTemplate");
                ...
                resources.InterfaceToImmutableTypeIdCache = new Dictionary<Type, Guid>();
